...
public class Analysistab {
	...
	// TC_Analysistab_01
	@Given("^Verify Sub tabs under CEIC Insights$")
	public void verify_Sub_tabs_under_CEIC_Insights() throws Throwable {
		Thread.sleep(18000);
		CommonFunctionality
		...
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='tree-root']/div", 20).isDisplayed());
	...
	// TC_Analysistab_02
	@Given("^Verify search for CEIC Insights$")
	public void verify_search_for_CEIC_Insights() throws Throwable {
		Thread.sleep(18000);
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[2]/span", 20)
				.click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//input[@class='search-input-text']", 20).sendKeys("QA");
		Thread.sleep(5000);
	...
	public void verify_Sort_by_dropdown() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver,
				"//span[@class='text-dots' and contains(text(),'Recently published')]", 20).click();
		Thread.sleep(2000);
		Assert.assertTrue(CommonFunctionality
	...
	public void verify_Sort_by_Title() throws Throwable {
		...
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver,
				"(//span[text()='Recently published']//following::span[@class='dropdown--icon icon--filter-arrow'])[1]",
				20).click();
		Thread.sleep(2000);
		CommonFunctionality
				.getElementByXpath(login.driver,
	...
	// TC_Analysistab_06
	@Given("^Verify Sort by=Recently published$")
	public void verify_Sort_by_Recently_created() throws Throwable {
		...
		CommonFunctionality
				.getElementByXpath(login.driver,
						"(//span[text()='Title']//following::span[@class='dropdown--icon icon--filter-arrow'])[1]", 20)
				.click();
		Thread.sleep(2000);
		CommonFunctionality
				.getElementByXpath(login.driver,
	...
	public void verify_Sort_by_Popularity() throws Throwable {
		...
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver,
				"(//span[text()='Last opened']//following::span[@class='dropdown--icon icon--filter-arrow'])[1]", 20)
				.click();
		Thread.sleep(2000);
		CommonFunctionality
				.getElementByXpath(login.driver,
						"//div[@class='custom-select--body custom-select--sorting-filter-dropdown']/div[4]", 20)
				.click();
		Thread.sleep(2000);
		...
		CommonFunctionality
		.getElementByXpath(login.driver,
				"(//span[text()='Popularity']//following::span[@class='dropdown--icon icon--filter-arrow'])[1]", 20)
		.click();
		Thread.sleep(1000);
		CommonFunctionality
		.getElementByXpath(login.driver,
	...
	public void verify_view_as_grid_mode() throws Throwable {
		...
		Thread.sleep(5000);
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "(//a[@class='insight-grid-item--buttons-item button'])[1]", 20)
				.isDisplayed());
		Thread.sleep(5000);
	...
	public void verify_view_as_table_mode() throws Throwable {
		...
		Thread.sleep(3000);
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']", 20).isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();

		/*
		 * CommonFunctionality.getElementByXpath(login.driver,
		 * "(//div[@class='custom-select-title--handler icon--filter-arrow'])[3]/span[2]"
		 * , 20).click(); Thread.sleep(2000);
		 * CommonFunctionality.getElementByXpath(login.driver,
		 * "(//*[@class='custom-select-item--link text-dots'])[1]", 20) .click();
		 */
	...
	public void verify_insights_count_for_each_sub_tabs() throws Throwable {
		...
		Thread.sleep(2000);
		String countbefore = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'WPIC Platinum Quarterly')]/span", 20)
				.getText();
	...
	public void verify_Sub_tabs_insights_counts_with_main_tab_count() throws Throwable {
		...
		String ceicinsight = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'CEIC Insights')]/span", 20).getText();
		int ceicinsightbefore = Integer.parseInt(ceicinsight);
		Thread.sleep(2000);

		String ASEAN = CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'ASEAN')]/span", 20)
				.getText();
		int ASEANbefore = Integer.parseInt(ASEAN);
		Thread.sleep(2000);

		String China = CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'China')]/span", 20)
				.getText();
		int Chinabefore = Integer.parseInt(China);
		Thread.sleep(2000);

		String India = CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'India')]/span", 20)
				.getText();
		int Indiabefore = Integer.parseInt(India);
		Thread.sleep(2000);

		String Europe = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'Europe')]/span", 20).getText();
		int Europebefore = Integer.parseInt(Europe);
		Thread.sleep(2000);

		String LatinAmerica = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'Latin America')]/span", 20).getText();
		int LatinAmericabefore = Integer.parseInt(LatinAmerica);
		Thread.sleep(2000);

		String World = CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'World')]/span", 20)
				.getText();
	...
	// TC_Analysistab_13
	@Given("^Verify CEIC  Insight under CEIC Insights tab$")
	public void verify_CEIC_Insight_under_CEIC_Insights_tab() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a table']", 20).click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//span[@class='name' and contains(text(),'  CEIC Insights')]", 20).click();
		Thread.sleep(2000);
	...
	public void verify_Customize_on_insight_right_click() throws Throwable {
		...
		String customizename = CommonFunctionality
				.getElementByXpath(login.driver, "(//a[@class='link insight-table-item--title-link text-dots'])[4]", 20)
				.getText();
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//a[@class='link insight-table-item--title-link text-dots'])[4]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		Thread.sleep(5000);
	...
	public void verify_insights_in_view_mode() throws Throwable {
		...
		// "(//div[@class='text-block-editor visual-select-area'])[2]",
		// 20).isDisplayed());
		Thread.sleep(5000);
	...
	public void verify_Related_Insights_in_view_mode() throws Throwable {
		...
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver,
				"//div[@class='related-insights--toggle' and contains(text(),'Related Insights')]", 20).click();
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='related-insights--container']", 20).isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_Customize_in_view_mode() throws Throwable {
		...
		Thread.sleep(2000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//a[@class='link insight-table-item--title-link text-dots'])[3]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
	...
	public void verify_CopyLink_on_view_mode() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[2]", 20)
				.click();
		Thread.sleep(1000);
		Clipboard clipboard = Toolkit.getDefaultToolkit().getSystemClipboard();
		Transferable contents = clipboard.getContents(null);
	...
	public void verify_Download_in_insight_view_mode() throws Throwable {
		...
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver,
						"//span[@class='download-modal-title__title' and contains(text(),'Download: ')]", 20)
				.isDisplayed());
		System.out.println("verified");
		Thread.sleep(3000);
	...
	public void verify_download_all_series() throws Throwable {
		...
		Thread.sleep(2000);
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='insight-preview--views-wrapper']/div[2]/div/div/a", 20)
				.click();
		Thread.sleep(1000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[2]", 20)
		.click();
	...
	public void verify_download_views_to_Excel_format() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--views-wrapper']/div[2]/div/div/a", 20)
		.click();
		Thread.sleep(1000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[2]", 20)
				.click();
		...
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='icon--export icon--export__xlsx']", 20)
				.click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver,
				"//button[@class='sphere-modal-control button insight-download__modal-button button button__download-btn']",
	...
	public void verify_download_views_to_PDF_format() throws Throwable {
		...
		Thread.sleep(2000);
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='insight-preview--views-wrapper']/div[2]/div/div/a",
		// 20).click();
		CommonFunctionality
		.getElementByXpath(login.driver, "//div[@class='insight-preview--views-wrapper']/div[2]/div/div/a", 20)
		.click();
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@data-tab='views']", 20).click();
		Thread.sleep(1000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='icon--export icon--export__pdf']", 20)
				.click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver,
				"//button[@class='sphere-modal-control button insight-download__modal-button button button__download-btn']",
	...
	public void verify_Expand_popup_in_insight_view_mode() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[3]", 20)
				.click();
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//i[@class='insight-preview--icon__expand']", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
	...
	public void verify_my_series_and_view_tabs() throws Throwable {
		...
		Thread.sleep(2000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//a[@class='link insight-table-item--title-link text-dots'])[2]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
	...
	//	System.out.println("verified");
		...
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver,
						"//div[@class='insight-preview--body']/div/div/div/div[1]/div/div[1]/div[1]", 20)
				.isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
	...
	public void verify_Download_scenario_for_Data() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[2]", 20)
				.click();
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='tabs__tabs-box']/div[1]", 20).click();
		Thread.sleep(2000);
		Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
				"//span[@class='download-area-selector__description text-dots' and contains(text(),'My Series')]", 20)
				.isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='sphere-modal__close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
	...
	public void verify_Download_scenario_for_Visuals() throws Throwable {
		...
		Thread.sleep(2000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//a[@class='link insight-table-item--title-link text-dots'])[15]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(2000);
		CommonFunctionality
		.getElementByXpath(login.driver, "//div[@class='insight-preview--views-wrapper']/div[2]/div/div[2]/div[1]/div[2]/a", 20)
		.click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[2]", 20)
				.click();
		Thread.sleep(2000);
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//span[@class='download-modal-title__title']", 20).isDisplayed());
		System.out.println("verified");
	...
	public void verify_CEIC_insight_Edit_access() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		 Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		 "(//div[@class='visual-item-template--controls'])[1]", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
	...
	public void verify_Focus_Economics_tab_under_Analysis() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "(//div[@title='View as a table'])[1]", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'CEIC Insights')]/preceding::div[1]", 20)
				.click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'FocusEconomics')]/preceding::div[1]", 20)
				.click();
		// Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		// "(//div[@class='child-container'])[2]", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_Focus_Economics_Insight() throws Throwable {
		...
		CommonFunctionality
				...
				.click();
		CommonFunctionality.getElementByXpath(login.driver,
				"//div[@class='tree-node full-expanded open']/div[3]/div[1]/div[2]", 20).click();
		Thread.sleep(5000);
		String Focuseconomic = CommonFunctionality
				.getElementByXpath(login.driver, "(//div[@class='insight-table-title-editor'])[1]", 20).getText();
	...
	public void verify_number_of_insights_for_Focus_Economics_Insight() throws Throwable {
		...
		String insightcountafter = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'ASEAN Countries')]/span", 20).getText();
	...
	public void verify_Right_click_options_Focus_Economics_Insight() throws Throwable {
		...
		Thread.sleep(5000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//div[@class='insight-table-title-editor'])[1]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		if (login.driver.findElements(By.xpath("//div[@class='items-wrapper']")).size() != 0) {
			System.out.println("Verified");
	...
	public void verify_Right_click_options_Customize_Focus_Economics_Insight() throws Throwable {
		...
		// div[@class='insight-breadcrumb--title text-dots
		// insight-breadcrumb--title__editable']
		String customizenamemyseries = CommonFunctionality.getElementByXpath(login.driver,
				"//div[@class='insight-breadcrumb--title text-dots insight-breadcrumb--title__editable insight-breadcrumb__is-explore']",
				20).getText();
		Thread.sleep(2000);
		System.out.println(customizenamemyseries + customizename);
		if (customizenamemyseries.contains(customizename)) {
	...
	public void verify_growl_message_for_Right_click_options_Customize_Focus_Economics_Insight() throws Throwable {
		...
		Thread.sleep(5000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//span[@class='context-menu--icon icon__gray icon__context-menu'])[1]", 20);
		Actions action = new Actions(login.driver);
		action.contextClick(gridmode).build().perform();
		Thread.sleep(2000);
	...
	public void verify_Right_click_options_insights_in_view_mode_Focus_Economics_Insight() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		// Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		// "(//div[@class='modal-body sphere-modal__body'])", 20).isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='sphere-modal__close']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_Expand_popup_option_in_view_mode_in_view_mode_Focus_Economics_Insight() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(2000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--actions']/div[4]", 20)
				.click();
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//i[@class='insight-preview--icon__expand']", 20).isDisplayed());
		System.out.println("verified");
	...
	public void verify_search_my_series_and_view_panels_Focus_Economics_Insight() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(5000);
		if (login.driver.findElements(By.xpath("//div[@class='insight-preview--views-wrapper']/div[2]/div/div/a"))
				.size() == 0) {
			System.out.println("Verified");
		} else {
			Assert.fail();
	...
	public void verify_Download_scenario_for_Focus_Economics_insights() throws Throwable {
		...
		Thread.sleep(2000);
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//button[@class='sphere-modal-control button insight-download__modal-button
		// button button__download-btn']", 20).click();
		Thread.sleep(8000);
		Last_file_download.getTheNewestFile();
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
	...
	public void verify_Focus_Economics_insight_Edit_access() throws Throwable {
		...
		Thread.sleep(2000);
		/*
		 * WebElement some_element = CommonFunctionality.getElementByXpath(login.driver,
		 * "//div[@class='text-block-editor visual-select-area']/p/span", 20); String
		 * readonly = some_element.getAttribute("readonly");
		 * Assert.assertNotNull(readonly);
		 */
		// Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='text-block-editor visual-select-area']/p/span",
		// 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
	...
	// TC_Analysistab_56
	@Given("^Verify WPIC tab under CEIC Insights$")
	public void verify_WPIC_tab_under_CEIC_Insights() throws Throwable {
		Thread.sleep(5000);
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[2]/span", 20)
				.click();
		...
		CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'WPIC Platinum Quarterly')]", 20)
				.click();
		Thread.sleep(5000);
		String WPIC = CommonFunctionality
				.getElementByXpath(login.driver, "(//a[@class='link insight-table-item--title-link text-dots'])[1]", 20)
				.getText();
	...
	public void verify_View_insight_Right_click_options_for_WPIC_tab() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(1000);
		Boolean view = login.driver.findElement(By.xpath("//div[@class='insight-preview--actions']")).isDisplayed();
		if(view == true)
		{
			System.out.println("Verified");
		} else {
	...
	public void verify_insights_in_view_mode_for_WPIC_tab() throws Throwable {
		...
		Thread.sleep(3000);
		// Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='visual-item-template attachments-visual visual-select-area
		// editable']", 20).isDisplayed());
		Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
				 "(//div[@class='insight-visual'])[2]", 20).isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_Expand_popup_in_view_mode_for_WPIC_tab() throws Throwable {
		...
		Thread.sleep(2000);
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='insight-preview--actions']/div[4]", 20).click();
		 Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		 "//i[@class='insight-preview--icon__collapse']", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
	...
	public void verify_search_my_series_and_view_panels_for_WPIC_tab() throws Throwable {
		...
		if (login.driver
				.findElements(
						By.xpath("//div[@class='insight-views-container']"))
				.size()!= 0) {
			System.out.println("Verified");
		} else {
			Assert.fail();
	...
	public void verify_WPIC_insight_Edit_access() throws Throwable {
		...
		Thread.sleep(5000);
	//	 Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
	//	"//div[@class='visual-item-template attachments-visual visual-select-area editable']", 20).isDisplayed());
	Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
					 "//div[@id='mainContainer']", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
	...
	// TC_Analysistab_74
	@Given("^Verify EMIS tab under CEIC Insights$")
	public void verify_EMIS_tab_under_CEIC_Insights() throws Throwable {
		Thread.sleep(8000);
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[2]/span", 20)
				.click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a table']", 20).click();
		// CommonFunctionality
		// .getElementByXpath(login.driver, "//span[contains(text(),'CEIC
		// Insights')]/preceding::div[1]", 20)
		// .click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'EMIS Insights')]/preceding::div[1]", 20)
				.click();
		CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'Asia')]", 20).click();
		Thread.sleep(3000);

		if (login.driver.findElements(By.xpath("(//a[@class='link insight-table-item--title-link text-dots'])"))
				.size() != 0) {
			System.out.println("Verified");
		} else {
			Assert.fail();
	...
	public void verify_EMIS_dropdown() throws Throwable {
		...
		Thread.sleep(5000);
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "(//div[@class='child-container'])[3]", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_EMIS_insight_count_for_dropdown() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'Asia')]", 20).click();
		Thread.sleep(5000);
		String EMISinsight = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'EMIS Insights')]/span", 20).getText();
		int EMISinsightbefore = Integer.parseInt(EMISinsight);
		Thread.sleep(2000);
		String ASIA = CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'Asia')]/span", 20)
				.getText();
		int ASIAbefore = Integer.parseInt(ASIA);
		Thread.sleep(2000);
		String CentralEurope = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'Central Eastern Europe')]/span", 20)
				.getText();
	...
	public void verify_Customize_Right_click_options_for_EMIS() throws Throwable {
		...
		/*
		 * CommonFunctionality.getElementByXpath(login.driver,
		 * "//div[@class='items-wrapper']/li[2]", 20).click(); String
		 * customizenamemyseries = CommonFunctionality.getElementByXpath(login.driver,
		 * "//div[@class='insight-breadcrumb--title text-dots insight-breadcrumb--title__editable']"
		 * , 20).getText(); Thread.sleep(2000);
		 * System.out.println(customizenamemyseries+customizename);
		 * if(!customizenamemyseries.contains(customizename)) {
		 * System.out.println("Verified"); }else { Assert.fail(); }
		 */
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_growl_message_for_Customize_on_insight_right_click_for_EMIS() throws Throwable {
		...
		Thread.sleep(2000);
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//div[@class='items-wrapper']/li[2]", 20).click();
		// CommonFunctionality.ValidateGrowlText("Selected insight(s) copied");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_insights_in_view_mode_for_EMIS() throws Throwable {
		...
		Thread.sleep(5000);
		 Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
		"//div[@id='toolbarContainer']", 20).isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality
				.getElementByXpath(login.driver, "//div[@class='search-presentation-tabs--visible']/span[1]/span", 20)
	...
	public void verify_Expand_popup_in_view_mode_for_EMIS() throws Throwable {
		...
		// "//div[@class='insight-preview--actions']/div[4]", 20).click();
		Assert.assertTrue(CommonFunctionality
				.getElementByXpath(login.driver, "//*[@class='insight-preview--icon__collapse']", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
	...
	//	Thread.sleep(8000);
		...
		if (login.driver
				.findElements(
						By.xpath("//span[@class='download-modal-title__title' and contains(text(),'Download: ')]"))
				.size() == 0) {
			System.out.println("Verified");
		} else {
			Assert.fail();
	...
	// TC_Analysistab_93
	@Given("^Verify Sentix tab under CEIC Insights$")
	public void verify_Sentix_tab_under_CEIC_Insights() throws Throwable {
	...
	public void verify_insights_counts_with_main_count_for_sentix() throws Throwable {
		...
		Thread.sleep(2000);
		String countbefore = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'Sentix')]/span", 20).getText();
		int cbefore = Integer.parseInt(countbefore);
		Thread.sleep(2000);
		List<WebElement> objLinks = login.driver
				.findElements(By.xpath("(//a[@class='link insight-table-item--title-link text-dots'])"));
	...
	public void verify_copied_URL_for_sentix() throws Throwable {
		...
		CommonFunctionality
				...
				.click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a table']", 20).click();
		//span[contains(text(),'Sentix')]/span
		CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'Sentix')]", 20).click();
		Thread.sleep(5000);
		WebElement gridmode = CommonFunctionality.getElementByXpath(login.driver,
				"(//a[@class='link insight-table-item--title-link text-dots'])[1]", 20);
	...
	public void verify_insights_in_view_mode_for_sentix() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(3000);
		Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='visual-item-template visual-select-area attachments-visual editable']", 20)
				.isDisplayed());
		Thread.sleep(5000);
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality
	...
	public void verify_search_my_series_and_view_panels_for_sentix() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		Thread.sleep(3000);
		if (login.driver.findElement(By.xpath("//div[@id='toolbarContainer']")).isDisplayed()) {
			System.out.println("Verified");
		} else {
			Assert.fail();
		}
	...
	public void verify_insight_Edit_access_for_Sentix() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']/li[1]", 20).click();
		 Assert.assertTrue(CommonFunctionality.getElementByXpath(login.driver,
				 "//div[@class='visual-item-template visual-select-area attachments-visual editable']", 20).isDisplayed());
		System.out.println("verified");
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--close']", 20).click();
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='application-logo']", 20).click();
		CommonFunctionality
