...
//		commentary.no_title_name_should_display_for_the_Commentary();
	...
	public void enter_in_the_link_field(String arg1) throws Throwable {
		ExpectedLink = arg1;
	    CommonFunctionality.getElementByXpath(login.driver, "//*[@class='links-tab--editor']/*[1]//input[@type='text']", 5).sendKeys(arg1);
//	    CommonFunctionality.getElementByXpath(driver, "//*[contains(text(),'Ok')]", 4).click();
	...
	public void the_attachment_visual_should_be_created_in_new_tab_on_current_insight() throws Throwable {
		CommonFunctionality.wait(2000);
		String ActualLink = login.driver.findElement(By.xpath("(//*[@class='attachments-item-link--row']//a)[2]")).getText();
	...
	public void the_Attachments_visual_should_be_deleted() throws Throwable {
		CommonFunctionality.wait(1500);
		if(login.driver.findElements(By.xpath("//*[contains(@class,'visual-item-template attachments-visual')]")).size() == 0) {
	...
	public void the_popup_should_be_closed_and_delete_attachments_visual_process_should_be_declined() throws Throwable {
		CommonFunctionality.wait(1500);
		if(login.driver.findElement(By.xpath("//*[contains(@class,'visual-item-template attachments-visual')]")).isDisplayed()) {
	...
	public void the_tab_should_contain_and_fields(String arg1, String arg2) throws Throwable {
	   CommonFunctionality.wait(2000);
	   Boolean link = login.driver.findElement(By.xpath("//*[@class='tabs__tabs-box']//*[contains(text(),'" + arg1 + "')]")).isDisplayed();
	   Boolean title = login.driver.findElement(By.xpath("//*[@class='links-tab--editor']//*[contains(text(),'" + arg2 + "')]")).isDisplayed();
	...
	public void the_link_should_be_created_above() throws Throwable {
	    ...
	    String ActualLink = login.driver.findElement(By.xpath("//*[@class='links-tab']//*[@class='attachments-item-link--row']//a")).getText();
	    if(ActualLink.contains(ExpectedLink)) {
	...
	public void type_any_name_in_the_title_field() throws Throwable {
		 CommonFunctionality.getElementByXpath(login.driver, "//*[@class='links-tab--editor']/*[2]//input[@type='text']", 5).sendKeys("Title");
	}
	...
	public void the_OK_button_should_be_disabled_until_enter_links_for_the_tilte() throws Throwable {
	    Boolean button_ok = login.driver.findElement(By.xpath("//*[@class='links-tab--buttons']//*[contains(text(),'Ok')]")).isEnabled();
	    if(!button_ok == true) {
	...
	public void the_OK_and_cancel_buttons_should_be_disabled() throws Throwable {
		 Boolean button_ok = login.driver.findElement(By.xpath("//*[@class='links-tab--buttons']//*[contains(text(),'Ok')]")).isEnabled();
		 Boolean button_cancel = login.driver.findElement(By.xpath("//*[@class='links-tab--buttons']//*[contains(text(),'Cancel')]")).isEnabled();
	...
	public void click_on_edit_icon_for_the_link() throws Throwable {
	   CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'attachments-item-link--icon__edit')])[2]", 5).click();
	...
	public void the_link_and_title_should_be_restored_to_respective_fields_to_edit() throws Throwable {
	    CommonFunctionality.wait(1500);
		Boolean Link = login.driver.findElement(By.xpath("//*[@class='links-tab--editor']/*[1]//input[@type='text']")).getText().isEmpty();
		Boolean Title = login.driver.findElement(By.xpath("//*[@class='links-tab--editor']/*[2]//input[@type='text']")).getText().isEmpty();
	...
	public void click_on_delete_icon_for_the_link() throws Throwable {
		 CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'attachments-item-link--icon__delete')])[2]", 5).click();
 	}

	@Then("^The link should be deleted$")
	public void the_link_should_be_deleted() throws Throwable {
		CommonFunctionality.wait(1200);
	    Boolean empty_visual = login.driver.findElement(By.xpath("//*[@class='empty-visual-overlay--content']")).isDisplayed();
	...
	public void click_on_the_link() throws Throwable {
	   ...
	   CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='attachments-item-link--row']//a)[2]", 5).click();
	}
	...
	public void the_Link_should_be_saved() throws Throwable {
		CommonFunctionality.wait(1000);
	   boolean link = login.driver.findElement(By.xpath("(//*[@class='attachments-item-link--row']//a)[2]")).isEnabled();
	   if(link == true) {
...
public void try_to_upload_multiple_files_in_the_same_visual() throws Throwable {
	...
	CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'attachments-uploader dropzone dz-clickable ')]", 8).click();
	CommonFunctionality.wait(2000);
...
public void should_allow_to_upload_multiple_files_to_the_visual() throws Throwable {
	CommonFunctionality.wait(500);
    List<WebElement> list_files = login.driver.findElements(By.xpath("//*[@class='uploader-tab--files-list']//div[@js-type='file']"));
...
public void all_the_contents_should_be_removed_from_the_attachments_visual() throws Throwable {
	CommonFunctionality.wait(2000);
	if(login.driver.findElements(By.xpath("//*[@class='links-tab--list']//*[@class='attachments-item-link--row']//a")).size() == 0) {
...
public void uploaded_image_should_be_removed() throws Throwable {
	...
	if (insight_url.contains("https://stage.ceicdata.com") && insight_url.contains("null") || insight_url.contains("https://insights.ceicdata.com") && insight_url.contains("null") ) {
