...
public class Breakdown extends CommonFunctionality {
	...
	public void expand_Global_database_till(String arg1) throws Throwable {
		...
		getElementByXpath(login.driver, "//*[@data-node-model-id='GLOBAL']/*[1]", 20).click();
		getElementByXpath(login.driver, "//*[@data-node-model-id='GLOBAL']/*[3]/*[1]/*[1]", 20).click();
	...
	public void expand_till_first_table_level(String arg1) throws Throwable {
		getElementByXpath(login.driver, "//*[contains(text(),'" + arg1 + "')]/preceding::*[@class='toggle'][1]", 20)
				.click();
		getElementByXpath(login.driver, "//*[contains(@class,'open last-open-node')]/*[3]/*[1]/*[1]", 20).click();
	...
	public void the_series_should_be_grouped() throws Throwable {
		...
		Boolean Breakdown_control = login.driver
				.findElement(By.xpath("//*[contains(@class,'indented-series__with-breakdown')]")).isDisplayed();
	...
	public void the_series_grouped_previously_should_be_un_grouped() throws Throwable {
		...
		if (login.driver.findElements(By.xpath("//*[contains(@class,'indented-series__with-breakdown')]")).size() == 0
				&& GroupCheckbox == false) {
	...
	public void click_on_option_for_the_first_group(String arg1) throws Throwable {
		WebElement countryName_firstGroup = getElementByXpath(login.driver,
	...
	public void open_Breakdown_tab_and_select_a_few_series() throws Throwable {
		...
		List<WebElement> listOfElements = login.driver.findElements(By.xpath(
				"(//*[@class='breakdown-container breakdown-container__breakdown-visible'])[2]//ul//div//span[contains(@class,'svg-checkbox')]"));
	...
	public void open_Breakdown_tab_and_click(String arg1) throws Throwable {
		...
		new Actions(login.driver).pause(200).moveToElement(ele).build().perform();
		wait(200);
		getElementByXpath(login.driver, "(//*[contains(text(),'Select All')])[2]", 8).click();
		SelectAllSeries();
	}
	...
	public void open_Breakdown_tab_and_select_a_series_and_click_on_chart_icon() throws Throwable {
		getElementByXpath(login.driver, "//*[contains(text(),'Breakdowns')]", 20).click();
		WebElement ele1 = getElementByXpath(login.driver,
				"(//*[@class='breakdown-container breakdown-container__breakdown-visible'])[2]//ul/*[1]//*[@class='series-list-item--checkbox-wrapper']/*",
				6);
		new Actions(login.driver).moveToElement(ele1).build().perform();
		ele1.click();
		WebElement ele = getElementByXpath(login.driver,
				"(//*[@class='breakdown-container breakdown-container__breakdown-visible'])[2]//ul/*[1]//*[@class='series-item--name']",
				20);
		new Actions(login.driver).pause(200).moveToElement(ele).build().perform();
		...
		// Clicking Chart icon
		wait(200);
		WebElement ele2 = getElementByXpath(login.driver,
				"(//*[@class='breakdown-container breakdown-container__breakdown-visible'])[2]//ul/*[1]//*[@class='view-chart-icon menu-icon']",
				8);
	...
	public void respective_chart_should_be_created() throws Throwable {
		wait(500);
		String ChartTitle = getElementByXpath(login.driver, "//*[@data-name='title']", 8).getText();
	...
	public void click_to_open_SSP_window() throws Throwable {
		getElementByXpath(login.driver, "//*[@class='series-name-field--series-name']", 8).click();
	}
	...
	public void respective_series_has_to_be_drilled_down() throws Throwable {
		...
		wait(1000);
		boolean Drilldown_link = login.driver.findElement(By.xpath("//*[@class='legend-drilldown--link']"))
				.isDisplayed();
	...
	public void drilled_down_series_should_reset_back_to_original_series() throws Throwable {
		...
		boolean backButton = login.driver.findElement(By.xpath("//*[@class='breakdown-preview--back']")).isDisplayed();
		wait(300);
		if (login.driver.findElements(By.xpath("//*[@class='legend-drilldown--link']")).size() == 0
				&& !backButton == true) {
	...
	public void expand_till_second_table_level(String arg1) throws Throwable {
		getElementByXpath(login.driver, "//*[contains(text(),'" + arg1 + "')]/preceding::*[@class='toggle'][1]", 20)
				.click();
		getElementByXpath(login.driver, "//*[contains(@class,'open last-open-node')]/*[3]/*[2]/*[1]", 20).click();
	}

	void SelectAllSeries() throws Exception {
		List<WebElement> listOfElements = login.driver.findElements(By.xpath(
				"(//*[@class='breakdown-container breakdown-container__breakdown-visible'])[2]//ul/*//*[@class='series-item--name']"));
		for (int i = 0; i < listOfElements.size(); i++) {
			// int j = i + 1;
			wait(200);
			...
			new Actions(login.driver).pause(100)
					.moveToElement(login.driver.findElement(By.xpath("//*[contains(text(),'Breakdowns')]"))).build()
					.perform();
