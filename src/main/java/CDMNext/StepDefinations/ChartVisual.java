...
public class ChartVisual {
	...
	public int chart_decimal_places;
	...
	public void read_the_from_excel(String arg1,String arg2,String arg3) throws Throwable {
		...
		if(date.getCellType() == Cell.CELL_TYPE_NUMERIC) {
	        ...
	        //Creating a date array for comparison of excel observation date with application observation date
	...
	public void observe_the_entire_list_of(String arg1) throws Throwable {
	    ...
	    List<WebElement> timepoints = login.driver.findElements(By.className("preview-series-time-points--point-value"));
		...
		List<WebElement> all_date = login.driver.findElements(By.className("preview-series-time-points--point-date"));
	...
	public void close_the_chart_visual() throws Throwable {
		if (login.driver.findElements(By.className("movable-modal--close")).size() > 0) {
			...
			if(login.driver.findElements(By.cssSelector("button.sphere-modal-control.button.button__primary")).size()>0) {
				CommonFunctionality.getElementBycssSelector(login.driver, "button.sphere-modal-control.button.button__primary", 4).click();
			}
		}
	...
	public void hover_over_the_legend_title() throws Throwable {
		...
		WebElement series = CommonFunctionality.getElementBycssSelector(login.driver,".series-edit--title__editable", 4);	
	...
	public void drag_and_Drop_the_series_into_right() throws Throwable {
		...
		chart_visual_title = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='title']", 4).getText();
	}
	...
	public void activate_the_header(String arg1) throws Throwable {
		WebElement axis = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'accordion-tabbar--header-tab') and contains(text(),'"+arg1+"')]", 4);
	...
	public void enter_and_seperator_for_Value_axis(String decimal, String grouping) throws Throwable {
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Decimal separator']/following::span[text()=\""+decimal+"\"][1]", 4).click();
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Grouping separator']/following::span[text()=\""+grouping+"\"]", 4).click();
	} 
	...
	public void select_and_separator_from_dropdown(String number, String decimal) throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Number separators']/following::div[1]//a/span[2]", 4).click();
		CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'select2-drop-active')]//*[contains(text(),\""+number_separator+"\")]", 4).click();
		CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='Number separators']//following::div/a/span[2])[2]", 4).click();
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='select2-result-label']//*[contains(text(),\""+decimal_separator+"\")]", 4).click();
	} 
	...
	public void select_and_separator_from_dropdown_list(String decimal,String group) throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Decimal separator']//following::*[contains(text(),\""+data_format_separator+"\")][1]", 4).click();
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Grouping separator']//following::*[contains(text(),\""+data_format_grouping_separator+"\")][1]", 4).click();
	}
	...
	if(arg2.equalsIgnoreCase("Decimal separator")) {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg2+"']//following::*[contains(text(),\""+data_format_separator+"\")][1]", 4).click();
	} if(arg2.equalsIgnoreCase("Grouping separator")) {
		data_format_grouping_separator = arg1;
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg2+"']//following::*[contains(text(),\""+data_format_grouping_separator+"\")][1]", 4).click();
	} if(arg2.equalsIgnoreCase("Decimal places")) {
		String value = arg1;
		chart_decimal_places = Integer.parseInt(value);
		WebElement input = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg2+"']/following::input[1]", 4);
	...
	public void copy_the_myseries_title() throws Throwable {
	   CommonFunctionality.wait(3000);
	   myseriestitle = CommonFunctionality.getElementByClassName(login.driver, "series-name-field--series-name", 4).getText();
	}
	...
	public void double_click_on_highcharts(String arg1) throws Throwable {
		CommonFunctionality.wait(1000);
		WebElement title = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='"+arg1+"']", 4);
	...
	public void select_series_chart_color_from_list(String arg1) throws Throwable {
		...
		CommonFunctionality.Hidden_Webelements_handling(login.driver, "xpath", "//*[@title='" + series_chart_color + "']");
	}
	...
	public void select_legend_border_color_from_list(String arg1) throws Throwable {
		...
		CommonFunctionality.Hidden_Webelements_handling(login.driver, "xpath", "//*[@title='" + legend_border_color + "']");
	}
	...
	public void select_the_tooltip_border_color_from_list(String arg1) throws Throwable {
		...
		CommonFunctionality.Hidden_Webelements_handling(login.driver, "xpath", "//*[@title='" + tooltip_border_color + "']");
	}
	...
	public void select_the_y_axis_right_color_from_list(String arg1) throws Throwable {
		...
		CommonFunctionality.Hidden_Webelements_handling(login.driver, "xpath", "//*[@title='" + y_axis_right_color + "']");
	...
	public void select_the_y_axis_right_bgcolor_from_list(String arg1) throws Throwable {
		...
		CommonFunctionality.getElementByProperty(login.driver, "axis_highlight_color_right", 4)
				.click();
	}
	...
	public void get_the_series_title() throws Throwable {
		series_title = CommonFunctionality.getElementBycssSelector(login.driver, ".series-edit--title__editable", 4).getText();
	}
	...
	public void get_the_text_of_Edit_series_option() throws Throwable {
	   if(CommonFunctionality.getElementBycssSelector(login.driver, ".sidebar-panel__opened", 4).isDisplayed()) {
		   edit_series_title = CommonFunctionality.getElementBycssSelector(login.driver, ".series-name--title", 4).getText();
	   } else {
	...
	public void check_the_checkbox_by_default(String arg1) throws Throwable {
		zoom_checkbox = login.driver.findElement(By.xpath("//*[text()='"+arg1+"']/preceding-sibling::input")).isSelected();
	...
	public void select_data_label_of(String data_label,String arg2) throws Throwable {
		if (arg2.equalsIgnoreCase("Point markers")) {
			CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg2+"']//following::div/a", 4).click();
			CommonFunctionality.getElementByXpath(login.driver, "//*[@class='select2-results']//*[contains(text(),'"+data_label+"')]", 4).click();
			point_marker = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg2+"']//following::div/a/span/span | //*[text()='"+arg2+"']//following::div/a/span", 4).getText();
		}
	}
	...
	public void select_any_for_chart_visual(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("image")) {
			...
			data_labels_bold = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='data_labels_font_weight']",
					4);
			data_labels_italic = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='data_labels_font_style']",
					4);
			...
			legends_bold = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='legend_title_font_weight']", 4);
			legends_italic = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='legend_title_font_style']", 4);
			legends_underline = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='legend_title_font_underline']", 4);
			...
			copyrights_bold = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='credits_font_weight']", 4);
			copyrights_italic = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='credits_font_style']", 4);
			copyrights_underline = CommonFunctionality.getElementBycssSelector(login.driver, "button[name='credits_font_underline']", 4);
			...
			y_axis_left_bold = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='y_axis_font_weight']", 4);
			y_axis_left_italic = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='y_axis_font_style']", 4);
			y_axis_left_underline = CommonFunctionality.getElementByXpath(login.driver,"//*[@name='y_axis_font_underline']", 4);
			...
			y_axis_right_bold = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='opposite_y_axis_font_weight']", 4);
			y_axis_right_italic = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='opposite_y_axis_font_style']", 4);
			y_axis_right_underline = CommonFunctionality.getElementByXpath(login.driver,"//*[@name='opposite_y_axis_font_underline']", 4);
	...
	public void select_for_chart_visual_to(String arg1, int arg2) throws Throwable {
		if (arg1.equalsIgnoreCase("Values Axis Lines width")) {
			...
			WebElement size = CommonFunctionality.getElementBycssSelector(login.driver, "input[name='legend_title_font_size']", 4);
			...
			WebElement size = CommonFunctionality.getElementBycssSelector(login.driver, "input[name='credits_font_size']", 4);
			...
			WebElement size = CommonFunctionality.getElementBycssSelector(login.driver, "input[name='legend_border_width']", 4);
			...
			WebElement size = CommonFunctionality.getElementBycssSelector(login.driver, "input[name='legend_border_radius']", 4);
	...
	public void select_visual_from_dropdown(String arg1, String arg2) throws Throwable {
		if (arg1.equalsIgnoreCase("Border Type")) {
			CommonFunctionality.getElementByXpath(login.driver,
					"//*[text()='Visual border']//following::*[text()='Style']/preceding::*[@id='s2id_autogen31']", 4)
					.click();
			CommonFunctionality.wait(2000);
			CommonFunctionality.getElementByXpath(login.driver, "//*[@id='select2-result-label-46']", 4).click();
			CommonFunctionality.wait(2000);
		}
	}
	...
	public void expand_section_from_popup(String arg1, String arg2) throws Throwable {
		if (arg2.equalsIgnoreCase("Values Axis")) {
			if (login.driver
				...
				WebElement active = CommonFunctionality.getElementByXpath(login.driver,
						"//*[contains(@class,'accordion-tabbar--header-tab') and contains(text(),'Axis')] | //*[@class='popover--title' and contains(text(),'Legend')]", 4);
				if (active.getAttribute("class").contains("active")) {
					CommonFunctionality.getElementByXpath(login.driver,"//*[@class='accordion-header']//following-sibling::*[text()='" + arg1 + "']", 4).click();
				} else {
		...
		if (arg2.equalsIgnoreCase("Time Axis") || arg2.equalsIgnoreCase("Tooltip") || arg2.equalsIgnoreCase("Labels")) {
			if (login.driver.findElements(By.xpath("//*[@class='popover--wrapper']//following-sibling::*[text()='" + arg2 + "']"))
					.size() > 0) {
				WebElement click = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='accordion-header']//following-sibling::*[text()='"+arg1+"']/ancestor::div[2]", 4);
	...
	public void expand_from_popup(String legend_expand, String arg2) throws Throwable {
		if(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='popover--wrapper']//*[text()='"+arg2+"']", 4).isDisplayed()) {
		  if(legend_expand.equalsIgnoreCase("Size")) { 
			WebElement legand = CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_expand+"']/ancestor::div[2])[2]", 4);
			if(!(legand.getAttribute("class").contains("collapsed"))) {
		    	CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_expand+"'])[2]", 4).click();
		    } else {
		    	System.out.println(legend_expand+" is already in Collapsed state");
		    	CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_expand+"'])[2]", 4).click();
		    }
		    } else if(!(legend_expand.equalsIgnoreCase("Size"))) {
		    WebElement legand = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_expand+"']/ancestor::div[2]", 4);
			if(!(legand.getAttribute("class").contains("collapsed"))) {
		    	CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_expand+"']", 4).click();
		    } else {
		    	System.out.println(legend_expand+" is already in Collapsed state");
		    	CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_expand+"']", 4).click();
		    }
	...
	public void collapse_from_popup(String legend_collapse, String arg2) throws Throwable {
		if(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='popover--wrapper']//*[text()='"+arg2+"']", 4).isDisplayed()) {
			...
			WebElement legand = CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_collapse+"']/ancestor::div[2])[2]", 4);
			if(legand.getAttribute("class").contains("collapsed")) {
		    	CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_collapse+"'])[2]", 4).click();
		    } else {
		    	System.out.println(legend_collapse+" is already in Expanded state");
		    	CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+legend_collapse+"'])[2]", 4).click();
		    }
		} else if(!(legend_collapse.equalsIgnoreCase("Size"))) {
		   WebElement legand = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_collapse+"']/ancestor::div[2]", 4);
			if(legand.getAttribute("class").contains("collapsed")) {
		    	CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_collapse+"']", 4).click();
		    } else {
		    	System.out.println(legend_collapse+" is already in Expanded state");
		    	CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+legend_collapse+"']", 4).click();
		    }
	...
	public void expanding_section_from_popup(String arg1, String arg2,String arg3) throws Throwable {
		if (arg2.equalsIgnoreCase("Values Axis")) {
			if (login.driver.findElements(By.xpath("//*[@class='popover--wrapper']//following-sibling::*[text()='" + arg2 + "']")).size() > 0) {
				WebElement active = CommonFunctionality.getElementByXpath(login.driver,"//*[contains(@class,'accordion-tabbar--header-tab') and contains(text(),'"+arg3+"')]", 4);
				if (active.getAttribute("class").contains("active")) {
					if(arg3.equalsIgnoreCase("Right Axis")) {
					WebElement collapse = CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+arg1+"']/ancestor::div[2])[2]", 4);
					if(!collapse.getAttribute("class").contains("collapsed")) {
					CommonFunctionality.getElementByXpath(login.driver,"(//*[@class='accordion-header']//following-sibling::*[text()='" + arg1 + "'])[2]", 4).click();
					CommonFunctionality.getElementByXpath(login.driver,"(//*[@class='accordion-header']//following-sibling::*[text()='" + arg1 + "'])[2]", 4).click();
					} else {
						CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+arg1+"'])[2]",4).click();
					}
					} else {
					WebElement collapse = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg1+"']/ancestor::div[2]", 4);
					if(!collapse.getAttribute("class").contains("collapsed")) {
					CommonFunctionality.getElementByXpath(login.driver,"//*[@class='accordion-header']//following-sibling::*[text()='" + arg1 + "']", 4).click();
					CommonFunctionality.getElementByXpath(login.driver,"//*[@class='accordion-header']//following-sibling::*[text()='" + arg1 + "']", 4).click();
					}
	...
	public void right_Click_the_Add_to_Related_series() throws Throwable {
		WebElement context = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-title--text.text-dots , .empty-visual-overlay--link", 4);
	...
	public void verify_the_field_is_disabledl(String arg1) throws Throwable {
		if(arg1.equalsIgnoreCase("color")) {
			...
			if (color.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
				cv.clicking_option("Save");
				if(!(CommonFunctionality.getElementByProperty(login.driver, "value_lines", 8).getAttribute("stroke") == null || login.driver.findElement(By.cssSelector(".highcharts-container > svg > g:nth-child(6) > path:first-child")).getAttribute("stroke") == null)) {
					fail("Verification Failed");
				}
			} else {
				fail("Verification Failed");
			...
			WebElement color = CommonFunctionality.getElementByProperty(login.driver, "tooltip_border_color_disabled", 4);
			if (color.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
				cv.clicking_option("Save");
				List<WebElement> timepoints = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]"));
				for (int i = 1; i <= timepoints.size(); i++) {
					WebElement timepoint = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]["+i+"]",4);
					new Actions(login.driver).moveToElement(timepoint).pause(10).build().perform();
					if(!(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-label-box highcharts-tooltip-box']", 4).getAttribute("stroke") == null)) {
					fail("Verification Failed");	
					}
					WebElement title = CommonFunctionality.getElementByXpath(login.driver,"//*[contains(@class,'visual-title--text') and @data-name='title']", 4);
			...
			WebElement color = CommonFunctionality.getElementByProperty(login.driver, "tooltip_border_width_disabled", 4);
			if (color.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
				cv.clicking_option("Save");
				List<WebElement> timepoints = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]"));
				for (int i = 1; i <= timepoints.size(); i++) {
					WebElement timepoint = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]["+i+"]",4);
					new Actions(login.driver).moveToElement(timepoint).pause(10).build().perform();
					if(!(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-label-box highcharts-tooltip-box']", 4).getAttribute("stroke-width") == null)) {
					fail("Verification Failed");
					}
					WebElement title = CommonFunctionality.getElementByXpath(login.driver,"//*[contains(@class,'visual-title--text') and @data-name='title']", 4);
					new Actions(login.driver).moveToElement(title).pause(2).build().perform();
			...
			if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
				cv.clicking_option("Save");
				if(!(CommonFunctionality.getElementByProperty(login.driver, "value_lines", 8).getAttribute("stroke-width") == null || login.driver.findElement(By.cssSelector(".highcharts-container > svg > g:nth-child(6) > path:first-child")).getAttribute("stroke-width") == null)) {
					fail("Verification Failed");
				} 
			} else {
				fail("Verification Failed");
		...
		WebElement width = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Title']/following::div[9]", 4);
		if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
			cv.clicking_option("Save");
		...
		WebElement width = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Background']/following::div[8]", 4);
		if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
			cv.clicking_option("Save");
			String bgcolor = CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("fill");
		...
		WebElement width = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='border-settings--container']//div[1]", 4);
		if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
			cv.clicking_option("Save");
			if(!(CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("stroke") == null)) {
				fail("Verification Failed");
			}
		} else {
			fail("Verification Failed");
		...
		WebElement width = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='border-settings--container']//div[2])[3]", 4);
		if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
			cv.clicking_option("Save");
			if(!(CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("stroke-width") == null)) {
				fail("Verification Failed");
			}
		} else {
			fail("Verification Failed");
		...
		WebElement width = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='border-settings--container']//div[3]", 4);
		if (width.getAttribute("class").contains("disabled") && values_axis_checkboxes_uncheck == false) {
			cv.clicking_option("Save");
			CommonFunctionality.wait(2000);
	    	String radius = CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("rx");
	    	int actual = Integer.parseInt(radius);
	    	int expected = 0;
	    	assertEquals(actual, expected);
	    	String radius1 = CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("ry");
	   ...
	   for(WebElement element : elements3) {
		...
		List<WebElement> elements = login.driver.findElements(By.xpath("//*[contains(@class,'highcharts-yaxis-labels highcharts-yaxis-left')]/*[3][not(@x='0')]"));
		   ...
		   for(WebElement element : elements3) {
			...
			CommonFunctionality.Views_list();
		} if(arg1.equals("before") && arg2.equalsIgnoreCase("Logarithmic") && arg3.equalsIgnoreCase("Left Axis") && axis_setup_checkboxes_uncheck == false) {
		...
		} if(arg1.equals("after") && arg2.equalsIgnoreCase("Logarithmic") && arg3.equalsIgnoreCase("Left Axis") && time_axis_checkboxes == true) {
		   List<WebElement> elements = login.driver.findElements(By.xpath("//*[contains(@class,'highcharts-yaxis-labels highcharts-yaxis-left')]//*[not(@y='-9999')]"));
		   ...
		   CommonFunctionality.Views_list();
		} if(arg1.equals("before") && arg2.equalsIgnoreCase("Reversed direction") && arg3.equalsIgnoreCase("Right Axis") && axis_setup_checkboxes_uncheck_right == false) {
		...
		} if(arg1.equals("after") && arg2.equalsIgnoreCase("Reversed direction") && arg3.equalsIgnoreCase("Right Axis") && axis_checkboxes_right == true) {
		...
		CommonFunctionality.Views_list();	
		   ...
		   CommonFunctionality.Views_list();
		} if(arg1.equals("after") && arg2.equalsIgnoreCase("Set as the default axis") && arg3.equalsIgnoreCase("Left Axis") && time_axis_checkboxes == true) {
			cv.search_for_the_series_with_SID("357534787");
			cv.click_on_more_actions_to_create("View as Chart");
		   if(login.driver.findElements(By.xpath("//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']")).size()==1) {
			   login.Log4j.info("The "+arg2+"of "+arg3+" has been verified successfully");
		   } else {
			   fail("Verification Failed");
		   }
	...
	public void hover_to_the_series_option_and_get_text() throws Throwable {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".series-name--title", 4)).pause(1000).build().perform();
	    series_name_text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Name:')]/following-sibling::*", 4).getText();
	}
	...
	public void click_credits_image() throws Throwable {
		CommonFunctionality.wait(2000);
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "visual-item-wrapper--credits-image", 4)).pause(500).click().build().perform();
	}
	
	@And("^Click the Functions input box$")
	public void click_the_Functions_input_box() throws Throwable {
	    CommonFunctionality.getElementBycssSelector(login.driver, "input[class='current-function-input--field']", 4).click();
	}
	...
	public void enter_the_function() throws Throwable {
		WebElement element = CommonFunctionality.getElementBycssSelector(login.driver, "input[class='current-function-input--field']", 4);
		element.sendKeys("%");
		CommonFunctionality.wait(200);
	...
	public void click_on_Currency_in_functions_box() throws Throwable {
		CommonFunctionality.wait(3000);
	    String function = CommonFunctionality.getElementByClassName(login.driver, "series-function-item--body", 4).getText();
	...
	public void clicking_Download_button(String arg1) throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='page-main-header--buttons']//following::*[contains(@class,'button__download-btn')]", 4).click();
		CommonFunctionality.wait(2000);
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='page-main-header--buttons']//following::*[contains(@class,'button__download-btn')]", 4).click();
		//CommonFunctionality.getElementByXpath(login.driver, "//div[@data-tab='series']", 4).click();
		if(login.driver.findElements(By.xpath("//*[contains(@class,'modal-body')]//*[contains(@class,'button__download-btn')]")).size()>0) {
			CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'modal-body')]//*[contains(@class,'button__download-btn')]", 4).click();
		}
	...
	public void click_on_button_in_myseries(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("More actions")) {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'show-context ') and @title='"+arg1+"']", 4)).click().build().perform();
	    } if(arg1.equalsIgnoreCase("Frequency")) {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[class='context-menu-item link'][title='"+arg1+"']", 4)).click().build().perform();
	    } else {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='"+arg1+"']", 4)).click().build().perform();
	    }
	}
	...
	public void click_on_More_actions_button_in_myseries() throws Throwable {
		CommonFunctionality.wait(3000);
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'show-context ') and @title='More actions']", 4)).click().build().perform();
	}
	
	@And("^Click on Unselect all button in myseries$")
	public void click_on_Unselect_all_button_in_myseries() throws Throwable {
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='Unselect all']", 4)).click().build().perform();
	}
	
	@And("^Click on Delete button in myseries$")
	public void click_on_Delete_button_in_myseries() throws Throwable {
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'context-menu-item') and @title='Delete']", 4)).click().build().perform();
	}
	
	@And("^Select the \"([^\"]*)\" position$")
	public void select_the_position(String arg1) throws Throwable {
	    data_position = arg1;
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "button[data-value='"+data_position+"']", 4)).click().build().perform();
	...
	public void hover_over_to_Option(String arg1) throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'visual-series-list--remove-row')]//*[@title='"+arg1+"']", 4)).build().perform();
	}
	
	@And("^Click on \"([^\"]*)\" button from myseries$")
	public void click_on_button_from_myseries(String frequency) throws Throwable {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='"+frequency+"']", 4)).click().build().perform();
	  }
	...
	public void click_on_button_in_myseries_list(String currency) throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='"+currency+"']", 4)).click().build().perform();
	}
	
	@And("^Click on \"([^\"]*)\" button from myseries list$")
	public void click_on_button_from_myseries_list(String change) throws Throwable {
	    String text = change;
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='"+change+"']", 4)).click().build().perform();
	...
	public void enter_the_Series_name_as(String arg1) throws Throwable {
	   ...
	   if(login.driver.findElements(By.cssSelector(".movable-modal--window")).size()>0) {
	    WebElement series = CommonFunctionality.getElementBycssSelector(login.driver, ".find-and-replace-item--name-input", 4);
	    series.clear();
	...
	public void verify_the_Copied_message_from_myseries() throws Throwable {
	    if(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'growl-messages-container')]", 4).isDisplayed()) {
	...
	public void capture_Screenshot() throws Throwable {
		...
		destFile = System.getProperty("user.dir") + "\\Screenshot_Images\\" + "Image_" + formatter.format(date)+ ".png";
	...
	public void click_on_in_Keep_insight_option(String arg1) throws Throwable {
		...
		if (login.driver.findElements(By.xpath("//*[@class='movable-modal--window']//*[text()='Do you want to keep your insight?']")).size() > 0) {
			CommonFunctionality.getElementByXpath(login.driver,"//*[@class='movable-modal--window']//*[text()='"+arg1+"']", 4).click();
		}
	}
	...
	public void should_displayed(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("Correct Observations")) {
			List<WebElement> observations = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden')]"));
	...
	public void get_the_text_of_sub_dropdowns_available() throws Throwable {
		...
		/*if(rightclick_element.contains(d)) {
	    	...
	    	System.out.println("The function options are present inside the "+d);
	    	} else {
	...
	public void click_on_inside_the_visual(String arg1) throws Throwable {
	    WebElement series = CommonFunctionality.getElementByXpath(login.driver, "//span[@title='Edit series' and @class='context-menu-item link'] | //span[@title='Clear contents' and @class='context-menu-item link']", 4);
	    new Actions(login.driver).moveToElement(series).pause(500).click().build().perform();
	}
	...
	public void select_tabs(String arg1, String arg2, String arg3, String arg4) throws Throwable {
		CommonFunctionality.wait(3000);
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='highcharts-range-selector-buttons']//*[text()='"+arg1+"']", 4).click();
		CommonFunctionality.wait(3000);
	...
	public void the_Default_title_for_Chart_visual_is(String arg1) throws Throwable {
		CommonFunctionality.wait(4000);
		String chart_title = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='title']", 4).getText();
	...
	public void the_Selected_data_value_should_reflect_in_the_chart_visual_legand() throws Throwable {
    	...
    	String position = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-item-wrapper--credits-container", 4).getCssValue("justify-content");
	...
	public void the_chart_should_update_the_selected(String arg1, String arg2, String arg3) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("Color")) {
			CommonFunctionality.wait(2000);
			String text_color = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='"+arg3+"']", 4).getCssValue("color");
			String actual = Color.fromString(text_color).asHex();
			assertEquals(actual, color);
		}
		if (arg2.equalsIgnoreCase("Highlight color")) {
			CommonFunctionality.wait(2000);
			String text_bgcolor = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='"+arg3+"']", 4).getCssValue("background-color");
	...
	public void the_chart_should_update_the_font_size_value_to_for_chart(int arg1, String arg2) throws Throwable {
		...
		String fontsize = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='"+arg2+"']", 4).getCssValue("font-size");
	...
	public void the_chart_should_update_the_selected(String arg1, String arg2) throws Throwable {
		...
		WebElement title = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='"+arg2+"']", 4);
	...
	public void the_chart_should_update_the_subtitle_name_to(String arg1) throws Throwable {
		if (checkbox2 == true
				&& login.driver.findElements(By.cssSelector("span[data-name='sub_title']")).size() == 1) {
			String subtitle = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='sub_title']", 4).getText();
	...
	public void the_color_of_background_should_be_updated() throws Throwable {
		String text_color = CommonFunctionality
				.getElementByXpath(login.driver, "(//*[@class='highcharts-plot-background'])[3]", 4)
				.getCssValue("fill");
		String actual = Color.fromString(text_color).asHex();
		assertEquals(actual, color);
	}
	...
	public void the_color_of_border_should_be_updated() throws Throwable {
		...
		String stroke = CommonFunctionality.getElementByXpath(login.driver,
				"//*[@class='highcharts-plot-border']", 4).getAttribute("stroke");
	...
	public void and_should_reflect_on_the_chart(String arg1, String arg2) throws Throwable {
		CommonFunctionality.wait(3000);
		if (arg1.equalsIgnoreCase("Color")) {
			String coloring = CommonFunctionality.getElementByProperty(login.driver, "chart_axes_multipler_value_dash", 4)
					.getCssValue("color");
	...
	public void the_changes_should_reflect_on_the_chart(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("Size")) {
			...
			CommonFunctionality.wait(2000);
			String format = login.driver.findElement(By.xpath("//*[contains(@class,'highcharts-xaxis-labels')][1]/*[1]")).getText();
		...
		if (arg1.equalsIgnoreCase("Value Axis color")) {
			...
			if (login.driver.findElements(By.xpath(login.LOCATORS.getProperty("time_axis_label_text"))).size() > 0
					&& login.driver.findElements(By.xpath(login.LOCATORS.getProperty("time_axis_label_axis_colr_text")))
							.size() > 0) {
				String time_label_color = login.driver.findElement(By.xpath("//*[contains(@class,'highcharts-xaxis-labels')][1]/*[1]")).getCssValue("fill");
	...
	public void should_reflect_on_the_chart_visual(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("Time Axis Title font size")) {
			...
			CommonFunctionality.wait(3000);
			WebElement title = login.driver.findElement(By.xpath("//*[contains(@class,'highcharts-xaxis-labels')][1]/*[1]"));
			String font_bold = title.getCssValue("font-weight");
			String font_italic = title.getCssValue("font-style");
			String font_underline = title.getCssValue("text-decoration");
			assertTrue(font_bold.equals("bold") || font_bold.equals("700"));
	...
	public void excel_data_is_compared_with_application_data() throws Throwable {
		...
		login.Log4j.info("Both the excel and application 'timepoints' and 'date' are displaying fine and has been verified successfully");
		CommonFunctionality.Views_list();
	}
	...
	public void The_SSP_timepoints_inside_series_are_compared_with_timepoints_reflecting_in_visual() throws Throwable {
		...
		login.Log4j.info("The SSP timepoints inside series are compared with timepoints reflecting in visual and has been verified successfully");
		CommonFunctionality.Views_list();
	}
	@SuppressWarnings("deprecation")
	...
	if(arg1.equalsIgnoreCase("Decimal seperator") && arg2.equalsIgnoreCase("Grouping seperator")) {
		cv.clicking_option("Save");
		List<WebElement> data_formats = login.driver.findElements(By.xpath("//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-undefined ' and not(@visibility='hidden')]"));
		for (WebElement data_format: data_formats) {
			...
			if(data_format_grouping_separator.equals("Space") && data_format_separator.equals(".") || data_format_grouping_separator.equals("Space") && data_format_separator.equals(",")) {
		...
		login.Log4j.info("The Selected "+arg1+" and "+arg2+" has been updated in chart visual timepoints and it's verified successfully");
		CommonFunctionality.Views_list();
	} else {
		cv.clicking_option("Save");
		List<WebElement> timepoints = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]"));
		for (int i = 1; i <= timepoints.size(); i++) {
			WebElement timepoint = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]["+i+"]",4);
			new Actions(login.driver).moveToElement(timepoint).pause(10).build().perform();
			String text = CommonFunctionality.getElementByXpath(login.driver,"//*[contains(@class,'highcharts-tooltip highcharts-color-undefined')]/span", 4).getText();
			String lines[] = text.split("\\r?\\n");
			String next_lines[] = lines[1].split("\\s+"); 
	...
	public void the_selected_should_update_with_selected_input(String arg1) throws Throwable {
		...
		for (int i = 1; i <= timepoints.size(); i++) {
			WebElement timepoint = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]["+i+"]",4);
			new Actions(login.driver).moveToElement(timepoint).pause(10).build().perform();
			String text = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-label-box highcharts-tooltip-box']", 4).getAttribute("stroke");
		...
		for (int i = 1; i <= timepoints.size(); i++) {
			WebElement timepoint = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]["+i+"]",4);
			new Actions(login.driver).moveToElement(timepoint).pause(10).build().perform();
			String text = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='highcharts-label-box highcharts-tooltip-box']", 4).getAttribute("stroke-width");
		...
		List<WebElement> font_size = login.driver.findElements(By.cssSelector(".highcharts-data-labels.highcharts-series-0.highcharts-line-series > g > text"));
		for (int i = 1; i <= font_size.size(); i++) {
			String fontsize = login.driver.findElement(By.cssSelector(".highcharts-data-labels.highcharts-series-0.highcharts-line-series > g > text")).getCssValue("font-size");
		...
		List<WebElement> font_style = login.driver.findElements(By.cssSelector(".highcharts-data-labels.highcharts-series-0.highcharts-line-series > g > text"));
		for (int i = 1; i <= font_style.size(); i++) {
			WebElement fontstyle = login.driver.findElement(By.cssSelector(".highcharts-data-labels.highcharts-series-0.highcharts-line-series > g > text"));
	...
	public void the_selected_value_should_reflect_in_chart(String arg1) throws Throwable {
		cv.clicking_option("Save");
		List<WebElement> point_markers = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden') or contains(@class,'highcharts-point-hover') and not(@visibility='hidden') or contains(@class,'highcharts-negative') and not(@visibility='hidden')]"));
		for(int i=1; i<= point_markers.size(); i++) {
		String point_marker_text = CommonFunctionality.getElementByClassName(login.driver, "select2-hidden-accessible",	4).getText();
		assertEquals(point_marker, point_marker_text);
		}
		login.Log4j.info("The selected "+arg1+" value ="+point_marker+"= is reflecting in chart visual and has been verified successfully");
		CommonFunctionality.Views_list();
	}
	...
	public void verify_the_changes_are_reflecting_in_Chart_visual_for(String arg1) throws Throwable {
		...
		String text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']", 4).getText();
		assertEquals(y_axis_title, text);
		login.Log4j.info("The y axis title name has been verified for left axis");
		String color = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']", 4).getCssValue("color");
		...
		String bgcolor = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']", 4).getCssValue("background-color");
		...
		String size = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']", 4).getCssValue("font-size");
		...
		String text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-right')]//*[@class='highcharts-axis-title']", 4).getText();
		assertEquals(y_axis_opposite_title, text);
		login.Log4j.info("The y axis title name has been verified for right axis");
		String color = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-right')]//*[@class='highcharts-axis-title']", 4).getCssValue("color");
		String color_hex = Color.fromString(color).asHex();
		assertEquals(color_hex, y_axis_right_color);
		login.Log4j.info("The y axis color has been verified for right axis");
		String bgcolor = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-right')]//*[@class='highcharts-axis-title']", 4).getCssValue("background-color");
		String bgcolor_hex = Color.fromString(bgcolor).asHex();
		assertEquals(bgcolor_hex, y_axis_right_bgcolor);
		login.Log4j.info("The y axis bgcolor has been verified for right axis");
		String size = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-right')]//*[@class='highcharts-axis-title']", 4).getCssValue("font-size");
		String font_size[] = size.split("px");
		int actual = Integer.parseInt(font_size[0]);
	...
	public void verify_the_Style_is_applied_for(String arg1) throws Throwable {
		cv.clicking_option("Save");
		if(arg1.equalsIgnoreCase("Left Axis")) {
		WebElement title = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-left')]//*[@class='highcharts-axis-title']",4);
		String font_bold = title.getCssValue("font-weight");
		String font_italic = title.getCssValue("font-style");
		String font_underline = title.getCssValue("text-decoration");
		assertTrue(font_bold.equals("bold") || font_bold.equals("700"));
		...
		WebElement title = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'highcharts-yaxis-right')]//*[@class='highcharts-axis-title']",4);
		String font_bold = title.getCssValue("font-weight");
		String font_italic = title.getCssValue("font-style");
		String font_underline = title.getCssValue("text-decoration");
		assertTrue(font_bold.equals("bold") || font_bold.equals("700"));
	...
	public void is_displayed_at_bottom_of_the_chart(String arg1) throws Throwable {
	    if(login.driver.findElements(By.cssSelector("div[class='legend-item']")).size() > 0 &&legend_checkbox == true) {
	    ...
	    if(login.driver.findElements(By.cssSelector("div[class='legend-item']")).size() == 0 &&legend_checkbox_uncheck == false) {
	...
	public void the_Selected_should_reflect_in_the_chart_visual_legand(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Color")) {
	    	String color = CommonFunctionality.getElementBycssSelector(login.driver, "div.highcharts-series-0 > span", 4).getCssValue("color");
	    	String color_hex = Color.fromString(color).asHex();
	    	...
	    	String title = CommonFunctionality.getElementBycssSelector(login.driver, "div.highcharts-legend-title > span", 4).getText();
	    	assertEquals(title, legend_title);
	    	login.Log4j.info("The selected "+arg1+" is reflecting in chart visual");
	    	CommonFunctionality.Views_list();
	    } if(arg1.equalsIgnoreCase("Font size") && values_axis_checkboxes == true) {
	    	cv.clicking_option("Save");
	    	String fontsize = CommonFunctionality.getElementBycssSelector(login.driver, "div.highcharts-legend-title > span", 4).getCssValue("font-size");
			String[] size = fontsize.split("px");
			Integer expected = Integer.valueOf(size[0]);
	    	...
	    	cv.clicking_option("Save");
	    	WebElement title = CommonFunctionality.getElementBycssSelector(login.driver, "div.highcharts-legend-title > span", 4);
			String font_bold = title.getCssValue("font-weight");
			String font_italic = title.getCssValue("font-style");
			String font_underline = title.getCssValue("text-decoration");
			assertTrue(font_bold.equals("bold") || font_bold.equals("700"));
	    	...
	    	cv.clicking_option("Save");
	    	String bordercolor = CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("stroke");
	    	...
	    	cv.clicking_option("Save");
	    	String width = CommonFunctionality.getElementBycssSelector(login.driver, "rect.highcharts-legend-box", 4).getAttribute("stroke-width");
	    	...
	    	cv.clicking_option("Save");
	    	String title = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-item-wrapper--text", 4).getText();
	    	...
	    	cv.clicking_option("Save");
	    	String fontsize = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-item-wrapper--text", 4).getCssValue("font-size");
			String[] size = fontsize.split("px");
			Integer expected = Integer.valueOf(size[0]);
	    	...
	    	cv.clicking_option("Save");
	    	String color = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-item-wrapper--text", 4).getCssValue("color");
	    	String color_hex = Color.fromString(color).asHex();
	...
	public void the_title_of_the_popup_should_be(String arg1) throws Throwable {
	    String actual = CommonFunctionality.getElementBycssSelector(login.driver, "div.popover--wrapper div.popover--title", 4).getText();
	...
	public void uncheck_the_checkbox_and_verify_the_results(String arg1) throws Throwable {
	   if(zoom_checkbox == true) {
		   WebElement checkbox = login.driver.findElement(By.xpath("//*[text()='"+arg1+"']/preceding-sibling::span"));
		   new Actions(login.driver).moveToElement(checkbox).click().build().perform(); 
	   }
	   cv.clicking_option("Save");
	   if(login.driver.findElements(By.className("highcharts-range-selector-buttons")).size() == 0) {
	...
	public void type_of_visuals_should_present(int arg1) throws Throwable {
	    List<WebElement> visuals_list = login.driver.findElements(By.xpath("//*[@title='View as']//following-sibling::ul[@class='dropdown-menu']/li/span"));
	...
	public void popup_shoud_display(String arg1) throws Throwable {
	    if(login.driver.findElements(By.xpath("//*[contains(@class,'movable-modal--window')]//*[contains(text(),'"+arg1+"')]")).size()>0) {
	    	login.Log4j.info(arg1+" popup is displayed");
	    	CommonFunctionality.getElementByClassName(login.driver, "movable-modal--close", 4).click();
	    } else {
	    	fail("Verification Failed");
	...
	public void icons_should_appear(String arg1, String arg2, String arg3, String arg4, String arg5) throws Throwable {
	    ...
	    login.Log4j.info("The "+arg1+", "+arg2+", "+arg3+", "+arg4+" and "+arg5+" icons are verified successfully");
	    CommonFunctionality.Views_list();
	}
	
	@Then("^Verify the Changes on clicking New button$")
	public void verify_the_Changes_on_clicking_New_button() throws Throwable {
	    String actual = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='title']", 4).getText();
	...
	public void clicking_on_the_insight_name_should_open_the_insight_with_the_series() throws Throwable {
		login.driver.findElement(By.xpath("//*[@class='growl-message growl-success']//*[@class='button growl-message-content--btns__fill']")).click();
		CommonFunctionality.wait(2000);
	...
	public void the_visual_has_been_deleted_from_the_right_panel(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Chart")) {
	    	...
	    	List<WebElement> views = login.driver.findElements(By.xpath(
					"//*[contains(@class,'insight-page-view-tab') and contains(text(),'View')]"));
			if (views.size() > 0) {
				for (WebElement view : views) {
					new Actions(login.driver).contextClick(view).build().perform();
					CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'Delete view')]", 8).click();
				}
			}
	...
	public void check_for_the_movable_popup_to_appear() throws Throwable {
    	if(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal-dialog')]", 4).isDisplayed()) {
	...
	public void verify_the_download_popup_appears_and_the_title_should_be(String arg1) throws Throwable {
	    if(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal__content')]", 4).isDisplayed()) {
	    	login.Log4j.info("The Download popup is displayed and verified successfully");
	    } else {
	    	fail(arg1+" is not displayed");
	    }
	    String actual = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal__content')]//*[@class='download-modal-title__title']", 4).getText();
	    assertEquals(actual, arg1);
	    CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	    CommonFunctionality.Views_list();
	}
	...
	public void the_text_and_sub_text_options_are_present_in_context_click() throws Throwable {
	    String a="Copy Chart"; String b="Cut chart"; String c="Delete chart";String d="Insert visual";String e="Paste visual";String f="View as";String g="Calculate series";String h="Edit series";String i="Clear contents";String j="Reset format";String k="Download";
	    String l="Chart";String m="Pie";String n="Table";String o="Map";String p="Heat map";String q="Histogram";String r="Commentary";String s="Attachments";String t="Image";String u="Filter";
	    String v="Map";String w="Table";String x="Pie";String y="Heat map";String z="Histogram";
	    String a_download="Chart";String b_download="View";
	    if(!(rightclick_element.contains(a) ||rightclick_element.contains(b) || rightclick_element.contains(c) || rightclick_element.contains(d) || rightclick_element.contains(e) || rightclick_element.contains(f) || rightclick_element.contains(g) || rightclick_element.contains(h) || rightclick_element.contains(i) || rightclick_element.contains(j) || rightclick_element.contains(k))) {
	    	fail("Drop down verification failed");
	    } if(!(insert_visual_list.contains(l) || insert_visual_list.contains(m) || insert_visual_list.contains(n) || insert_visual_list.contains(o) || insert_visual_list.contains(p) || insert_visual_list.contains(q) || insert_visual_list.contains(r) || insert_visual_list.contains(s) || insert_visual_list.contains(t) || insert_visual_list.contains(u))) {
	    	fail("Insert Visual verification failed");
	    } if(!(view_as.contains(v) || view_as.contains(w) || view_as.contains(x) || view_as.contains(y) || view_as.contains(z))) {
	...
	public void the_options_have_been_verified(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Insert visual")) {
	    	...
	    	new Actions(login.driver).moveToElement(new WebDriverWait(login.driver, 20).until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(@class,'input-control__grey')]")))).pause(3000).click().build().perform();
	    	}
	    	}
		   ...
		   WebElement edit = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-series-settings']/parent::div", 4);
		   if(edit.getAttribute("class").contains("sidebar-panel__opened")) {
			   CommonFunctionality.wait(3000);
			   if(login.driver.findElements(By.cssSelector(".insight-series-settings")).size()>0 && login.driver.findElement(By.cssSelector(".insight-series-settings")).isDisplayed()) {
		   ...
		   if(login.driver.findElements(By.className("empty-visual-overlay--content")).size() == 1) {
			   boolean checkbox = login.driver.findElement(By.cssSelector("input[name='select_all_dataselection']")).isSelected();
			   if(checkbox == true) {
	...
	public void the_Chart_is_changed_to_type(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("column")) {
	    	WebElement className = login.driver.findElement(By.xpath("//*[@class='highcharts-series-group']//following-sibling::*[contains(@class,'highcharts-series-0')]"));
	    	...
	    	WebElement className = login.driver.findElement(By.xpath("//*[@class='highcharts-series-group']//following-sibling::*[contains(@class,'highcharts-series-0')]"));	    	String chart_type = className.getAttribute("class");
	    	String[] split = chart_type.split("-");
	    	assertEquals(arg1, split[4]);
	    }
	...
	public void the_Series_is_changed_to_the_specified(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Color")) {
	    	String color_text = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='highcharts-series highcharts-series-0 highcharts-line-series']/*[@class='highcharts-graph']", 4).getAttribute("stroke");
	    	String actual = Color.fromString(color_text).asHex();
	    	assertEquals(actual, color);
	    } if(arg1.equalsIgnoreCase("Stroke Width")) {
	    	String stroke = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='highcharts-series highcharts-series-0 highcharts-line-series']/*[@class='highcharts-graph']", 4).getAttribute("stroke-width");
	    	...
	    	WebElement right = CommonFunctionality.getElementByXpath(login.driver, "(//*[@title='"+arg1+"'])[2]", 4);
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'series-edit--title__editable')])[2]", 4)).pause(1000).build().perform();
		    String expected= CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Name:')]/following-sibling::*", 4).getText();
	    	if(!(Comparables.hovered_series_name.equalsIgnoreCase(expected)) && (!(right.getAttribute("class").contains("series-axis--button__selected")))) {
	    		fail("Verification Failed");
	    	}
	    }
	...
	public void the_action_is_performed_successfully(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Copy and Paste")) {
	    	...
	    	WebElement select = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-series-search-filter']/following::div[1]", 4);
	    	if(!(select.getAttribute("class").contains("all-selected")) && login.driver.findElements(By.className("empty-visual-overlay--content")).size() == 1) {
	    	...
	    	if(login.driver.findElements(By.cssSelector(".data-selection-series-overlay__view ")).size()==1 && login.driver.findElements(By.className("empty-visual-overlay--content")).size() == 1) {
	    	...
	    	String expected = CommonFunctionality.getElementBycssSelector(login.driver, "span[data-name='title']", 4).getText();
	...
	public void the_should_reflect_in_Chart(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Rename")) {
	    	String actual = CommonFunctionality.getElementBycssSelector(login.driver, ".visual-title--text.text-dots", 4).getText();
	    	...
	    	if(!(legand.getAttribute("class").contains("series-axis--button__selected")) && (!(login.driver.findElements(By.xpath("//*[@class='highcharts-axis-title']//parent::*[contains(@class,'highcharts-yaxis-right')]")).size()>0))) {
	    		fail("Verification Failed");
	    	}
	    } if(arg1.equalsIgnoreCase("Color")) {
	    	List<WebElement> colors = login.driver.findElements(By.xpath("//*[@class='highcharts-point' and not(@visibility='hidden')]"));
	    	...
	    	String legend_color = CommonFunctionality.getElementBycssSelector(login.driver, ".legend-item--marker.legend-item--hide-series", 4).getCssValue("background-color");
	    	...
	    	String a = "Weekly"; String b="Monthly";
	    	String actual = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Functions:')]/following-sibling::*", 4).getText();
