...
public class CollabarationSharing {
	...
	public void navigate_to(String arg1, String arg2) throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='items-wrapper']//*[text()='"+arg2+"']", 4)).pause(200).click().build().perform();
	}
	...
	public void open_sharing_window_next_time() throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@title='"+new_insight_name+"']", 4)).pause(500).build().perform();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Customize')]", 4)).click().build().perform();
	    CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4).click();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "span[title='Share']", 4)).click().build().perform();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".share-specific--users-list .share-user-delete-box.icon--red-cross", 4)).pause(500).click().build().perform();
	    cv.click_on_button_to_share("Save");
	    if(login.driver.findElements(By.xpath("//*[text()='Confirmation']/following::*[@class='sphere-modal-controls']//*[text()='OK']")).size()>0) {
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Confirmation']/following::*[@class='sphere-modal-controls']//*[text()='OK']", 4).click();
	    }
	...
	public void deleting_insights(String arg1) throws Throwable {
		...
		WebElement table_mode = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a table']/parent::div", 4);
	...
	public void create_a_fresh_insight() throws Throwable {
	    new_insight_name = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'modal-window')]//*[@class='form--control']", 4).getAttribute("value");
	...
	public void click_option_from_the_title(String arg1) throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@title='"+arg1+"']", 4)).pause(1000).click().build().perform();
	}
			
	@SuppressWarnings("deprecation")
	@And("^Move the mouse on any one of the insights$")
	public void move_the_mouse_on_any_one_of_the_insights() throws Throwable {
		WebElement scroll = CommonFunctionality.getElementByXpath(login.driver,"(//div[contains(@class,'insight-grid-item--bottom-panel-title')])[1]", 4);
	...
	public void capture_the_creator_user_name() throws Throwable {
		CommonFunctionality.wait(2000);
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='View and edit profile information']", 4)).click().build().perform();
	    creator_name = CommonFunctionality.getElementBycssSelector(login.driver, "span[js-user-fullname='']", 4).getText();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='View and edit profile information']", 4)).click().build().perform();
	}
	
	@And("^Click on \"([^\"]*)\" > \"([^\"]*)\" > \"([^\"]*)\" > \"([^\"]*)\" > \"([^\"]*)\"$")
	public void click_on(String arg1, String arg2, String arg3, String arg4, String arg5) throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='"+arg2+"']", 4)).click().build().perform();
		CommonFunctionality.wait(2000);
		if(CommonFunctionality.getElementBycssSelector(login.driver, ".modal-content.sphere-modal__content", 4).isDisplayed()) {
			WebElement protect_option = CommonFunctionality.getElementByXpath(login.driver,"//*[text()='"+arg3+"']/following::div[2]", 4);
			if(arg4.equalsIgnoreCase("OFF")) {
				CommonFunctionality.wait(2000);
				if (protect_option.getAttribute("class").contains("bootstrap-switch-on")) {
					new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg3+"']/following::*[@class='bootstrap-switch-label'][1]",4)).click().build().perform();
				} else {
					System.out.println(arg3+ " option is already in "+arg4+ " state");
				}
			} 
			boolean apply = login.driver.findElement(By.xpath("//*[text()='"+arg5+"' and contains(@class,'button__secondary_purple')]")).isEnabled();
			if(apply == true) {
				CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg5+"' and contains(@class,'button__secondary_purple')]", 4).click();
			} else {
	...
	public void click_on_File_Protect_Copy_ON_Apply() throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Protect']", 4)).click().build().perform();
		CommonFunctionality.wait(2000);
		if(CommonFunctionality.getElementBycssSelector(login.driver, ".modal-content.sphere-modal__content", 4).isDisplayed()) {
			WebElement protect_option = CommonFunctionality.getElementByXpath(login.driver,"//*[text()='Copy']/following::div[2]", 4);
			if (protect_option.getAttribute("class").contains("bootstrap-switch-on")) {
	...
	public void perform_second_login_actions() throws Throwable {
	   ...
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@title='"+new_insight_name+"']", 4)).pause(500).build().perform();
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Customize')][1]", 4)).pause(500).click().build().perform();
	}
	...
	public void verify_Share_option_status() throws Throwable {
		...
		cv.click_on_button_to_share("Save");
		CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'button__text_purple') and contains(text(),'email')]", 4).click();
	}
	...
	public void select_few_insights_and_click_on_Share_option() throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@title,'"+new_insight_name+"')]/ancestor::*[@class='insight-table-item--title'][1]", 4)).keyUp(Keys.CONTROL).pause(200).click().keyDown(Keys.CONTROL).build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[@title='Share Insight']/following::*[contains(@class,'insight-table-item--title-link')])[1]", 4)).keyUp(Keys.CONTROL).pause(200).contextClick().keyDown(Keys.CONTROL).build().perform();
	}
	...
	public void click_on_dropdown_to_view_permission_list_to_select_permission(String arg1) throws Throwable {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'share-type-permissions')]//span[@class='insight-share--choose-button-arrow']", 4)).click().build().perform();
	    CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'select-permissions')]//li//span[@title='"+arg1+"']", 4).click();
	    cv.click_on_button_to_share("Save");
	}
	...
	public void click_on_dropdown_to_select_permission(String arg1) throws Throwable {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+sharing_mail+"']/following::span[@class='insight-share--choose-button-arrow'][1]", 4)).click().build().perform();
	    CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'select-permissions')]//li//span[@title='"+arg1+"']", 4).click();
	    cv.click_on_button_to_share("Save");
	    if(login.driver.findElements(By.xpath("//*[text()='Confirmation']/following::*[@class='sphere-modal-controls']//*[text()='OK']")).size()>0) {
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Confirmation']/following::*[@class='sphere-modal-controls']//*[text()='OK']", 4).click();
	...
	public void clicking_dropdown_to_view_permission_list_to_select_permission(String arg1) throws Throwable {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'share-specific--users-list')]//span[@class='insight-share--choose-button-arrow']", 4)).click().build().perform();
	    CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'select-permissions')]//li//span[@title='"+arg1+"']", 4).click();
	    cv.click_on_button_to_share("Save");
	}
	...
	public void the_window_is_present(String arg1) throws Throwable {
	    String new_insight = CommonFunctionality.getElementBycssSelector(login.driver, ".modal-title.sphere-modal__title.text-dots", 4).getText();
	    assertEquals(new_insight, arg1);
	}
	
	@And("^Login as next user$")
	public void login_as_next_user() throws Throwable {
	    CommonFunctionality.login_as_next_user(login.driver, "input[name='user_id']", "input[name='password']", "button[type='submit']", sharing_mail);
	}
	
	@And("^Login as ceic user$")
	public void login_as_ceic_user() throws Throwable {
	    CommonFunctionality.login_as_ceic_user(login.driver, "input[name='user_id']", "input[name='password']", "button[type='submit']", "ceicsuresh10@gmail.com");
	}
	...
	public void click_Guest_access() throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Guest Mode']", 4)).click().build().perform();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".js-guest.btn.btn-guest", 4)).click().build().perform();
	...
	public void click_on_dropdown_in_share_popup(String arg1) throws Throwable {
		...
		boolean accounts = login.driver.findElement(By.xpath("//*[text()='"+arg1+"']/preceding-sibling::input")).isSelected();
	    if(accounts == false) {
	...
	public void create_new_insights(int arg1) throws Throwable {
	    ...
	    for(int i=1; i<=total_new_insights; i++) {
	    	cv.click("File", "New");
	    	String insight_name = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'modal-window')]//*[@class='form--control']", 4).getAttribute("value");
		    cv.click_to_create_a_new_insight("Create insight"); 
		    CommonFunctionality.wait(2000);
	...
	public void select_newly_created_insights_in_table_mode() throws Throwable { 
	   ...
	   if(table_mode.getAttribute("class").contains("insights-view-modes__table-mode-teal")) {
		   ...
		   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a table']", 4)).pause(500).click().build().perform();
	   }
	   new Actions(login.driver).keyDown(Keys.CONTROL).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+first_insight+"']/following::*[@class='insight-table-item--info'][1]", 4)).pause(200).click().build().perform();
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+second_insight+"']/following::*[@class='insight-table-item--info'][1]", 4)).pause(200).click().build().perform();
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+third_insight+"']/following::*[@class='insight-table-item--info'][1]", 4)).pause(200).click().build().perform();
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+first_insight+"']/following::*[@class='insight-table-item--options'][1]", 4)).pause(200).contextClick().keyUp(Keys.CONTROL).build().perform();
	}
	...
	public void the_Invite_specific_user_is_fetching_proper_results(String arg1) throws Throwable {
	    ...
	    if(invite_specific_user.equalsIgnoreCase("ceicsuresh10@gmail.com")) {
	     mail = CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Type people/accounts/companies you want to invite'] | //input[@placeholder='Select people you want to invite']", 4);
	    }if(invite_specific_user.equalsIgnoreCase("cvision-suresh")) {
	     mail = CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Type people/accounts/companies you want to invite']", 4);
	    }if(invite_specific_user.equalsIgnoreCase("CEIC Development – CDMNext 2")) {
	     mail = CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Type people/accounts/companies you want to invite']", 4);
	    }
		//new Actions(login.driver).moveToElement(mail).click().sendKeys(invite_specific_user).pause(2000).click().build().perform();
		if(login.driver.findElements(By.xpath("//span[contains(text(),'External users/accounts/companies')]")).size()>0) {
	    new Actions(login.driver).moveToElement(mail).click().sendKeys(invite_specific_user).sendKeys(Keys.ENTER).pause(1000).build().perform(); 
	    } else {
	    new Actions(login.driver).moveToElement(mail).click().sendKeys(invite_specific_user).pause(2000).build().perform();
	    WebElement result = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+invite_specific_user+"')] | //*[@class='choosable-item' and contains(text(),'"+invite_specific_user+"')]", 4);
		js.executeScript("arguments[0].scrollIntoView(true);", result);
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+invite_specific_user+"')]", 4)).pause(3000).click().build().perform();
	    }
		CommonFunctionality.wait(2000);
		/*WebElement result = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+invite_specific_user+"')]", 4);
		js.executeScript("arguments[0].scrollIntoView(true);", result);
	...
	public void the_searched_user_is_fetching_proper_results_for(String arg1,String arg2) throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='share-specific-search-user']//button//span[2] | //div[contains(@class,'share-specific-search-user')]//button//span[2]", 4)).click().build().perform();
		List<WebElement> options = login.driver.findElements(By.xpath("//ul[contains(@class,'select-permissions')]//li//span[not(contains(@class,'name-li'))]"));
    	...
    	if(text.equals("can manage")) {
    		boolean users = login.driver.findElement(By.xpath("//*[contains(text(),'Users')]/preceding-sibling::input")).isSelected();
    	    if(users== true) {
		...
		permission_type = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='share-specific-search-user']//button//span[1] | //div[contains(@class,'share-specific-search-user')]//button//span[2]", 4).getText();
		searched_user = arg1;
		CommonFunctionality.wait(2000);
	    WebElement mail = null;
		...
		//new Actions(login.driver).moveToElement(mail).click().sendKeys(searched_user).pause(3000).click().build().perform();
		if(login.driver.findElements(By.xpath("//span[contains(text(),'External users/accounts/companies')]")).size()>0) {
	    new Actions(login.driver).moveToElement(mail).click().sendKeys(searched_user).sendKeys(Keys.ENTER).pause(1000).build().perform(); 
	    } else {
		...
		js.executeScript("arguments[0].scrollIntoView(true);", result);
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+searched_user+"')]", 4)).pause(3000).click().build().perform();
	    }
		CommonFunctionality.wait(1000);
		/*WebElement result = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+searched_user+"')]", 4);
		js.executeScript("arguments[0].scrollIntoView(true);", result);
		new Actions(login.driver).moveToElement(result).pause(1000).click().build().perform();*/
	}
	...
	public void entering_mail_to_share_the_insight() throws Throwable {
		...
		WebElement mailing = CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Type people/accounts/companies you want to invite'] | //input[@placeholder='Select people you want to invite']", 4);
		CommonFunctionality.wait(2000);
		if(login.driver.findElements(By.xpath("//span[contains(text(),'External users/accounts/companies')]")).size()>0) {
	    new Actions(login.driver).moveToElement(mailing).click().sendKeys(sharing_mail).sendKeys(Keys.ENTER).pause(1000).build().perform(); 
	    } else {
	    new Actions(login.driver).moveToElement(mailing).click().sendKeys(sharing_mail).pause(1000).sendKeys(Keys.BACK_SPACE).pause(1000).build().perform();
	    WebElement result = CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+sharing_mail+"')] | //*[@class='choosable-item' and contains(text(),'"+sharing_mail+"')]", 4);
		js.executeScript("arguments[0].scrollIntoView(true);", result);
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='choosable-item ' and contains(text(),'"+sharing_mail+"')]", 4)).pause(3000).click().build().perform();
	    }
	}
	...
	public void login_as_current_execution_login_by_taking_username_rowcount_as_and_cellcount_as_and_for_password_rowcount_as_and_cellcount_as(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		CommonFunctionality.wait(3000);
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("div[title='View and edit profile information']")));
		logout_from_current_user();
		URL url = new URL(login.driver.getCurrentUrl());
		login.driver.get(url.getProtocol()+"://"+url.getHost()+"/login");
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "input[name='user_id']", 4)).pause(500).click().sendKeys(Keys.chord(Keys.CONTROL,Keys.BACK_SPACE)).sendKeys(username).build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "input[name='password']", 4)).pause(500).click().sendKeys(Keys.chord(Keys.CONTROL,Keys.BACK_SPACE)).sendKeys(password).build().perform();
	...
	public void enter_mail_for_with_action_as_an_insight(String arg1, String arg2) throws Throwable {
		...
		for(String windowHandle : handles)
	    {
	       if(!windowHandle.equals(parentWindow)) {
	        ...
	        wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='growl-message-text']//a")));
		    driver2.findElement(By.xpath("//div[@class='growl-message-text']//a")).click();
		    Thread.sleep(2000);
	        ...
	        wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='growl-message-text']")));
	...
	public void perform_notification_off_growl_action() throws Throwable {
	   ...
	   login_as_ceic_user();
	   CommonFunctionality.wait(1000);
	   CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[title='View and edit profile information']")));
	   login.driver.findElement(By.cssSelector("div[title='View and edit profile information']")).click();
	   WebElement notification = login.driver.findElement(By.xpath("//*[contains(text(),'Notifications')]/following::div[1]"));
	   if(notification.getAttribute("class").contains("bootstrap-switch-on")) {
	   new Actions(login.driver).moveToElement(login.driver.findElement(By.cssSelector(".user-notifications-settings .bootstrap-switch-container .bootstrap-switch-handle-on"))).pause(500).click().build().perform();
	   login.driver.findElement(By.cssSelector("div[title='View and edit profile information']")).click();
	...
	public void perform_notification_on_growl_action() throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(login.driver.findElement(By.cssSelector(".user-notifications-settings .bootstrap-switch-container .bootstrap-switch-handle-off"))).pause(500).click().build().perform();
	    login.driver.findElement(By.cssSelector("div[title='View and edit profile information']")).click();
	...
	public void enter_mail_for_with_action_as_the_insight(String arg1, String arg2) throws Throwable {
		...
		for(String windowHandle : handles)
	    {
	       if(!windowHandle.equals(parentWindow)) {
			...
			wa.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='growl-message-text']//a")));
			insight_name_growl = driver3.findElement(By.xpath("//div[@class='growl-message-text']//a")).getText();
	...
	public void login_back_to_default_execution_login() throws Throwable {
		...
		URL url = new URL(login.driver.getCurrentUrl());
		login.driver.get(url.getProtocol()+"://"+url.getHost()+"/login");
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "input[name='user_id']", 4)).pause(500).click().sendKeys(Keys.chord(Keys.CONTROL,Keys.BACK_SPACE)).sendKeys(login.CONFIG.getProperty("username")).build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "input[name='password']", 4)).pause(500).click().sendKeys(Keys.chord(Keys.CONTROL,Keys.BACK_SPACE)).sendKeys(login.CONFIG.getProperty("password")).build().perform();
		WebElement submit = CommonFunctionality.getElementBycssSelector(login.driver, "button[type='submit']", 4);
		assertEquals(submit.isEnabled(), true);
		new Actions(login.driver).moveToElement(submit).pause(500).click().build().perform();
	...
	public void login_back_to_current_user() throws Throwable {
		logout_from_current_user();
		CommonFunctionality.login_as_next_user(login.driver, "input[name='user_id']", "input[name='password']", "button[type='submit']", "ceicsuresh12@gmail.com");
	}
	...
	public void login_back_to_internal_user(String arg1,String arg2) throws Throwable {
		logout_from_current_user();
		CommonFunctionality.login_as_internal_user(login.driver, "input[name='user_id']", "input[name='password']", "button[type='submit']", arg1, arg2);
	}
	...
	public void perform_Share_action() throws Throwable {
	 ...
	 public void select_the_first_insight() throws Throwable { 
		 new Actions(login.driver).keyDown(Keys.CONTROL).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[text()='"+new_insight_name+"']//following::*[@class='insight-table-item--info'][1]", 4)).pause(200).click().build().perform(); 
		 new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"(//*[@title='Share Insight']/following::a[not(contains(text(),'Name your insight'))])[1]//following::div[@class='insight-table-item--info'][1]", 4)).pause(200).click().keyUp(Keys.CONTROL).build().perform();
		 new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+new_insight_name+"']//following::*[@class='insight-table-item--options']//*[@class='icon']", 4)).pause(200).contextClick().build().perform();
	 }
	...
	public void click_option(String arg1) throws Throwable {
	 if(arg1.equalsIgnoreCase("Insight Share")) {
		 new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[@class='items-wrapper']//*[contains(@title,'Share')]", 4)).pause(200).click().build().perform();
	 } else {
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,"//*[contains(@title,'"+arg1+"')]", 4)).pause(200).click().build().perform();
	}
	}
	...
	for(int i=1; i<=20; i++) {
	if(i!=1) {
	   	new Actions(login.driver).keyDown(Keys.CONTROL).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@title='Share Insight']//following::div[@class='insight-table-item--info'][1])["+i+"]", 4)).pause(200).click().build().perform();
	} if(i==20) {
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@title='Share Insight']//following::div[@class='insight-table-item--info'][1])[20]//div[2]//following::div[1]", 4)).pause(200).click().keyUp(Keys.CONTROL).build().perform();
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[name()='use' and contains(@*,'#actions__options')])[20]", 4)).pause(200).contextClick().build().perform();
	}
	}
    CommonFunctionality.webDriverwait_locator("//*[@class='items-wrapper']//*[@title='Delete']", "xpath");
    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Delete']", 4)).pause(2000).click().build().perform();
	...
	public void the_window_should_present(String arg1) throws Throwable {
	  if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal-dialog')]//*[contains(@class,'sphere-modal__title') and contains(text(),'Name insight')]")).size() == 1) {
		CommonFunctionality.getElementByClassName(login.driver, "input-share", 4).clear();
		CommonFunctionality.getElementByClassName(login.driver, "input-share", 4).sendKeys(Untitled_insight+"-"+formatter.format(date));
		CommonFunctionality.wait(3000);
		boolean save = login.driver.findElement(By.xpath("//*[contains(@class,'button button__primary') and text()='Save']")).isEnabled();
		if(save == true) {
		CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'button button__primary') and text()='Save']", 4).click();
		} else {
			fail("Not enabled");
		}
	  } if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal-dialog')]//*[contains(@class,'sphere-modal__title') and contains(text(),'"+arg1+"')]")).size() == 1) {
	    	login.Log4j.info("The Sharing insight window is opened"); 
      }
	  String modal_title = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal__title') and contains(text(),'"+arg1+"')]", 4).getText();
	  CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void verify_the_insight_for_icon(String arg1) throws Throwable {
		CommonFunctionality.wait(2000);
		WebElement open_file_menu =CommonFunctionality.getElementByXpath(login.driver, "//*[@title='Open File menu']",4);
	    if(arg1.equalsIgnoreCase("share")) {
	    	new Actions(login.driver).moveToElement(open_file_menu).pause(500).click().build().perform();
	    	if(login.driver.findElements(By.xpath("//*[name()='use' and contains(@*, '#actions__"+arg1+"')]")).size() == 1) {
	...
	public void the_number_of_insights_selected_should_match() throws Throwable {
		...
		login.Log4j.info("The number of insights selected is displaying correctly in Share popup and has been verified successfully");
	}
	...
	public void the_Insight_owner_name_and_Email_ID_should_be_displayed() throws Throwable {
	    String name = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='owner']/preceding::*[contains(@class,'share-user-name')]", 4).getText();
	    String email = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='owner']/preceding::*[contains(@class,'share-user-email')]", 4).getText();
	...
	public void the_newly_created_Insights_should_appear_in_next_user_login() throws Throwable {
	    ...
	    if(insight1.isDisplayed() && insight2.isDisplayed() && insight3.isDisplayed()) {
	    	login.Log4j.info("The newly created Insights are displaying in next login and it has been verified successfully");
	    } else {
	...
	public void click_on_dropdown_to_view_permission_list_to_check_for_and_and_is_selected_by_default(String arg1, String arg2, String arg3, String arg4) throws Throwable {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'share-type-permissions')]//span[@class='insight-share--choose-button-arrow']", 4)).click().build().perform();
	    List<WebElement> options = login.driver.findElements(By.xpath("//ul[contains(@class,'select-permissions')]//li//span[not(contains(@class,'name-li'))]"));
	    ...
	    String default_permission = CommonFunctionality.getElementByXpath(login.driver, "//div[contains(@class,'share-company-permissions')]//span[@share-current-permission-type='']", 4).getText();
	    CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void the_newly_created_insight_should_appear_as_permission_in_next_user_login(String arg1) throws Throwable {
		WebElement grid_mode = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a grid']/parent::div", 4);
	  	...
	  	/*if(login.driver.findElements(By.xpath("//*[contains(@class,'user-notifications--body')]")).size()>0) {
			...
			if(open.getAttribute("class").contains("dropdown--body__open")) {
				new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "user-notifications--icon", 4)).pause(500).click().build().perform();
				System.out.println("Notification appeared and clicked");
			} 
		} else {
	    ...
	    if(permission.isDisplayed()) {
			CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+new_insight_name+"']/following::*[contains(text(),'Open')][1]", 4).click();
		} else {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).pause(500).click().build().perform();
	    List<WebElement> views = login.driver.findElements(By.xpath("//*[@class='items-wrapper']//*[@title='Save']/ancestor::li"));
    	...
    	if(permission.isDisplayed()) {
			CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+new_insight_name+"']/following::*[contains(text(),'Customize')][1]", 4).click();
		} else {
			fail("Newly created insight is not displayed");
		}
    	/*if(login.driver.findElements(By.xpath("//*[contains(@class,'user-notifications--body')]")).size()>0) {
	    ...
	    CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Click to edit the Insight']", 4).click();
	    String display = CommonFunctionality.getElementByXpath(login.driver, "//input[@class='insight-breadcrumb--title-input']", 4).getAttribute("style");
	    if(display.equalsIgnoreCase("display: none;")) {
	    	fail("Title field not editable");
	    }
	    CommonFunctionality.getElementByXpath(login.driver, "//input[@class='insight-breadcrumb--title-input']", 4).sendKeys(Keys.ENTER);
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
	    WebElement delete = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Delete']/parent::*", 4);
	    if(delete.getAttribute("class").contains("hide")) {
	    	fail("Delete option is hidden for managing an insight");
	    }
	    WebElement share = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Share']/parent::*", 4);
	    if(share.getAttribute("class").contains("hide")) {
	    	fail("Share option is hidden for managing an insight");
	    }
	    //new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Share']", 4)).click().build().perform();
	    if(login.driver.findElements(By.xpath("//*[contains(@class,'modal-dialog')]//*[contains(@class,'sphere-modal__title') and contains(text(),'Share')]")).size()>0) {
	...
	public void the_list_of_users_name_with_email_ID_should_be_displayed() throws Throwable {
	    CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Select people you want to invite']", 4).click();
	    CommonFunctionality.wait(5000);
	    List<WebElement> users = login.driver.findElements(By.xpath("//div[contains(@class,'choosable-search-box')]//*[@class='choosable-item'] | //div[contains(@class,'choosable-search-box')]//*[@class='choosable-item ']"));
	    CommonFunctionality.wait(2000);
	...
	public void the_popup_should_appears(String arg1) throws Throwable {
	   if(login.driver.findElements(By.cssSelector(".modal-content.sphere-modal__content")).size()>0) {
		   String header = CommonFunctionality.getElementBycssSelector(login.driver, ".modal-title.sphere-modal__title", 4).getText();
		   CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void the_searched_user_is_fetching_proper_results_and_given_permission(String arg1,String arg2) throws Throwable {
	    searched_user = arg1;
	    WebElement mail = null;
	    if(searched_user.equalsIgnoreCase("ceicsuresh10@gmail.com")) {
	     mail = CommonFunctionality.getElementByXpath(login.driver, "//input[@placeholder='Type people/accounts/companies you want to invite'] | //input[@placeholder='Select people you want to invite']", 4);
		...
		CommonFunctionality.wait(2000);
		List<WebElement> users = login.driver.findElements(By.xpath("//div[contains(@class,'choosable-search-box--below-input')]//*[@class='choosable-item ']"));
	    CommonFunctionality.wait(1000);
	    if(searched_user.equalsIgnoreCase("ceicsuresh10@gmail.com")) {
	    String email_text = CommonFunctionality.getElementBycssSelector(login.driver, ".share-specific--users-list .share-user-email.share-note-color", 4).getText();
	    String share_name = CommonFunctionality.getElementBycssSelector(login.driver, ".share-specific--users-list .share-user-name", 4).getText();
	    if(user.contains(" (")) {
	    	String split1[] = user.split(Pattern.quote(" ("));
	    	assertEquals(split1[0], share_name);
	    } else {
	    	assertEquals(user, share_name);
	    }
	    assertEquals(searched_user, email_text);
	    }
	    assertEquals(1, users.size());*/
	    login.Log4j.info("The searched user is fetching proper results and has been verified successfully");
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='share-type-permissions']//button[@share-permission-choose='']//span[2] | //*[contains(@class,'share-specific--users-list')]//button[@share-permission-choose='']//span[2]", 4)).click().build().perform();
	    List<WebElement> options = login.driver.findElements(By.xpath("//ul[contains(@class,'select-permissions')]//li//span[not(contains(@class,'name-li'))]"));
	    if(searched_user.equalsIgnoreCase("ceicsuresh10@gmail.com")) {
	    	assertEquals(3, options.size());
	    } else {
	    ...
	    for(WebElement option:options) {
	    	...
	    	if(text.equals("can manage")) {
	    	    if(login.CONFIG.getProperty("username").equals("ceicsuresh12@gmail.com") /*|| login.CONFIG.getProperty("username").contains("@gmail.com")*/ || login.CONFIG.getProperty("username").equals("ceicsuresh10@gmail.com")) {
	    ...
	    CommonFunctionality.wait(1000);
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'share-specific--users-list')]//span[@class='insight-share--choose-button-arrow']", 4)).click().build().perform();
	    String default_permission = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='share-type-permissions']//button[@share-permission-choose='']//span[1] | //*[contains(@class,'share-specific--users-list')]//button[@share-permission-choose='']//span[1]", 4).getText();
	    assertEquals("can view", default_permission);
	    clicking_dropdown_to_view_permission_list_to_select_permission(arg2);
	    if(login.driver.findElements(By.xpath("//*[contains(@class,'button__text_purple') and contains(text(),'email')]")).size()>0) {
	    CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'button__text_purple') and contains(text(),'email')]", 4).click();
	    }
	}
	...
	public void the_Verify_the_remove_icon_in_shared_insight() throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[text()='Shared']", 4).click();
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".share-specific--users-list .share-user-delete-box.icon--red-cross", 4)).pause(500).click().build().perform();
		List<WebElement> after_remove = login.driver.findElements(By.cssSelector(".share-specific--users-list .share-user-email"));
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void the_same_permission_can_prepopulate_in_insight_share_field() throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Open File menu']", 4)).click().build().perform();
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[text()='Shared']", 4).click();
		String permission_text = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='share-specific--users-list']//span[@class='insight-share--choose-button-text']", 4).getText();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".share-specific--users-list .share-user-delete-box.icon--red-cross", 4)).click().build().perform();
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void the_newly_created_Insight_should_appear_in_second_login_before_stopping_of_sharing_with_shared_user_name() throws Throwable {
	    ...
	    CommonFunctionality.wait(2000);
	    String creator = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='"+new_insight_name+"']/ancestor::div[2]//div[contains(@class,'common-information--item-content--creator')]//span", 4).getText();
	...
	public void the_newly_created_insight_should_vanish_in_second_login_when_insight_is_stopped_sharing() throws Throwable {
	    ...
	    login.Log4j.info("The newly created insight is vanished in second login when insight has been stopped sharing and has been verified successfully");
	    login_back_to_current_user();
	    cv.click_on_my_insights();
	    click_tab("Created");
	    delete_Insight();
	...
	public void the_expected_permission_should_display(String arg1) throws Throwable {
	    ...
	    WebElement option = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal__content')]//*[text()='"+arg1+"']", 4);
	...
	public void the_Cancel_icon_in_share_popup_should_verify() throws Throwable {
		...
		login.Log4j.info("The Sharing insight window is opened"); 
	    CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	    List<WebElement> share = login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal-dialog')]//*[contains(@class,'sphere-modal__title') and contains(text(),'Share')]"));
	...
	public void perform_some_actions_in_Manage_insight_of_next_login() throws Throwable {
		...
		login.Log4j.info("The Insight can be shared with Manage permission and also the refresh option has been verified successfully");
	}
	...
	public void perform_action_by_using_option_in_the_context_menu(String arg1, String arg2) throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+new_insight_name+"']/following::*[contains(text(),'Open')]", 4)).pause(500).click().build().perform();
	    /*if(login.driver.findElements(By.xpath("//*[contains(@class,'user-notifications--body')]")).size()>0) {
		    WebElement open = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'user-notifications--body')]", 4);
			if(open.getAttribute("class").contains("dropdown--body__open")) {
				new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "user-notifications--icon", 4)).pause(500).click().build().perform();
		...
		if(save.getAttribute("class").equals("hide")) {
			...
			CommonFunctionality.getElementByXpath(login.driver,"//*[@class='items-wrapper']//*[text()='"+arg2+"']", 4).click();
			if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal__title') and text()='Copy the Insight']")).size() == 1) {
	...
	public void the_option_should_be_hidden_in_explorer_and_option_is_hidden_in_file_menu(String arg1, String arg2) throws Throwable {
	    perform_first_login_actions();
	    WebElement grid_mode = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='View as a grid']/parent::div", 4);
	  	if(grid_mode.getAttribute("class").contains("insights-view-modes__grid-mode-teal")) {
	  	   System.out.println("Already grid mode is clicked");
		...
		if(save.getAttribute("class").equals("hide")) {
		 ...
		 WebElement right_click = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+new_insight_name+"']", 4);
		 CommonFunctionality.wait(2000);
