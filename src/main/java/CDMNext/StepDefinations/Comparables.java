...
public class Comparables {
	   ...
	   CommonFunctionality.wait(3000);
	    ...
	    if(!(show.getAttribute("class").contains("series-tab__hidden"))) {
	    	if(arg1.equalsIgnoreCase("Data")) {
	    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'ui-sortable-handle')]//*[contains(text(),'"+arg1+"')]", 4)).pause(1000).click().build().perform();
	    	} else {
   ...
   public void count_the_number_of_texts_in_header() throws Throwable {
	   WebElement show= CommonFunctionality.getElementBycssSelector(login.driver, ".series-tab.ui-sortable-handle", 4);
	    if(!(show.getAttribute("class").contains("series-tab__hidden"))) {
	    	List<WebElement> texts = login.driver.findElements(By.xpath("//*[@class='search-presentation-tabs--visible']//span[@class='series-tab--text']"));
	        count = texts.size();
   ...
   public void click_three_dots_in_search_pane() throws Throwable {
	   CommonFunctionality.wait(3000);
       WebElement dots = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='search-presentation-tabs--drop-down']", 4);
   ...
   public void clicking_section_from_Comparables_tab(String arg1) throws Throwable {
	  ...
	  CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Global Economic Monitor')]/following::div[@class='toggle'][1]", 4).click();
	  } else {
   ...
   public void select_series_inside_table(int arg1) throws Throwable {
       ...
       WebElement ul_element = login.driver.findElement(By.cssSelector(login.LOCATORS.getProperty("UL")));
		...
		for(int i=1; i<=li_All.size();i++) {
			WebElement check = CommonFunctionality.getElementByXpath(login.driver, "//li["+i+"]//span[contains(@class,'series-list-item--checkbox')]", 4);
   ...
   public void unselect_series_inside_table(int arg1) throws Throwable {
       series_count_inside_table = arg1;
		for(int i=1; i<=series_count_inside_table;i++) {
			WebElement check = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+hovered_series_name+"')]/preceding::span[1]", 4);
   ...
   public void clicking_option_from_Series_list(String arg1) throws Throwable {
      ...
      WebElement hovor = CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'search-series-list')]//li[1]//*[@class='add-to-data-selection--title']", 4);
      new Actions(login.driver).moveToElement(hovor).pause(1000).build().perform();
	  WebElement dropdown = CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'search-series-list')]//li[1]//*[@class='add-to-data-selection--title']//*[contains(@class,'"+arg1+"')]", 4); 
   ...
   public void clicking_option_from_Table(String arg1) throws Throwable {
	  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "add-to-data-selection--title", 4)).pause(500).build().perform();
   ...
   public void clicking_option_from_series() throws Throwable {
       ...
       WebElement hovor1 = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='series-list-item--container']//*[@class='add-to-data-selection--toggle']",4);
   ...
   public void the_option_for_series_should_present(String arg1) throws Throwable {
	   if(arg1.equalsIgnoreCase("series-data-set--table-name")) {
		   related_data_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])[1]", 4).getText();
		   CommonFunctionality.wait(2000);
		   CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])[1]", 4).click();
	   } else {
		 WebElement click = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+arg1+"')]", 4);
		 CommonFunctionality.wait(2000);
   ...
   public void the_Insight_should_present(String arg1) throws Throwable {
	   ...
	   insight_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--title-link')])[1]", 4).getText(); 
	   } else {
	   insight_text = arg1;
       WebElement text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+insight_text+"')]", 4);
       js.executeScript("arguments[0].scrollIntoView(true);",text);
    	   if(!(text.isDisplayed())) {
   ...
   public void clicking_favorite_icon_of_related_insight() throws Throwable {
	   String value = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+insight_text+"')]/preceding::*[contains(@title,'favorite')]", 4).getAttribute("title");
   ...
   public void hovor_on_to_i_icon() throws Throwable {
	   WebElement first_series = login.driver.findElement(By.xpath("//*[contains(@class,'series-list-item--info-icon')]"));
		new Actions(login.driver).moveToElement(first_series).pause(2000).click(login.driver.findElement(By.xpath("//div[@title='Show Series Info']"))).build().perform();
	} 
   ...
   public void get_the_name_of_series() throws Throwable {
	   for(int i=1; i <= series_count_inside_table; i++) {
	   String series_name_inside_table = login.driver.findElement(By.xpath("(//*[@class='series-item--name'])["+i+"]")).getText();
   ...
   public void clicking_button_from_Header_portion(String arg1) throws Throwable {
	   ...
	   CommonFunctionality.wait(2000);
		if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal-controls--right')]//*[contains(text(),'"+arg1+"')]")).size()>0) {
			WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sphere-modal-controls--right')]//*[contains(text(),'"+arg1+"')]", 4);
   ...
   public void click_option_in_series(String arg1) throws Throwable {
	   WebElement icon = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='series-item--status-icons']/following-sibling::*[contains(@title,'"+arg1+"')]", 4);
   ...
   public void perform_Drag_and_Drop_operation() throws Throwable {
	   ...
	   WebElement target = CommonFunctionality.getElementByClassName(login.driver, "data-selection-series-overlay--content", 4);
	   new Actions(login.driver).moveToElement(source).pause(500).clickAndHold(source).pause(1000).dragAndDrop(source, target).pause(500).build().perform();
   }
	
   @And("^Check the checkbox \"([^\"]*)\"$")
   public void check_the_checkbox(String arg1) throws Throwable {
	   if(arg1.equalsIgnoreCase("Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia")) {
		   new Actions(login.driver).moveToElement(login.driver.findElement(By.xpath("//*[contains(text(),'Global Economic Monitor')]/following::span[@class='svg-checkbox'][1]"))).click().build().perform();
	   } else {
   ...
   public void uncheck_the_checkbox(String arg1) throws Throwable {
       new Actions(login.driver).moveToElement(login.driver.findElement(By.xpath("//*[contains(text(),'"+arg1+"')]/preceding::span[1]"))).doubleClick().build().perform();
   }
   ...
   public void expand_the_tree_for_key_icons() throws Throwable {
	   //CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Search without any filters')]", 4).click();
       new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='toggle']", 4)).pause(1000).click().build().perform();
       new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='toggle'])[2]", 4)).pause(1000).click().build().perform();
       new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='toggle'])[3]", 4)).pause(1000).click().build().perform();
   }
   ...
   public void select_checkbox_from_more_section(String arg1) throws Throwable {
    if(arg1.equalsIgnoreCase("new")) {
    	filter_text = arg1;
    	WebElement ele = login.driver.findElement(By.xpath("//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'n') and @class='status-icon--sign']"));
    	js.executeScript("arguments[0].scrollIntoView(true);", ele);
    	boolean checked = login.driver.findElement(By.xpath("//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'n') and @class='status-icon--sign']/preceding::input[1]")).isSelected();
    	if(checked == false) {
    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'n') and @class='status-icon--sign']/preceding::span[1]",4)).click().build().perform();
    	}
    } if(arg1.equalsIgnoreCase("Key")) {
    	filter_text1 = arg1;
    	WebElement ele = login.driver.findElement(By.xpath("//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'k') and @class='status-icon--sign']"));
    	js.executeScript("arguments[0].scrollIntoView(true);", ele);
    	boolean checked = login.driver.findElement(By.xpath("//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'k') and @class='status-icon--sign']/preceding::input[1]")).isSelected();
    	if(checked == false) {
    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='more-filter-content--left']//*[contains(@class,'more-filter-content--section__other')]//*[contains(text(),'k') and @class='status-icon--sign']/preceding::span[1]",4)).click().build().perform();
    	}
    } if(arg1.equalsIgnoreCase("units")) {
    	WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'"+arg1+"-filter-container')]", 4);
    	if(ele.isDisplayed()) {
		boolean checked = login.driver.findElement(By.xpath("//*[contains(@class,'"+arg1+"-filter-container')]//*[contains(text(),'USD')]/preceding::input[1]")).isSelected();
    	if(checked == false) {
    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'"+arg1+"-filter-container')]//*[contains(text(),'USD')]/preceding::span[1]", 4)).click().build().perform();
    	}	
    	} else {
   ...
   public void get_href_of_section_from_Comparables_tab(String arg1) throws Throwable {
      ...
      link = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='"+section_name+"']//ancestor::div[@class='data-set-node--body']", 4).getAttribute("href");
      } else {
	  link = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+arg1+"')]/ancestor::*[2]", 4).getAttribute("href");
      }
   ...
   public void count_the_series_in_multiple_selected_Filter() throws Throwable {
      ...
      String filter_count = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='search-filter-container']//*[contains(text(),'"+filters[i]+"')]//following::div[2] | (//div[@class='search-filter-container']//*[contains(text(),'"+filters[i]+"')]//following::div[2])[2]", 4).getText();
	  String filter = filter_count.substring(1, filter_count.length()-1);
      String fcount = filter.replaceAll(",", "");
   ...
   public void click_on_for_related_series(String arg1) throws Throwable {
	 ...
	 WebElement database = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='related-series-information-portlet--container']//*[@class='series-data-set--node-link' and @js-open-"+arg1+"]", 4);
   ...
   public void click_to_collapse(String arg1) throws Throwable {
    ...
    CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+arg1+"')]/preceding::div[@class='toggle'][1]", 4).click();
   }
   }
   ...
   public void count_the_series_inside(String arg1) throws Throwable {
	   ...
	   if(arg1.equalsIgnoreCase("First Dataset")) {
	   series_inside_table = login.driver.findElements(By.xpath("(//*[@class='release-scheduler-tree-node--title'])[1]/following::ul[1]/li"));   
	   } else if(arg1.equalsIgnoreCase("Selected Dataset")) {
	   series_inside_table = login.driver.findElements(By.xpath("(//*[contains(@class,'tree-series-list list-view-component')])[1]//ul[1]/li"));
	   } else {
	   if(arg1.equalsIgnoreCase("Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia")) {
	   String series_count = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Global Economic Monitor')]/following::span[@class='name-text'][1]", 4).getText();
	   series_inside_table = login.driver.findElements(By.xpath("//*[contains(text(),'"+series_count+"')]//following::ul[1]/li"));
	   } else {
	   series_inside_table = login.driver.findElements(By.xpath("//*[contains(text(),'"+arg1+"')]//following::ul[1]/li"));
	   }
	   } 
   ...
   public void right_click_section_from_Comparables_tab(String arg1) throws Throwable {
	  ...
	  if(arg1.equalsIgnoreCase("Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia")) {
	   ...
	   section_name = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='nodes-list--tree-wrapper']//*[@class='series-data-set--table-name'])[1]", 4).getText();
   ...
   public void using_keyboard_shortcuts_for_the_section(String arg1) throws Throwable {
       if(arg1.equalsIgnoreCase("expanding")) {
    	   WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'National Accounts')]", 4);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_RIGHT)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_RIGHT)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_RIGHT)).build().perform();
       } if(arg1.equalsIgnoreCase("collapsing")) {
    	   WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[@data-node-model-id='TB2992367']", 8);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_LEFT)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_LEFT)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   WebElement ele1 = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Global Economic Monitor')]", 4);
    	   new Actions(login.driver).moveToElement(ele1).pause(1000).sendKeys(Keys.chord(Keys.ARROW_LEFT)).build().perform();
       } if(arg1.equalsIgnoreCase("moving down")) {
    	   WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'National Accounts')]", 4);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_DOWN)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_DOWN)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_DOWN)).build().perform();
    	   ...
    	   WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Demographic and Labour Market')]", 4);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_UP)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_UP)).build().perform();
    	   CommonFunctionality.wait(2000);
    	   new Actions(login.driver).moveToElement(ele).pause(1000).sendKeys(Keys.chord(Keys.ARROW_UP)).build().perform();
   ...
   public void checkbox(String arg1,String arg2) throws Throwable {
	   if(login.driver.findElements(By.cssSelector(".modal-content.sphere-modal__content")).size() == 1) {
		   if(arg1.equalsIgnoreCase("Uncheck")) {
			  boolean checkbox = login.driver.findElement(By.xpath("//*[contains(text(),'"+arg2+"')]/preceding-sibling::input")).isSelected();
			  if(checkbox == true) {
				  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+arg2+"')]/preceding-sibling::span", 4)).click().build().perform();
			  }
   ...
   public void click_on_option_in_series_level(String arg1) throws Throwable {
      WebElement country = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'country-information')]", 4);
      ...
      CommonFunctionality.wait(2000);
      new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='items-wrapper']//span[@title='"+arg1+"']", 4)).pause(3000).click().build().perform();
      } else {
	  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//li[1]//*[@title='"+arg1+"']", 4)).pause(2000).click().build().perform();
      }
   }
   ...
   @And("^Also Expand the \"([^\"]*)\"$")
	public void also_Expand_the(String arg1) throws Throwable {
		WebElement table = CommonFunctionality.getElementByXpath(login.driver,"//*[contains(text(),'" + arg1 + "')]/preceding::*[@class='toggle'][1]", 4);
   ...
   public void clicking_button_in_search_popup(String arg1) throws Throwable {
      ...
      WebElement save = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='search-tabs-manager--footer']//*[contains(text(),'"+arg1+"')]", 4);
...
@And("^Click on \"([^\"]*)\" button in Comparables$")
	public void click_on_button_in_Comparables(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("More actions")) {
	     new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, "*[title='"+arg1+"']", 4)).pause(500).click().build().perform();
	    } else if(arg1.equalsIgnoreCase("View as Map")) {
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementBycssSelector(login.driver, ".dropdown-menu.context-menu span[title='"+arg1+"']", 4)).pause(2000).click().build().perform();
   ...
   public void drag_and_Drop_the_Comparables_text() throws Throwable {
      WebElement source = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='search-presentation-tabs--visible']/span[3]", 4);
      WebElement target = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='search-presentation-tabs--visible']/span[2]", 4);
      new Actions(login.driver).moveToElement(source).pause(2000).clickAndHold(source).pause(4000).dragAndDrop(source, target).pause(4000).release(target).build().perform();
   }
   
   @SuppressWarnings("deprecation")
   @And("^Clicking \"([^\"]*)\" from dropdown list$")
   public void clicking_from_dropdown_list(String arg1) throws Throwable {
       WebElement dropdown = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'dropdown-menu')]//*[contains(@title,'"+arg1+"')]",4);
   ...
   public void get_Text_of_Table() throws Throwable {
       table_text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Global Economic Monitor')]/following::span[@class='name-text'][1]",4).getText();
   }
   ...
   public void the_Section_level_results_for_series_should_be_present() throws Throwable {
       if(CommonFunctionality.getElementBycssSelector(login.driver, ".search-input--series-indicators", 4).isDisplayed()) {
    	   String series_count=CommonFunctionality.getElementByClassName(login.driver, "series-series-count--number", 4).getText();
    	   String seriescount = series_count.replaceAll(",", "");
    	   comparables_count = Integer.parseInt(seriescount);
    	   login.Log4j.info("The Section level results for series is present and it has been verified and the total count is "+comparables_count);
       } else {
    	   fail("Verification Failed");
       }
   }
   ...
   public void comparables_tab_be_visible_in_search_pane(String arg1) throws Throwable {
	  if(arg1.equalsIgnoreCase("should not")) {
		  if(login.driver.findElements(By.xpath("//*[@class='search-presentation-tabs--visible']//*[contains(text(),'Comparables')]")).size() == 0) {
		  ...
		  if(login.driver.findElements(By.xpath("//*[@class='search-presentation-tabs--visible']//*[contains(text(),'Comparables')]")).size() == 1) {
   ...
   public void should_be_able_to_expand_section_levels_results_upto_table_level() throws Throwable {
	   if(login.driver.findElements(By.cssSelector(".tree-series-list.list-view-component.series-table-list__all-shown")).size()==1) {
		   login.Log4j.info("Expanded section level results upto table level without any errors and it has been verified successfully");
	   } else {
		   fail("Verification Failed");
	   }
	   //CommonFunctionality.CollapseTreeMethod();
   ...
   public void should_be_able_to_collapse_section_levels_results() throws Throwable {
	   if(login.driver.findElements(By.cssSelector(".tree-series-list.list-view-component.series-table-list__all-shown")).size()==0) {
		   login.Log4j.info("Collapsed till section level results without any errors and it has been verified successfully");
	   } else {
		   fail("Verification Failed");
	   } 
   }
   ...
   public void should_be_able_to_move_down_the_section_levels_results_upto_table_level() throws Throwable {
	   WebElement section = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Demographic and Labour Market')]/ancestor::div[2]", 4);
	   if(section.getAttribute("class").contains("active")) {
		   login.Log4j.info("It is possible to Move down the section level results with keyboard actions and it has been Verified Successfully");
	   } else {
		   fail("Verification Failed");
	   }
   }
   ...
   public void should_be_able_to_move_up_the_section_levels_results_upto_table_level() throws Throwable {
	   WebElement section = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'National Accounts')]/ancestor::div[2]", 4);
	   if(section.getAttribute("class").contains("active")) {
		   login.Log4j.info("It is possible to Move down the section level results with keyboard actions and it has been Verified Successfully");
	   } else {
		   fail("Verification Failed");
   ...
   public void the_Footnotes_window_tab_should_be_opened() throws Throwable {
	   CommonFunctionality.wait(2000);
	   String text = CommonFunctionality.getElementBycssSelector(login.driver, "span[class='footnotes-modal--name'] span", 4).getText();
   ...
   public void the_and_option_should_present(String arg1, String arg2) throws Throwable {
       if(login.driver.findElements(By.xpath("//*[@class='name-li' and text()='"+arg1+"']")).size()==1 && login.driver.findElements(By.xpath("//*[@class='name-li' and text()='"+arg2+"']")).size()==1) {
    	  login.Log4j.info(arg1+" and "+arg2+" options are present in right click and has been verified successfully"); 
    	  //login.driver.navigate().refresh();
       } else {
    	   fail("Verification failed");
       }
   ...
   public void the_and_option_for_section_should_present(String arg1, String arg2) throws Throwable {
      List<WebElement> section_items = login.driver.findElements(By.xpath("//*[contains(@class,'items-wrapper')]//*[contains(@class,'context-menu-item')]"));
   ...
   public void the_and_option_for_series_should_present(String arg1, String arg2,String arg3,String arg4) throws Throwable {
      List<WebElement> series_items = login.driver.findElements(By.xpath("//ul//li[1]//*[contains(@class,'series-list-item--action-icons')]//span"));
      for(WebElement series: series_items) {
    	  String text = series.getAttribute("title");
    	  if(text.equalsIgnoreCase(arg1) || text.equalsIgnoreCase(arg2) || text.equalsIgnoreCase(arg3) || text.equalsIgnoreCase(arg4)) {
    		  System.out.println(text+" option is present and verified successfully");
    	  } else {
    		  fail("Verification Failed");
    	  }
   ...
   public void the_comparables_count_should_match_to_applied_filter_count() throws Throwable {
       String compare_count = CommonFunctionality.getElementByClassName(login.driver, "series-series-count--number", 4).getText();
       ...
       login.Log4j.info("The comparables count is matching to applied filter count and it has been verified successfully");
    }
   ...
   public void related_results_should_be_shown_in_comparables() throws Throwable {
       ...
       String id = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'Series id:')]/following-sibling::*", 4).getText();
   ...
   public void the_comparables_count_after_reset_should_match_to_applied_filter_count() throws Throwable {
       ...
       login.Log4j.info("The comparables count is matching to actual comparables count and it has been verified successfully");
	  }
   ...
   public void the_comparables_count_should_match_to_applied_filters_count() throws Throwable {
       ...
       login.Log4j.info("The comparables count is matching to applied filters count and it has been verified successfully");
	   }
   ...
   public void options_should_present(String arg1, String arg2, String arg3, String arg4, String arg5) throws Throwable {
	   if(CommonFunctionality.getElementBycssSelector(login.driver, ".dropdown-menu.context-menu", 4).isDisplayed()) {
       List<WebElement> options = login.driver.findElements(By.xpath("//*[contains(@class,'dropdown-menu')]//*[@class='name-li']"));
   ...
   public void the_Applied_filter_is_displaying_under_Comparables(String arg1) throws Throwable {
	   CommonFunctionality.wait(1000); 
	   String actual = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'More:')]/following-sibling::*", 4).getText();
   ...
   public void SSP_window_for_specific_series_should_be_opened() throws Throwable {
	    ...
	    WebElement ele = CommonFunctionality.getElementByClassName(login.driver, "series-preview-modal-header--link", 4);
   ...
   public void series_should_get_added_into_myseries_pane() throws Throwable {
	   ...
	   for(int i=1; i<= myseries.size(); i++) {
		   String myseries_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-name-field--series-name'])["+i+"]", 4).getText();
   ...
   public void the_options_should_available(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8, String arg9, String arg10, String arg11, String arg12, String arg13) throws Throwable {
       ...
       for(WebElement item:items) {
    	   ...
    	   if(value.equals(arg1) || value.equals(arg2) || value.equals(arg3) || value.equals(arg4) || value.equals(arg5) || value.equals(arg6) || value.equals(arg7) || value.equals(arg8) || value.equals(arg9) || value.equals(arg10) || value.equals(arg11) || value.equals(arg12) || value.equals(arg13)) {
   ...
   public void the_options_should_available_in_table(String arg1, String arg2, String arg3, String arg4, String arg5, String arg6, String arg7, String arg8, String arg9, String arg10) throws Throwable {
       List<WebElement> items = login.driver.findElements(By.xpath("//*[@class='items-wrapper']/li/span[not(contains(@class,'dropdown-submenu-icon')) and not(contains(@title,'View on Administrative Map'))]"));
       for(WebElement item:items) {
    	   String value = item.getAttribute("title");
   ...
   public void the_series_should_get_selected_by_default() throws Throwable {
    WebElement checkbox = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+hovered_series_name+"')]/ancestor::li", 4);   
   ...
   public void the_option_is_displayed(String arg1) throws Throwable {
	CommonFunctionality.wait(2000);
	String expected = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='visual-top-panel--left-controls']//*[contains(@class,'button__special')] | //*[@class='visual-top-panel--left-controls']//*[contains(@class,'button__primary')]",4).getText();
	CommonFunctionality.Views_list();
   ...
   public void the_option_should_present(String arg1) throws Throwable {
	if(arg1.equalsIgnoreCase("Show Dataset")) {
		...
		List<WebElement> series_all = login.driver.findElements(By.xpath("//ul[contains(@class,'search-series-list')]/li"));
		for(int i=1; i<=series_all.size();i++) {
			WebElement series = CommonFunctionality.getElementByXpath(login.driver, "//ul[contains(@class,'search-series-list')]/li["+i+"]", 4);
   ...
   public void the_Data_tab_is_active_by_default() throws Throwable {
	WebElement data = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='search-presentation-tabs--visible']//*[@data-id='DATA']", 4);
   ...
   public void the_options_are_present(String arg1, String arg2, String arg3) throws Throwable {
       List<WebElement> sub_options = login.driver.findElements(By.xpath("//span[text()='View as ...']//following::*[@class='dropdown-menu']//li//span[contains(@class,'context-menu-item')]"));
   ...
   public void the_option_is_shown(String arg1) throws Throwable {
       if(arg1.equalsIgnoreCase("Download")) {
		   ...
		   if(login.driver.findElements(By.className("footnotes--unavailable-message")).size() == 1) {
			   CommonFunctionality.wait(2000);
			   String breadcrumb;
			   breadcrumb = CommonFunctionality.getElementBycssSelector(login.driver, "div.footnotes--breadcrumbs > div > div:last-child >div", 4).getText();
    	   ...
    	   if(series.getAttribute("class").contains("series-list-item__selected") && series.getAttribute("class").contains("series-list-item__highlighted")) {
    		 CommonFunctionality.getElementByClassName(login.driver, "insight-discovery--popup-back-button", 4).click();
    		 if(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+section_name+"') and not(@class='insight-discovery--popup-title')]",4).isDisplayed()) {
    			 login.Log4j.info("The application has been returned back to series level and verified successfully");
    		 } else {
    			 fail("Verification Failed");	
    		 }
   ...
   public void the_link_is_navigating_to(String arg1) throws Throwable {
       if(arg1.equalsIgnoreCase("Single Series")) {
    	   ...
    	   for(int i=1; i<=datasets.size();i++) {
    		   CommonFunctionality.wait(2000);
    		   WebElement data = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])["+i+"]", 4);
    		   String actual = data.getText();
    		   data.click();
    		   String expected = CommonFunctionality.getElementByClassName(login.driver, "insight-discovery--popup-title", 4).getText();
    		   CommonFunctionality.getElementByClassName(login.driver, "insight-discovery--popup-back-button", 4).click();
   ...
   public void the_Sharing_insight_window_should_be_opened() throws Throwable {
       if(login.driver.findElements(By.className("related-insights-preview")).size()>0) {
    	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-share-button__gray')])[1]", 4)).pause(1000).click().build().perform();
    	   if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal__content')]//*[text()='Name insight']")).size()>0) {
   ...
   @Then("^Clicking on go to the insight name should open the new insight with the added series$")
	public void clicking_on_go_to_the_insight_name_should_open_the_new_insight_with_the_added_series() throws Throwable {
   ...
   public void the_Share_icon_should_not_present_for_non_sharing_related_insight() throws Throwable {
       if(login.driver.findElements(By.xpath("//*[text()='"+insight_text+"']/preceding::*[contains(@title,'favorite')][1]/following-sibling::div[@title='Share Insight']")).size() == 0) {
    	  login.Log4j.info("The Share icon is not present for non sharing related insight and has been verified successfully");
       } else {
   ...
   public void the_opened_dropdown_should_not_close() throws Throwable {
	   if(login.driver.findElements(By.xpath("//*[contains(text(),'"+hovered_series_name+"')]//following-sibling::div[@title='Hide related data']")).size()>0) {
   ...
   public void the_tooltip_as_and_should_present(String arg1, String arg2) throws Throwable {
	   String name = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--title-link')])[1]", 4).getText();
       String tooltip = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--title-link')])[1]", 4).getAttribute("title");
   ...
   public void the_creator_tooltip_should_present() throws Throwable {
	   String name = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--info')]//*[@class='text-dots'])[1]", 4).getText();
	   String value = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--info-date')])[1]/span", 4).getText();
	   String modify = value.substring(0, value.length()-1);
       String tooltip = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--info-date')])[1]", 4).getAttribute("title");
       //System.out.println(tooltip);
       String text[] = tooltip.split("\n");
   ...
   public void the_Modified_time_tooltip_should_present() throws Throwable {
	   String time = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--info-date')])[1]/span[2]", 4).getText();
       String tooltip = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--info-date')])[1]", 4).getAttribute("title");
       //System.out.println(tooltip);
       String text[] = tooltip.split("\n");
   ...
   public void the_Related_insights_should_be_added_to_favourite_list_in_insight_explorer_window_of_favorite_tab() throws Throwable {
	   ...
	   if(title_name.isDisplayed()) {
		   login.Log4j.info("The Related insights is added to favourite list in insight explorer window of favorite tab and has been verified successfully");
	   } else {
   ...
   public void insight_explorer_window_should_be_opened() throws Throwable {
	   if(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='dropdown-menu']//h4[text()='Add to recent insight']", 4).isDisplayed()) {
