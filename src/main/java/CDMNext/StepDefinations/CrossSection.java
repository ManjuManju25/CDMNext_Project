...
public class CrossSection {
	...
	public void search_for_the_series_with_SID_and_click_on_option(String arg1, String arg2) throws Throwable {
		...
		login.driver
		.findElement(By.xpath("//*[@class='toggler-control-item toggler-control-item__selected']"));
		...
		List<WebElement> list = login.driver.findElements(By.xpath("//*[@class='series-list-item--information']"));
		
		System.out.println("==listWeb========"+list.size());
		
		if (arg1.equals("7892501")) {
			for(int i =list.size(); i>=1; i--) {
				WebElement Series=login.driver.findElement(By.xpath("//span[@class='series-list-item--checkbox svg-checkbox']"));
				Series.click();
			}
		...
		if (arg1.equals("310902301;310902401") || arg1.equals("210698402;206954202") || arg1.equals("310901701") || arg1.equals("205424302")) {
			...
			for(int i = list.size(); i >= 1; i--) {
				click_on_more_actions_to_create_View_as_chart();
				/*WebElement series_unselected = CommonFunctionality.getElementByXpath(	
						login.driver, "//*[@class='search-series-list']/*["+i+"]", 4);
			...
			for(int i = 1; i <= list.size(); i++) {
			WebElement series_unselected = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='series-item--main-info']/*["+i+"]", 4);
			System.out.println("=SeriesUnselect========"+series_unselected.getText());
			//WebElement series = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='series-list-item--action-icons']/span[@title='More actions']//*[name()='svg']//*[local-name()='use'][1]", 4);
			WebElement series =login.driver.findElement(By.xpath("//div[@class='series-list-item--action-icons']/span[@title='More actions']//*[name()='svg']//*[local-name()='use'][1]"));
			if(!series_unselected.getAttribute("class").contains("series-list-item__selected")) {
				System.out.println("=Serieenter here========");
			new Actions(login.driver).moveToElement(series).pause(4000).build().perform();
...
public void click_on_more_actions_to_create_View_as_chart() throws Throwable {
	...
	public void change_the_result_count_per_page_to(int arg1) throws Throwable {
		...
		CommonFunctionality.getElementBycssSelector(login.driver, "label[title='View results as List']", 4).click();
		//CommonFunctionality.getElementByXpath(login.driver,"//*[@class='toggler-control-item 	"+ "-control-item__selected']",4).click();
	...
	String function = CommonFunctionality.getElementByXpath(login.driver, "	"
			+ "//*[@class='series-function-item--body']", 4).getText();
