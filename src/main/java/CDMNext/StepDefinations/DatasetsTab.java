...
public class DatasetsTab {
	...
	public void hovor_on_icon() throws Throwable {
	   WebElement first_series = login.driver.findElement(By.cssSelector(".series-item--main-info .series-item--country"));
	   new Actions(login.driver).moveToElement(first_series).pause(200).build().perform();
	   series_item_name = CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='series-item--name'])[1]", 4).getText();
	}
	...
	public void click_on_the_Sort_by_option() throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]")));
		WebElement open = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]", 4);
		if(!open.getAttribute("class").contains("dropdown__open")) {
			new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='data-sets--right']//span[contains(@class,'icon--filter-arrow')]", 4)).click().build().perform();
		} else {
	...
	public void select_any_checkbox_for_dataset() throws Throwable {
		...
		if(checkbox.getAttribute("class").contains("svg-checkbox__selected") || checkbox.getAttribute("class").contains("svg-checkbox__partially-selected")) {
		  System.out.println("===> The Checkbox has been checked already <===");
		} else {
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'svg-checkbox')])[1]", 4)).click().build().perform();
		}
	}
	...
	public void right_Click_series(int arg1) throws Throwable {
	    ...
	    for(int i=1; i<= series_inside_one_dataset; i++) {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//span[contains(@class,'series-list-item--checkbox')])["+i+"]", 4)).pause(500).click().build().perform();
	    if(i== arg1) {
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='series-item--name'])["+i+"]", 4)).pause(1000).contextClick().pause(1000).build().perform();
	    	break;
	    }
	    }
	}
	...
	public void search_for_the_series_to_scroll_down() throws Throwable {
	   WebElement scroll = CommonFunctionality.getElementByXpath(login.driver, "//div[contains(text(),'Industrial Sales Vol Index: NACE 2: DO: EM: Mfg: Transport Equipment')]", 4);
	   js.executeScript("arguments[0].scrollIntoView(true);",scroll);
	   CommonFunctionality.wait(1000);
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[contains(text(),'Industrial Sales Vol Index: NACE 2: DO: EM: Mfg: Transport Equipment')]/preceding::div[contains(@class,'series-item--country')][1]", 4)).pause(2000).build().perform();
	...
	public void collapse_the_dataset_and_perform_right_click_operation() throws Throwable {
		WebElement expand = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='nodes-list--tree-wrapper']//div[@class='title']/parent::div", 4);
		if(expand.getAttribute("class").contains("full-expanded")) {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[@class='nodes-list--tree-wrapper']//div[@class='title']/child::div[1]", 4)).pause(200).click().build().perform();	
		} else {
		System.out.println("===> The Dataset window has been closed already <===");	
		}
		WebElement ele = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+Comparables.section_name+"')]", 4);
	...
	public void verify_the_replaced_series() throws Throwable {
		List<WebElement> series_name = login.driver.findElements(By.cssSelector(".series-item--main-info .series-item--name"));
		for(int i= series_name.size()-1; i>=0; i--) {
			String series_left = CommonFunctionality.getElementBycssSelector(login.driver, ".series-item--main-info .series-item--name", 4).getText();
			series_name_inside_dataset.add(series_left);
		}
		List<WebElement> visual_series = login.driver.findElements(By.xpath("//*[@class='legend-item']//*[contains(@class,'series-edit--title')]"));
		for(int j=1; j<= visual_series.size(); j++) {
			String chart_series = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='legend-item']//*[contains(@class,'series-edit--title')])["+j+"]", 4).getText();
	...
	public void select_the_series_checkbox() throws Throwable {
		CommonFunctionality.wait(1000);
		boolean checkbox = login.driver.findElement(By.xpath("(//span[contains(@class,'series-list-item--checkbox')])[1]")).isSelected();
		if(checkbox == false) {
			new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//span[contains(@class,'series-list-item--checkbox')])[1]", 4)).click().build().perform();
		} else {
	...
	public void paste_in_the_clipboard_and_take_url_one_by_one() throws Throwable {
		...
		for(String line: textArea) {
			...
			String code = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='main-series-information--series-id']/div[2]", 4).getText();
	...
	public void clicking_option_in_Dataset(String arg1) throws Throwable {
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='add-to-data-selection--title'])[2]", 4)).pause(500).build().perform();
	...
	public void verify_Checkbox_is_checked() throws Throwable {
	   WebElement checkbox = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'svg-checkbox')])[1]", 4);
	...
	if(arg1.equalsIgnoreCase("A")) {
		...
		WebElement source = CommonFunctionality.getElementBycssSelector(login.driver, ".series-data-set--table-name", 4);
		WebElement target = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='data-selection-series-overlay--content'] | //*[@class='empty-visual-overlay--content']", 4);
		//select_any_checkbox_for_dataset();
		(new Actions(login.driver)).pause(500).clickAndHold(source).pause(1000).moveToElement(target).pause(500).release(target).build().perform();
	} if(arg1.equalsIgnoreCase("Drag and Drop a Series")) {
		WebElement source = CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='series-item--name'])[1]", 4);
		WebElement target = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='data-selection-series-overlay--content'] | //*[@class='empty-visual-overlay--content']", 4);
		(new Actions(login.driver)).pause(500).clickAndHold(source).pause(1000).moveToElement(target).pause(500).release(target).build().perform();
	}
	}
	...
	public void create_an_empty_view_and_click_on_option(String arg1) throws Throwable {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[@class='view-action-panel']//div[@data-title='"+arg1+"']", 4)).pause(500).click().build().perform();
	...
	public void search_for_the_with_ID_and_click_on_option(String arg1, String arg2, String arg3) throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//span[contains(@class,'svg-checkbox')]", 4)).pause(500).click().build().perform();
	...
	public void click_the_footnotes_icon() throws Throwable {
	   WebElement hovor = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])[1]", 4);
	   footnotes_dataset_title = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])[1]", 4).getText();
	   new Actions(login.driver).moveToElement(hovor).pause(500).perform();
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+footnotes_dataset_title+"')]/following::*[@title='Open footnote'][1]", 4)).click().build().perform();
	}
	...
	public void verify_the_and_validate_option(String arg1, String arg2) throws Throwable {
		if(arg1.equalsIgnoreCase("Chart")) {
			...
			boolean enable = login.driver.findElement(By.cssSelector(".visual-top-panel--left-controls .button__primary")).isEnabled();
	...
	public void verify_that_the_dataset_is_added_in_right_pane() throws Throwable {
	   CommonFunctionality.wait(1000);
	   select_any_checkbox_for_dataset();
	   CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@class,'data-set-node')]//*[contains(@class,'svg-checkbox__selected')]/following::*[@class='series-data-set--table-name'][1]")));
	   String name_left = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'data-set-node')]//*[contains(@class,'svg-checkbox__selected')]/following::*[@class='series-data-set--table-name'][1]", 4).getText();
	   String series_left = CommonFunctionality.getElementByClassName(login.driver, "search-input--preview-selection", 4).getText();
	   String[] left_series_count = series_left.split("[^a-zA-Z0-9]");
	   int left_count = Integer.parseInt(left_series_count[0]);
	   String right_series_count = CommonFunctionality.getElementByXpath(login.driver, "//span[@class='series-panel--count']//*[@js-series-number='']", 4).getText();
	 ...
	 public void clicking_on_go_to_insight_name_should_open_the_new_insight_with_the_added_series() throws Throwable {
	    ...
	    actual = login.driver.findElement(By.xpath("(//span[@class='series-name-field--series-name'])["+i+"]")).getText();
	 ...
	 public void should_be_able_to_navigate_to_the_existing_insight() throws Throwable {
		String existing_insight = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='input-control--description'])[1]", 4).getText();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='input-control--description'])[1]/preceding-sibling::span", 4)).click().build().perform();
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Apply']", 4).click();
		String expected = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'growl-message--link')]", 4).getText();
	...
	public void hovor_on_to_the_series_name() throws Throwable {
	   ...
	   String series_name = login.driver.findElement(By.xpath("//*[contains(@class,'series-list-item__selected')]["+i+"]//*[@class='series-item--name']")).getAttribute("innerHTML");
	...
	public void verify_that_the_series_is_added_in_right_pane() throws Throwable {
	   ...
	   CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@class,'data-set-node')]//*[contains(@class,'series-list-item__selected')]//*[@class='series-item--name']")));
	   String name_left = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'data-set-node')]//*[contains(@class,'series-list-item__selected')]//*[@class='series-item--name']", 4).getText();
       String name_right = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='series-name-field--series-name']", 4).getText();
	...
	public void verify_that_the_series_is_added_successfuly_in_right_pane_with_Group() throws Throwable {
	   String right_series_count = CommonFunctionality.getElementByXpath(login.driver, "//span[@class='series-panel--count']//*[@js-series-number='']", 4).getText();
       int right_count = Integer.parseInt(right_series_count);
       String right = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='series-name-wrapper']//following-sibling::*[@class='group-name']", 4).getText();
	...
	public void verify_that_the_series_is_added_successfuly_in_right_pane() throws Throwable {
	   String right_series_count = CommonFunctionality.getElementByXpath(login.driver, "//span[@class='series-panel--count']//*[@js-series-number='']", 4).getText();
       int right_count = Integer.parseInt(right_series_count);
       String right = CommonFunctionality.getElementByClassName(login.driver, "series-name-field--series-name", 4).getText();
       assertEquals(Comparables.series_count_inside_table, right_count);
	...
	public void verify_selected_links_are_copied() throws Throwable {
	    ...
	    ArrayList<String> tabs = new ArrayList<String>(login.driver.getWindowHandles());
	    login.driver.switchTo().window(tabs.get(1));
	    String text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+Comparables.section_name+"')]", 4).getText();
	    String dataset_name[] = text.split("\\: ",2);
	    String count = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+text+"')]/following-sibling::span", 4).getText();
	    String count1 = count.substring(1, 2);
	    int dataset_count = Integer.parseInt(count1);
	    List<WebElement> series = login.driver.findElements(By.xpath("//*[contains(text(),'"+text+"')]/following::div[@class='series-item--name']"));
	    for(int i=1; i <= series.size(); i++) {
		String series_name = login.driver.findElement(By.xpath("//*[contains(text(),'"+text+"')]/following::div[@class='series-item--name']["+i+"]")).getText();
	...
	public void verify_Sort_by_option_for(String arg1, int arg2) throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]")));
		CommonFunctionality.wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]")));
		WebElement open = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]", 4);
		if(!(open.getAttribute("class").contains("dropdown__open"))) {
		...
		String expected = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='custom-select--body']//div["+arg2+"]/div", 4).getAttribute("title");
	...
	public void the_series_in_dataset_getting_unselected() throws Throwable {
		...
		if(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+Comparables.section_name+"') and not(@class='insight-discovery--popup-title')]",4).isDisplayed()) {
		 login.Log4j.info("The series gets unselected and has been returned back to series level and verified successfully");
		} else {
		 fail("Verification Failed");	
		}
	}
	...
	public void verify_Sort_by_option_for_the(String arg1, int arg2) throws Throwable {
		...
		WebElement expected = CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='custom-select--body']/li["+arg2+"]/div[text()='"+arg1+"']", 4);
		new Actions(login.driver).moveToElement(expected).click().build().perform();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sort-select-title__asc-hidden')]//*[@class='custom-select-title--reset-icon']", 4)).click().build().perform();
		CommonFunctionality.wait(500);
		WebElement reset = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'sort-select-title__asc-hidden')]", 4);
	...
	public void verify_closing_the_Sort_by_option() throws Throwable {
		CommonFunctionality.wait(2000);
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]")));
		WebElement close = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='data-sets--right']//div[@class='dropdown--button']/parent::div[contains(@class,'custom-select')]", 4);
	...
	public void verify_the_tooltips_for_different_dataset() throws Throwable {
		...
		for(int i=1; i<=datasets.size();i++) {
			WebElement text = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-data-set--table-name'])["+i+"]", 4);
			js.executeScript("arguments[0].scrollIntoView(true);", text);
	...
	public void verify_the_datasets_keyboard_shortcuts(String arg1, String arg2) throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@class='nodes-list--tree-wrapper']//*[contains(@class,'data-set-node')])[1]")));
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='nodes-list--tree-wrapper']//*[contains(@class,'data-set-node')])[1]", 4)).pause(500).build().perform();
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@class='nodes-list--tree-wrapper']//*[contains(@class,'data-set-node')])[1]")));
	    WebElement expand = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='nodes-list--tree-wrapper']//*[contains(@class,'data-set-node')])[1]", 4);
	    if(arg1.equalsIgnoreCase("Expand") && arg2.equalsIgnoreCase("Without")) {
	    	CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@class,'data-set-node')][1]//div[@class='toggle']")));
			new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'data-set-node')][1]//div[@class='toggle']", 4)).pause(500).click().build().perform();
	...
	public void clicking_on_the_insight_name_should_open_new_insight() throws Throwable {
		CommonFunctionality.wait(2000);
		String name_left = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'data-set-node')]//*[contains(@class,'svg-checkbox__selected')]/following::*[@class='series-data-set--table-name'][1]", 4).getText();
		String series_left = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'data-set-node')]//*[contains(@class,'svg-checkbox__selected')]/following::*[@class='data-set-node--count'][1]", 4).getText();
		String[] left_series_count = series_left.split("[^a-zA-Z0-9]");
		int left_count = Integer.parseInt(left_series_count[0]);
		login.driver.findElement(By.xpath("//*[@class='growl-message growl-success']//*[@class='button growl-message-content--btns__fill']")).click();
	...
	public void the_Footnotes_window_for_Dataset_should_be_open() throws Throwable {
	   CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("span[class='footnotes-modal--name'] span")));
	   String text = CommonFunctionality.getElementBycssSelector(login.driver, "span[class='footnotes-modal--name'] span", 4).getText();
	...
	public void the_related_dataset_option_should_present() throws Throwable {
	   List<WebElement> element = login.driver.findElements(By.xpath("//*[@class='related-series-information-portlet--container']//*[@class='series-data-set--table-name']"));
	   for(int i=1; i<= element.size(); i++) {
	   String title = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='related-series-information-portlet--container']//*[@class='series-data-set--table-name'])["+i+"]", 4).getAttribute("title");
	   CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='related-series-information-portlet--container']//*[@class='series-data-set--table-name'])["+i+"]", 4).click();
	...
	public void the_should_present_on_tooltip(int arg1, String arg2) throws Throwable {
	   String split = CommonFunctionality.getElementByXpath(login.driver, "(//tr[@class='series-tooltip-table--row']//td[1])["+arg1+"]", 4).getText();
