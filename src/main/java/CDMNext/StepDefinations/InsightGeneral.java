...
public class InsightGeneral {
	...
	public void delete_all_views() throws Throwable {
		WebElement visual1 = CommonFunctionality.getElementByXpath(login.driver, "//a[@class='insight-page-view-tab--link insight-page-view-tab--link__active']" , 4);
		...
		CommonFunctionality.getElementByXpath(login.driver, "/html/body/div[1]/div/div[3]/div[2]/div/div[2]/div/div[2]/button[2]", 4).click();	
	}
	...
	public void verify_insight_title_change() throws Throwable {
		String insightText = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title.text-dots",4).getText();
	...
	public void verify_insight_URL_after_changed_insight_title_with_existing_insight_title() throws Throwable {
		...
		String username = "SR" + new Random().nextInt(1000);
		CommonFunctionality.getElementByProperty(login.driver, "untitledInsight", 4).click();
		new Actions(login.driver).moveToElement(ele).pause(500).sendKeys(username).sendKeys(Keys.ENTER).build().perform();
		...
		login.Log4j.info("The insight URL after changed insight title with existing insight title has been verified successfully");
	}
	...
	public void check_for_the_options(String arg1) throws Throwable {
	    String actual = CommonFunctionality.getElementBycssSelector(login.driver,".items-wrapper span[title='"+arg1+"']",4).getAttribute("title");
	...
	public void check_for_the_options(String arg1, String arg2) throws Throwable {
	   WebElement display = CommonFunctionality.getElementByXpath(login.driver, "//*[@title='"+arg1+"']//*[name()='use' and contains(@*,'#actions__"+arg2+"')]", 4);
	...
	public void verify_tag_popup_is_displayed() throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(login.LOCATORS.getProperty("add_tag_popup"))));
	...
	public void verify_tag_in_insight_explorer() throws Throwable {
		...
		CommonFunctionality.wait(2000);
		List<WebElement> tags = login.driver.findElements(By.xpath("//*[contains(text(),'"+tagEnter1+"')]"));
		CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+tagEnter1+"')]", 4).click();
		assertEquals(tags.size(), 1);
		System.out.println("Tag is shown in insight explorer");
		CommonFunctionality.getElementBycssSelector(login.driver, ".custom-select-title--reset-icon", 4).click();
		CommonFunctionality.getElementBycssSelector(login.driver, ".insights-control--wrapper .custom-select-title__reset-hidden .dropdown--icon", 4).click();
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+CollabarationSharing.new_insight_name+"')]", 4)).pause(1000).build().perform();
		WebElement insight = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+CollabarationSharing.new_insight_name+"']/following::*[contains(text(),'Customize')][1]", 4);
	...
	public void save_as_changes_is_shown() throws Throwable {
		List<WebElement> save_as = CommonFunctionality.getElementsByXpath(login.driver, "//*[contains(@class,'sphere-modal__content')]//*[text()='Copy the Insight']");
	...
	public void verify_default_insight_title_on_coping_insight() throws Throwable {
		List<WebElement> save_as = login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal__content')]//*[text()='Copy the Insight']"));
		assertEquals(save_as.size(), 1);
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
		System.out.println("Save as option has been verified");
	}
	...
	public void Verify_the_insight_saved_with_updated_title() throws Throwable {
		...
		new Actions(login.driver).moveToElement(input).sendKeys(Keys.chord(Keys.CONTROL,Keys.BACK_SPACE)).sendKeys("Shravas").build().perform();
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Copy Insight']", 4).click();
		CommonFunctionality.wait(1000);
		String actual = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title__editable", 4).getText();
		cs.click_option_from_the_title("Open File menu");
		cs.click_option_from_the_title("View");
		String expected = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-preview--title.text-dots", 4).getText();
	...
	public void verify_that_the_insight_saved_with_updated_title() throws Throwable {
		...
		CommonFunctionality.wait(1000);
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
		String actual = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title", 4).getText();
	...
	public void click_on_Edit_icon_on_insight_URL_field_and_Verify() throws Throwable {	
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-editable", 4)).pause(500).build().perform();
		...
		String actual = CommonFunctionality.getElementByClassName(login.driver, "friendly-url__uneditable", 4).getText();
	...
	public void verify_Copy_permanent_link_option() throws Throwable {
		...
		CommonFunctionality.getElementByProperty(login.driver, "Name_Insight_Save", 4).click();
		CommonFunctionality.getElementByProperty(login.driver, "Name_Insight_Close", 4).click();
		String InsightCuurentTab = CommonFunctionality.getElementByProperty(login.driver, "Untitled_insight", 4).getText();
	...
	public void verify_icons_for_file_menu() throws Throwable {
		...
		if (View_Icon == true && Add_To_Favorite_Icon == true && New_Icon == true && Open_Icon == true && Save_Icon == true	&& Delete_Icon == true && Save_As_Icon == true && Refresh_Icon == true && Settings_Icon == true && Protect_Icon == true && Download_Icon == true && Share_Icon == true) {
	...
	public void the_Email_template_should_be_opened_with_auto_filled_email_ID(String arg1) throws Throwable {
		String text = CommonFunctionality.getElementByXpath(login.driver, "//a[contains(text(),'our help desk team')]", 4).getAttribute("href");
	...
	public void list_of_recent_opened_insights_should_be_displayed(int arg1) throws Throwable {
		List<WebElement> insights = login.driver.findElements(By.xpath("//*[@class='recent-insight-sub-menu-item-view']"));
		if(arg1 == 1) {
		String expected = login.driver.findElement(By.xpath("(//*[@class='recent-insight-sub-menu-item-view'])[1]/div")).getAttribute("title");
		Thread.sleep(1000);
	...
	public void insight_should_not_be_editable() throws Throwable {
		CommonFunctionality.wait(2000);
	    CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--body']//*[@data-name='title']", 4).click();
	    WebElement delete = login.driver.findElement(By.cssSelector(".insight-preview--views div[data-action='delete']"));
	...
	public void verify_to_favorite_option(String arg1) throws Throwable {
	    if(arg1.equalsIgnoreCase("Add")) {
	    	CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Add to favorite']", 4).click();
	    	String insight_title = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title", 4).getText();
	    	cv.click_on_my_insights();
	    	CommonFunctionality.getElementBycssSelector(login.driver, "div[data-tab='favorite']", 4).click();
	    	CommonFunctionality.getElementBycssSelector(login.driver, "div[title='View as a grid']", 4).click();
	    	String fav_title = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-grid-item--bottom-panel-title", 4).getText();
	    	...
	    	CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Add to favorite']", 4).click();
	    	click_on_File_menu();
	    	CommonFunctionality.getElementByXpath(login.driver, "//*[@class='items-wrapper']//*[@title='Remove from favorite'] | //*[@class='items-wrapper']//*[@title='Add to favorite']", 4).click();
	    	String insight_title = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title", 4).getText();
	    	cv.click_on_my_insights();
	    	CommonFunctionality.getElementBycssSelector(login.driver, "div[data-tab='favorite']", 4).click();
	...
	public void click_on_Add_to_favorite_option_and_Verify() throws Throwable {
		...
		String Fav_Insight_Title = CommonFunctionality.getElementByProperty(login.driver, "Fav_Insight_Title", 4).getAttribute("title");
	...
	public void verify_Open_option_in_insight_preview() throws Throwable {
		String InsightCurrentTab = CommonFunctionality.getElementByProperty(login.driver, "Untitled_insight", 4).getText();
		...
		login.driver.switchTo().window(tabs.get(1)).close();
		login.driver.switchTo().window(tabs.get(0));
		if(CommonFunctionality.getElementsByXpath(login.driver, "//div[@class='insight-context-menu--menu-icon']").size()>0) {
		CommonFunctionality.getElementByProperty(login.driver, "file", 4).click();
		}
	...
	public void verify_Insight_title_update_in_Copy_the_insight_popup() throws Throwable {
		CommonFunctionality.getElementBycssSelector(login.driver, ".insight-copy-text-input.block.form--control", 4).clear();
		CommonFunctionality.getElementBycssSelector(login.driver, ".insight-copy-text-input.block.form--control", 4).sendKeys("TEST");
		boolean copy_insight = login.driver.findElement(By.cssSelector(".sphere-modal-control.button__primary")).isEnabled();
	...
	public void verify_Copy_insight_button() throws Throwable {
		...
		CommonFunctionality.wait(1000);
		String expected = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title-block.text-dots", 4).getText();
	...
	public void verify_changing_title_while_coping_insight() throws Throwable {
		...
		CommonFunctionality.getElementBycssSelector(login.driver, ".insight-copy-text-input block", 4).sendKeys("Shravas");
		CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Copy Insight']", 4).click();
		String copied_insight = CommonFunctionality.getElementByProperty(login.driver, "Untitled_insight", 4).getText();
		click_on_File_menu();
		cs.click_option_from_the_title("View");
	...
	public void verify_Download_option_in_insight_preview_without_visual() throws Throwable {
		CommonFunctionality.wait(2000);
        List<WebElement> download = login.driver.findElements(By.xpath("//div[@class='insight-preview--header']/div[2]/div[3]/button"));
	...
	public void create_Visual() throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'series-list-item--checkbox')])[1]//span", 4)).pause(500).click().build().perform();
		new Actions(login.driver).pause(500).sendKeys("c").build().perform();
		CommonFunctionality.wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".visual-top-panel--left-controls .button__primary")));
	}
	...
	public void search_for_related_insight_series() throws Throwable {
		...
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='search-series-list']/li[1]/div/a/div[2]/span", 4)).pause(500).click().sendKeys("c").build().perform();
		cv.click_on_my_insights();
		cv.click_option_from_empty_list("View as a table");
	    new Actions(login.driver).keyDown(Keys.CONTROL).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[not(contains(@data-id,'Untitled-insight'))]/following::*[text()='"+CollabarationSharing.new_insight_name+"'])[1]//following::div[@class='insight-table-item--info'][1]", 4)).pause(200).click().build().perform();
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[not(contains(@data-id,'Untitled-insight'))]/following::*[contains(@class,'insight-table-item--title-link')])[2]//following::div[@class='insight-table-item--info'][1]", 4)).pause(200).click().keyUp(Keys.CONTROL).build().perform();
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-table-item--options')])[2]", 4)).pause(200).contextClick().build().perform();
	   	CommonFunctionality.getElementBycssSelector(login.driver, "div[class='items-wrapper'] span[title='Add tags']", 4).click();
	   	CommonFunctionality.getElementBycssSelector(login.driver, "input[placeholder='Enter tags ...']", 4).click();
	   	CommonFunctionality.getElementBycssSelector(login.driver, "input[placeholder='Enter tags ...']", 4).sendKeys("Related Insights");
	   	CommonFunctionality.getElementBycssSelector(login.driver, ".sphere-modal-control.button__primary", 4).click();
	   	cv.click_option_from_empty_list("View as a grid");
	   	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+CollabarationSharing.new_insight_name+"')]", 4)).pause(1000).build().perform();
	   	CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+CollabarationSharing.new_insight_name+"']/following::*[contains(text(),'Customize')][1] | //*[text()='"+CollabarationSharing.new_insight_name+"']/following::*[contains(text(),'Open')][1]", 4).click();
	   }
	...
	public void verify_Download_option_in_insight_preview_with_visual()	throws Throwable {
		...
		if (login.driver.findElements(By.xpath(login.LOCATORS.getProperty("Ig_Downloadpopup"))).size() != 0) {
			...
			CommonFunctionality.getElementByProperty(login.driver, "MYINSIGHTS_CLOSE", 4).click();
			CommonFunctionality.getElementByProperty(login.driver, "Ig_Preview_Close", 4).click();
			new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "insight-page-view-tab--title", 4)).contextClick().pause(500).build().perform();
			CommonFunctionality.getElementBycssSelector(login.driver, "div[class='items-wrapper'] span[title='Delete view']", 4).click();
	...
	public void click_on_Maximize_button() throws Throwable {
		CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--action__toggle']", 4).click();
	}

	@Given("^Verify 'Maximize' option in insight preview$")
	public void verify_Maximize_option_in_insight_preview() throws Throwable {
		WebElement maximize = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='insight-preview--action__toggle']/ancestor::div[5]", 4);
	...
	public void verify_auto_title_for_Create_insight() throws Throwable {
		String insightTitle = CommonFunctionality.getElementByProperty(login.driver, "Ig_InsightTitle", 4).getAttribute("value");
	...
	public void verify_Create_insight_button() throws Throwable {
		String newInsight = CommonFunctionality.getElementByProperty(login.driver, "Ig_InsightTitle", 4).getAttribute("value");
		CommonFunctionality.getElementByProperty(login.driver, "create_insight", 4).click();
		String insightTitle = CommonFunctionality.getElementBycssSelector(login.driver, ".insight-breadcrumb--title.text-dots", 4).getText();
	...
	public void verify_Delete_forever_button() throws Throwable {
		...
		CommonFunctionality.wait(3000);
		String untitledinsight = CommonFunctionality.getElementByProperty(login.driver, "Untitled_insight", 4).getText();
	...
	public void the_Edit_icon_should_be_displayed_and_URL_should_be_selected_when_click_on_it() throws Throwable {
	    if(login.driver.findElements(By.xpath("//*[@class='modal-header sphere-modal__header']//*[text()='Insight settings']")).size()>0) {
	       String insight_name = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-settings--input-field')])[1]", 4).getAttribute("value");
	       assertEquals(CollabarationSharing.new_insight_name, insight_name);
	       new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-editable", 4)).pause(1000).build().perform();
	       ...
	       WebElement friendlyURL = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='friendly-url__input-icon']/ancestor::div[3]", 4);
	...
	public void the_URL_should_be_changed_as_per_updated() throws Throwable {
		...
		CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-icon", 4).click();
		Thread.sleep(500);
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-editable", 4)).sendKeys(Keys.chord(Keys.CONTROL, "a")).sendKeys(Keys.BACK_SPACE).pause(500).sendKeys(text).pause(500).build().perform();
		CommonFunctionality.getElementBycssSelector(login.driver, ".button__secondary_purple", 4).click();
		Thread.sleep(200);
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
		click_on_File_menu();
		click_on_Settings();
		String expected = CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-editable", 4).getAttribute("value");
		CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void click_on_Add_views() throws Throwable {
		CommonFunctionality.wait(1000);
		//CommonFunctionality.getElementByXpath(login.driver, "//*[@data-id='myseries']", 4).click();
	...
	public void verify_Refresh_option() throws Throwable {
		 String Title = CommonFunctionality.getElementByProperty(login.driver, "Ig_viewtab_active", 4).getAttribute("title");
	...
	public void click_on_Settings_and_Verify_the_available_tabs_in_the_settings_popup()	throws Throwable {
		CommonFunctionality.wait(3000);
		String text = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'insight-breadcrumb--title text-dots')]", 4).getText();
		click_on_File_menu();
		click_on_Settings();
	...
	public void verify_Change_insight_URL_with_existing_insight_name()
		...
		WebElement element = login.driver.findElement(By.xpath(login.LOCATORS
				.getProperty("Ig_settingurl")));
		action.moveToElement(element).build().perform();
		action.moveToElement(CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input", 4)).build().perform();
		Thread.sleep(2000);
		login.driver.findElement(
				By.xpath(login.LOCATORS.getProperty("Ig_urlediticon"))).click();
		login.driver.findElement(
	...
	public void verify_for_all_options(String arg1) throws Throwable {
		WebElement edit = CommonFunctionality.getElementByXpath(login.driver,"//*[text()='Edit']/following::div[2]", 4);
	    WebElement copy = CommonFunctionality.getElementByXpath(login.driver,"//*[text()='Copy']/following::div[2]", 4);
		if(arg1.equalsIgnoreCase("ON")) {
		 if(edit.getAttribute("class").contains("bootstrap-switch-on")) {
		  ...
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Edit']/following::*[@class='bootstrap-switch-label'][1]",4)).click().build().perform();
		 } if(copy.getAttribute("class").contains("bootstrap-switch-on")) {
		  System.out.println("Copy option is already in ON state");
		} else {
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Copy']/following::*[@class='bootstrap-switch-label'][1]",4)).click().build().perform();
		}
		WebElement apply = login.driver.findElement(By.xpath("//*[text()='Apply' and contains(@class,'button__secondary_purple')]"));
		if(apply.getAttribute("class").contains("button__disabled")) {
			System.out.println("Apply button is not enabled");
		} else {
			CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Apply' and contains(@class,'button__secondary_purple')]", 4).click();
		}
		if(edit.getAttribute("class").contains("bootstrap-switch-on") && copy.getAttribute("class").contains("bootstrap-switch-on")) {
			...
			if(edit.getAttribute("class").contains("bootstrap-switch-off") && copy.getAttribute("class").contains("bootstrap-switch-off")) {
	...
	public void should_able_to_add_insight_descripiton() throws Throwable {
	    ...
	    CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings-control']/textarea", 4).sendKeys(random_text);
	    CommonFunctionality.getElementBycssSelector(login.driver, ".button__secondary_purple", 4).click();
	    Thread.sleep(1000);
	    CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	...
	public void the_descripton_should_be_visible_to_user() throws Throwable {
	    ...
	    cv.click_on_my_insights();
	    CommonFunctionality.getElementBycssSelector(login.driver, "div[title='View as a grid']", 4).click();
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+CollabarationSharing.new_insight_name+"']", 4)).pause(1000).build().perform();
	    String actual = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'"+CollabarationSharing.new_insight_name+"')]//following::*[contains(@class,'insight-grid-item--description-text')]", 4).getText();
	...
	public void by_default_the_Save_and_Apply_buttons_should_be_disabled_and_enable_after_any_changes_made() throws Throwable {
	    CommonFunctionality.wait(1000);
		WebElement apply = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'button__secondary_purple')]", 4);
	    WebElement save = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='sphere-modal-controls--right']//*[contains(@class,'button__primary')]",4);
	    if(apply.getAttribute("class").contains("button__disabled") && save.getAttribute("class").contains("button__disabled")) {
	    	System.out.println("The buttons are disabled by default");
	    } else {
	    	fail("Verification Failed");
	    }
	    CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings-control']/textarea", 4).sendKeys("Shravas"+ new Random().nextInt(1000));
	    Thread.sleep(1000);
	    if(!apply.getAttribute("class").contains("button__disabled") && !save.getAttribute("class").contains("button__disabled")) {
	...
	public void the_button_is_clicked_and_popup_size_is(String arg1, int arg2) throws Throwable {
	   ...
	   CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings-control']/textarea", 4).sendKeys(actual);
	   Thread.sleep(1000);
	   if(arg1.equalsIgnoreCase("Save")) {
		   ...
		   click_on_File_menu();
		   click_on_Settings();
		   String expected = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings-control']/textarea", 4).getText();
		   assertEquals(actual, expected);
		   CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
	   }
	...
	public void the_original_link_of_insight_should_be_copied() throws Throwable {
		login.driver.findElement(By.xpath("//*[@title='Permanent link is an insight URL that will never be changed.']")).click();
		...
		String url = CommonFunctionality.getElementByClassName(login.driver, "friendly-url__input-editable", 4).getAttribute("value");
	...
	public void the_message_should_popup(String arg1) throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings-control']/textarea", 4).sendKeys(input);
		CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'button__secondary_purple')]", 4).click();
		String actual = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='insight-settings__changes-saved-message' and @style='display: inline;']", 4).getText();
	    login.driver.findElement(By.xpath(login.LOCATORS.getProperty("MYINSIGHTS_CLOSE"))).click();
	    assertEquals(actual, arg1);
	...
	public void share_insight_and_Check_the_sharing_settings_field() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='sphere-modal-controls'])[2]//*[contains(@class,'button__primary')]", 4).click();
	...
	public void verify_the_insight_for_added_keywords_in_insight_explorer()	throws Throwable {
		...
		//open_insight();
		CommonFunctionality.getElementByXpath(login.driver, "//input[@class='insights-search--input']", 4).sendKeys("CEIC DATA");
		CommonFunctionality.getElementByXpath(login.driver, "//input[@class='insights-search--input']", 4).sendKeys(Keys.ENTER);
	...
	public void remove_keywords() throws Throwable {
		...
		CommonFunctionality.getElementByProperty(login.driver, "Ig_Keyword_desc", 4).sendKeys(Keys.ENTER);
		CommonFunctionality.wait(2000);
		if(login.driver.findElements(By.xpath("//ul[contains(@class,'ui-widget-content ui-corner-all')]")).size() > 0) {
	...
	public void click(String arg1, String arg2) throws Throwable {
	   ...
	   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()=\""+arg2+"\"]", 4)).pause(500).click().build().perform();
	}
	...
	public void the_latest_insights_should_be_displayed(int arg1) throws Throwable {
		List<WebElement> total_insights = CommonFunctionality.getElementsByXpath(login.driver, "//*[@class='all-insights-list-item']");
	...
	public void get_text_of_available_for(String arg1, String arg2) throws Throwable {
	    String notification_option = CommonFunctionality.getElementBycssSelector(login.driver, "div[data-tab='"+arg1+"']", 4).getText();
	...
	public void the_announcement_popup_should_be_displayed() throws Throwable {
	    if(login.driver.findElements(By.xpath("//*[@class='ceic-highlight--title' and text()='There are no recent announcements']")).size()==1) {
	    System.out.println(" <=========== Announcement popup is not displayed ===========>");	
	    }if(login.driver.findElements(By.xpath("//*[@class='activity-block-header--title' and contains(text(),'Highlights')]/following-sibling::*[contains(@class,'activity-block-header--link')]")).size()==1) {
	    String anno_text = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='ceic-highlight--content']//div[2]/div[1]", 4).getText();
	    String split[] = anno_text.split(",\n");
	    assertEquals(split[0],"Dear CEIC Subscriber");
	    List<WebElement> databases = CommonFunctionality.getElementsByXpath(login.driver, "//*[@class='ceic-highlight--content']//a[contains(@class,'tinymce-plugin-link')]");
	    for(int i=1; i<=databases.size(); i++) {
	    if(i!=1) {
	     CommonFunctionality.getElementByClassName(login.driver, "user-notifications--icon", 4).click();
	    }
	    WebElement one_database = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='ceic-highlight--content']//a[contains(@class,'tinymce-plugin-link')])["+i+"]", 4);
	    js.executeScript("arguments[0].scrollIntoView(true);", one_database);
	    String data_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='ceic-highlight--content']//a[contains(@class,'tinymce-plugin-link')])["+i+"]", 4).getText();
	    new Actions(login.driver).moveToElement(one_database).pause(1000).click().build().perform();
	    CommonFunctionality.wait(5000);
	    if(CommonFunctionality.getElementsByXpath(login.driver, "//*[@class='insight-preview--views-wrapper']").size() == 0) {
	    ...
	    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//a[contains(@class,'activity-block-header--link') and text()='See all highlights']", 4)).pause(500).click().build().perform();
	    if(login.driver.findElements(By.xpath("//*[contains(@class,'sphere-modal__content')]//*[text()='Announcements']")).size() == 1) {
	    	System.out.println("The popup is shown");
	    } else {
	    	fail("Not shown");
	    }
	    WebElement whats_new = CommonFunctionality.getElementBycssSelector(login.driver, ".select2-container.form--control", 4);
	    CommonFunctionality.getElementByClassName(login.driver, "select2-arrow", 4).click();
	    List<WebElement> products = login.driver.findElements(By.xpath("//ul[@class='select2-results']/li/div/div[2]"));
	    for(int i=1; i<=products.size(); i++) {
	    	String product_text = CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='select2-results']/li["+i+"]/div/div[2]", 4).getText();
	    	if(product_text.equalsIgnoreCase("World Trend Plus") || product_text.equalsIgnoreCase("Global Database") || product_text.equalsIgnoreCase("Brazil Premium Database") || product_text.equalsIgnoreCase("China Premium Database") || product_text.equalsIgnoreCase("India Premium Database") || product_text.equalsIgnoreCase("Indonesia Premium Database") || product_text.equalsIgnoreCase("Russia Premium Database") || product_text.equalsIgnoreCase("CDMNext") || product_text.equalsIgnoreCase("API & Integrations")) {
	    ...
	    if(whats_new.getAttribute("class").contains("select2-dropdown-open")) {
		   new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='select2-results']/li[1]/div", 4)).pause(500).click().build().perform();
		}
	    ...
	    List<WebElement> products_name_list = CommonFunctionality.getElementsByXpath(login.driver, "//ul[@class='select2-results']/li");
	    for(int i=1;  i<=products_name_list.size(); i++) {
	    	...
	    	WebElement product = CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='select2-results']/li["+i+"]", 4);
	    	product.click();
	    	CommonFunctionality.wait(3000);
	    	/*WebElement loader = login.driver.findElement(By.cssSelector(".announcements-products-updates .announcements-container--body"));
	    	...
	    	for(int j=1; j<=product_name.size(); j++) {
	    		WebElement product1 = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'insight-ceic')]["+j+"]", 4);
	    ...
	    CommonFunctionality.getElementBycssSelector(login.driver, ".link__inverted.modal-icon-button--text", 4).click();
	    ArrayList<String> tabs = new ArrayList<String>(login.driver.getWindowHandles());
    	assertEquals(tabs.size(), 2);
		login.driver.switchTo().window(tabs.get(1));
	...
	public void the_should_open_in_preview_mode_with_limit(String arg1, int arg2) throws Throwable {
		if(arg1.equalsIgnoreCase("Recent Insights")) {
			click("Notifications", "Recommendations"); 
	    	CommonFunctionality.wait(4000);
	    	...
	    	List<WebElement> recent_insight = login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following::*[contains(@class,'insight-ceic')]"));	    	
	    	...
	    	for(int i=1; i<= recent_insight.size(); i++) {
	    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg1+"']/following::*[contains(@class,'insight-ceic')]["+i+"]", 4)).pause(2000).click().build().perform();
	    		CommonFunctionality.wait(5000);
			...
			click("Notifications", "Recommendations"); 
	    	CommonFunctionality.wait(3000);
	    	List<WebElement> recent_insight = login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link']"));	    	
	    	sa.assertEquals(recent_insight, arg2);
	    	System.out.println("The recent insight count is:" +arg2);
	    	for(int i=1; i<= recent_insight.size(); i++) {
	    		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link'])["+i+"]", 4)).pause(500).click().build().perform();
	    		CommonFunctionality.wait(3000);
	    		List<WebElement> preview = login.driver.findElements(By.className("insight-preview--close"));
	    		CommonFunctionality.wait(3000);
	    		CommonFunctionality.getElementByClassName(login.driver, "insight-preview--close", 4).click();
	    	...
	    	if(data.getAttribute("class").contains("active") && login.driver.findElements(By.className("insights-group--main-wrapper")).size()>0) {
	    	...
	    	WebElement grid = CommonFunctionality.getElementByXpath(login.driver, "//*[@title='View as a grid']/parent::div", 4);
	    	...
	    	CommonFunctionality.getElementBycssSelector(login.driver, ".custom-select-title--handler.icon--filter-arrow", 4).click();
	    	CommonFunctionality.getElementBycssSelector(login.driver, "div[title='Popularity']", 4).click();
	    	CommonFunctionality.wait(4000);
	    	for(int i=1; i<=10; i++) {
	    		String analytic_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-grid-item--bottom-panel-title')])["+i+"]", 4).getText();
	    		analysis_insight.add(analytic_text);
	    	}
	    	click("Notifications", "Recommendations"); 
	    	CommonFunctionality.wait(4000);
	    	List<WebElement> ceic_insight = login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link']"));
	    	sa.assertEquals(ceic_insight, arg2);
	    	System.out.println("The insight count is "+arg2);
	    	for(int i=1; i<=ceic_insight.size(); i++) {
	    	String ceic_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link'])["+i+"]", 4).getText();
	    	notification_insight.add(ceic_text);
	    	}
	    	if(login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link']")).size()>0) {
	    	for(int i=1; i<=ceic_insight.size(); i++) {
	    	if(i!=1) {
	    	click("Notifications", "Recommendations");
	    	}
	    	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[text()='"+arg1+"']/following::*[@class='activity-block--content'][1]//*[@class='all-insights-list-item--name-link'])["+i+"]", 4)).pause(2000).click().build().perform();
	    	CommonFunctionality.wait(5000);
	    	List<WebElement> preview = login.driver.findElements(By.className("insight-preview--close"));
	    	assertEquals(preview.size(), 1);
	    	System.out.println("The insight is opened in preview mode");
	    	...
	    	CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'navigation-sidebar')]//*[contains(text(),'EMIS Insights')]", 4).click();
	    	WebElement grid = CommonFunctionality.getElementByXpath(login.driver, "//*[@title='View as a grid']/parent::div", 4);
	    	if(grid.getAttribute("class").contains("insights-view-modes__table-mode")) {
	    		CommonFunctionality.getElementByXpath(login.driver, "//*[@title='View as a grid']", 4).click();	
	    	}
	    	CommonFunctionality.getElementBycssSelector(login.driver, ".custom-select-title--handler.icon--filter-arrow", 4).click();
	    	WebElement recent = CommonFunctionality.getElementByXpath(login.driver, "//div[@title='Recently created']/parent::li", 4);
	    	...
	    	CommonFunctionality.getElementBycssSelector(login.driver, ".custom-select-title--handler.icon--filter-arrow .icon--filter-arrow", 4).click();
	    	}
	    	CommonFunctionality.wait(5000);
	    	for(int i=1; i<=10; i++) {
	    		String analytic_text = CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'insight-grid-item--bottom-panel-title')])["+i+"]", 4).getText();
	...
	public void click_on_Help_dropdown() throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "help-title", 4)).pause(500).click().build().perform();
	}
	...
	public void the_field_is_adding_the_text(String arg1) throws Throwable {
	   if(arg1.equalsIgnoreCase("Subject")) {
		  ...
		  cc.sendKeys("12345");
		  CommonFunctionality.getElementByXpath(login.driver, "//textarea[@name='message']", 4).sendKeys("For testing purpose, Please ignore!");
		  CommonFunctionality.getElementBycssSelector(login.driver, ".sphere-modal-control.button__primary", 4).click();
		  ...
		  CommonFunctionality.getElementByXpath(login.driver, "//input[@name='subject']", 4).sendKeys("Shravas");
		  CommonFunctionality.getElementByXpath(login.driver, "//textarea[@name='message']", 4).sendKeys("For testing purpose, Please ignore!");
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "dz-message", 4)).pause(500).click().build().perform();
		  ...
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "dz-message", 4)).pause(500).click().build().perform();
		  CommonFunctionality.uploadTheFileusingAutoIT(login.driver,System.getProperty("user.dir") + "\\AutoIT\\Shravas.exe", System.getProperty("user.dir") + "\\AutoIT\\Shravas.png");
		  new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "dz-remove", 4)).pause(500).click().build().perform();
		  CommonFunctionality.wait(2000);
		  WebElement remove = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='dz-message']/parent::div", 4);
	...
	public void verify_Diagnostics_configurations_options() throws Throwable {
		...
		String local_storage = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='LocalStorage/SessionStorage']/following-sibling::div", 4).getText();
		String local_storage_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='LocalStorage/SessionStorage']/following-sibling::div", 4).getCssValue("background-color");
		String websocket = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='WebSocket']/following-sibling::div", 4).getText();
		String websocket_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='WebSocket']/following-sibling::div", 4).getCssValue("background-color");
		String cookies = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Cookies']/following-sibling::div", 4).getText();
		String cookies_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Cookies']/following-sibling::div", 4).getCssValue("background-color");
		String authentication = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CEIC Authentication System']/following-sibling::span", 4).getText();
		String authentication_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CEIC Authentication System']/following-sibling::span", 4).getCssValue("background-color");
		String backend = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CDMNext Backend']/following-sibling::div", 4).getText();
		String backend_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CDMNext Backend']/following-sibling::div", 4).getCssValue("background-color");
		String notification = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CDMNext Notification']/following-sibling::div", 4).getText();
		String notification_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='CDMNext Notification']/following-sibling::div", 4).getCssValue("background-color");
		String solr = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'CDMNext Search Insights Service')]/following-sibling::div", 4).getText();
		String solr_color = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'CDMNext Search Insights Service')]/following-sibling::div", 4).getCssValue("background-color");
		String java = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'CDMNext Search Series Service')]/following-sibling::div", 4).getText();
		String java_color = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'CDMNext Search Series Service')]/following-sibling::div", 4).getCssValue("background-color");
		String mongoDB = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Content document']/following-sibling::span", 4).getText();
		String mongoDB_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Content document']/following-sibling::span", 4).getCssValue("background-color");
		String amazon_s3 = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Objects resources']/following-sibling::span", 4).getText();
		String amazon_s3_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Objects resources']/following-sibling::span", 4).getCssValue("background-color");
		String knowledge = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Knowledge Base']/following-sibling::span", 4).getText();
		String knowledge_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Knowledge Base']/following-sibling::span", 4).getCssValue("background-color");
		String fd = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Freshchat']/following-sibling::span", 4).getText();
		String fd_color = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='Freshchat']/following-sibling::span", 4).getCssValue("background-color");
		assertEquals(local_storage, configStatus); assertEquals(Color.fromString(local_storage_color).asHex(), configcolor);
		assertEquals(websocket, configStatus); assertEquals(Color.fromString(websocket_color).asHex(), configcolor);
		assertEquals(cookies, configStatus); assertEquals(Color.fromString(cookies_color).asHex(), configcolor);
		assertEquals(authentication, configStatus); assertEquals(Color.fromString(authentication_color).asHex(), configcolor);
		assertEquals(backend, configStatus); assertEquals(Color.fromString(backend_color).asHex(), configcolor);
		assertEquals(notification, configStatus); assertEquals(Color.fromString(notification_color).asHex(), configcolor);
		assertEquals(solr, configStatus); assertEquals(Color.fromString(solr_color).asHex(), configcolor);
		assertEquals(java, configStatus); assertEquals(Color.fromString(java_color).asHex(), configcolor);
		assertEquals(mongoDB, configStatus); assertEquals(Color.fromString(mongoDB_color).asHex(), configcolor);
		assertEquals(amazon_s3, configStatus); assertEquals(Color.fromString(amazon_s3_color).asHex(), configcolor);
		assertEquals(knowledge, configStatus); assertEquals(Color.fromString(knowledge_color).asHex(), configcolor);
		assertEquals(fd, configStatus); assertEquals(Color.fromString(fd_color).asHex(), configcolor);
	...
	public void verify_Send_button_on_Report_a_problem_window()	throws Throwable {
		...
		js.executeScript("arguments[0].scrollIntoView();", element);
		element.click();
		CommonFunctionality.getElementByProperty(login.driver, "Ig_desc", 4).sendKeys("For Testing purpose, please ignore!");
	...
	public void verify_Attachments_on_Report_a_problem() throws Throwable {
		...
		js.executeScript("arguments[0].scrollIntoView();", element);
		element.click();
		CommonFunctionality.getElementByXpath(login.driver, "//textarea[@class='report-problem-s--message']", 4).sendKeys("For testing purpose, please ignore!");
	...
	public void verify_description_and_attach_screenshot() throws Throwable {
		...
		CommonFunctionality.getElementByXpath(login.driver, "//textarea[@class='report-problem-s--message']", 4).sendKeys("For testing purpose, please ignore!");
		String bgcolor = CommonFunctionality.getElementByXpath(login.driver, "//textarea[@class='report-problem-s--message']", 4).getCssValue("border");
	...
	String text = CommonFunctionality.getElementByXpath(login.driver, "//*[@class='installation__header']/span", 4).getText();
	String split[] = text.split("Version ");
	System.out.println("The WPS addin version is: "+split[1]);
	String url = CommonFunctionality.getElementBycssSelector(login.driver, ".installation-download-button__button", 4).getAttribute("href");
	...
	String version = CommonFunctionality.getElementByClassName(login.driver, "installation-download-description__text", 4).getText();
	String path = System.getProperty("user.dir")+"\\Downloads\\"+version;
	Files.deleteIfExists(Paths.get(path));
	String split2[] = version.split("\\(");
	String split3[] = split2[1].split("\\)");
	CommonFunctionality.wait(3000);
	CommonFunctionality.getElementBycssSelector(login.driver, ".installation-documentation--document-link", 4).click();
	ArrayList<String> tabs = new ArrayList<String>(login.driver.getWindowHandles());
	assertEquals(tabs.size(), 2);
	login.driver.switchTo().window(tabs.get(1));
	...
	login.driver.switchTo().window(tabs.get(1)).close();
	login.driver.switchTo().window(tabs.get(0));
	String description1 = "The CDMNext Add-in for WPS mainly provides the option for CEIC users to refresh data with links downloaded from CDMNext application.";
	...
	String expected = CommonFunctionality.getElementByXpath(login.driver, "//div[@class='installation__block'][1]", 4).getText();
	...
	public void verify_Send_Report() throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='growl-messages-container']")));
...
public void verify_Excel_add_in_version_in_popup() throws Throwable {
    String actual="Download CDMNext Add-in for Microsoft Excel® Version";
    String Expected_Excel_addin_ver=CommonFunctionality.getElementByProperty(login.driver, "Ig_excel_addin_ver", 4).getText();
...
public void verify_OS_and_MS_Office_selection_on_popup() throws Throwable {
	...
	new Actions(login.driver).moveToElement(CommonFunctionality.getElementByProperty(login.driver, "Ig_64bit", 4)).pause(500).build().perform();
	...
	String Ex_MS_office_version= CommonFunctionality.getElementByProperty(login.driver, "Ig_Ms_Office_ver", 4).getText();
	CommonFunctionality.getElementByProperty(login.driver, "MYINSIGHTS_CLOSE", 4).click();
...
public void verify_Download_CDMNext_add_in_navigate_to_new_tab() throws Throwable {
	...
	String Ex_URL= CommonFunctionality.getElementBycssSelector(login.driver, ".installation-download-button__button", 4).getAttribute("href");
...
public void click_on_Python_SDK_and_Verify_API_SDK_download() throws Throwable {
	String file = CommonFunctionality.getElementByClassName(login.driver, "installation-download-description__text", 4).getText();
...
public void verify_API_SDK_download_through_URL() throws Throwable {
   ...
   //String copiedText=  login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Ig_text"))).getText();
...
public void verify_documents_opening_in_new_tab() throws Throwable {
	List<WebElement> documents = CommonFunctionality.getElementsByXpath(login.driver, "//div[@class='installation-documentation--document']");
	for(int i=1; i<=documents.size(); i++) {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//*[contains(@class,'installation-documentation--document-link')])["+i+"]", 4)).click().build().perform();
		ArrayList<String> tabs = new ArrayList<String>(login.driver.getWindowHandles());
		assertEquals(tabs.size(), 2);
		login.driver.switchTo().window(tabs.get(1));
...
String downloadPath = System.getProperty("user.home")
    ...
    List<WebElement> help = login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following-sibling::*[@class='help-popup--items']//*[contains(text(),'"+arg2+"')]"));
    assertEquals(help.size(), 1);
    String text = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg1+"']/following-sibling::*[@class='help-popup--items']//*[contains(text(),'"+arg2+"')]", 4).getText();
    ...
    List<WebElement> help = login.driver.findElements(By.xpath("//*[text()='"+arg1+"']/following::*[text()='"+arg2+"']"));
    assertEquals(help.size(), 1);
    String text = CommonFunctionality.getElementByXpath(login.driver, "//*[text()='"+arg1+"']/following::*[text()='"+arg2+"']", 4).getText();
    assertEquals(text, arg2);
    System.out.println("The text present for "+arg1+" is "+arg2);
    }
    ...
    public void click_on(String arg1, String arg2) throws Throwable {
      ...
      new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "help-popup--live-chat-toggle", 4)).pause(500).click().build().perform();  
      } else {
      new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "//div[contains(@class,'help-popup--item') and contains(text(),'"+arg2+"')]", 4)).pause(500).click().build().perform();
      }
    }
    ...
    CommonFunctionality.wait(2000);
    List<WebElement> videos = CommonFunctionality.getElementsByXpath(login.driver, "//div[@class='learn-tutorials-item--title']/span");
    for(int i=1; i<=videos.size();i++) {
    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='learn-tutorials-item--title'])["+i+"]/span", 4)).pause(500).click().build().perform();
    WebElement play = CommonFunctionality.getElementByXpath(login.driver, "//*[contains(@class,'learn-tutorials-item learn-tutorials-item__selected')]", 4);
    if(i==1) {
    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver, "(//div[@class='learn-tutorials-item--title'])["+i+"]/span", 4)).pause(500).click().build().perform();
    ...
    new Actions(login.driver).moveToElement(CommonFunctionality.getElementByClassName(login.driver, "vjs-control-bar", 4)).pause(500).perform();
	...
	for(int i=1; i<=11; i++) {
	boolean previous = login.driver.findElement(By.xpath("//button[contains(text(),'Previous')]")).isEnabled();
	...
	if(previous == true) {
     ...
     List<WebElement> previous_button = login.driver.findElements(By.xpath("//div[text()='How do I search?']"));
     assertEquals(previous_button.size(), 1);
     System.out.println("The previous button is clickable and navigating to previous tour of count "+i);
     login.driver.findElement(By.xpath("//button[contains(text(),'Next')]")).click();
	} else {
		fail("Not enabled");
	}
    ...
    public void the_keyword_search_tips_window_should_open() throws Throwable {
      List<WebElement> search = CommonFunctionality.getElementsByXpath(login.driver, "//*[contains(@class,'sphere-modal__title') and text()='Keyword search tips']");
    ...
    public void the_keyboard_shortcuts_window_should_open() throws Throwable {
      List<WebElement> search = CommonFunctionality.getElementsByXpath(login.driver, "//*[contains(@class,'sphere-modal__title') and text()='Keyboard Shortcuts']");
      assertEquals(search.size(), 1);
      CommonFunctionality.getElementByClassName(login.driver, "sphere-modal__close", 4).click();
    ...
    public void the_Footnotes_window_should_open() throws Throwable {
      List<WebElement> footnotes = CommonFunctionality.getElementsByXpath(login.driver, "//*[contains(@class,'footnotes-modal--name') and contains(text(),'Footnotes')]");
    ...
    WebElement chat = CommonFunctionality.getElementByXpath(login.driver, "//div[contains(@class,'bootstrap-switch-animate')]", 4);
    if(arg1.equalsIgnoreCase("ON")) {
...
public void verify_refresh_behavior() throws Throwable {
	...
	if(undo.getAttribute("class").contains("button__disabled") && redo.getAttribute("class").contains("button__disabled")) {
...
public void verify_Redo_option_behavior_for_my_series_tab() throws Throwable {
	String redo = CommonFunctionality.getElementByClassName(login.driver, "series-name-field--series-name", 4).getText();
