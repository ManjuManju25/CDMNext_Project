...
public class Landingpage {
	...
	public void successfully_Verify_the_Tabs_present_in_Landing_page() throws Throwable {
		...
		element = login.driver.findElement(
				By.xpath("/html/body/div[1]/div/div[1]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[14]/div[1]"));
		jse.executeScript("arguments[0].scrollIntoView(true);", element);

		login.driver
				.findElement(By.xpath(
						"/html/body/div[1]/div/div[1]/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[14]/div[1]"))
				.click();
		Thread.sleep(500);
	...
	public void successfully_verify_the_What_s_New_option_under_Product() throws Throwable {
		...
		Thread.sleep(8000);
		WebElement Whats_new_Announcement = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Whats_new_Announcement")));
		login.Log4j
				.info("Is 'Whats_new_Announcement' Displayed? - True/False:: " + Whats_new_Announcement.isDisplayed());
	...
	public void select_the_What_s_New_and_Take_the_servey_option() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='header-menu-products--footer-link']/div")).click();
		Thread.sleep(12000);
		login.driver.findElement(By.xpath("//a[@class='announcements-container--button button button__primary']"))
				.click();
	}
	...
	public void successfully_verify_the_Take_the_servey_option_under_what_s_new() throws Throwable {
		...
		WebElement Whats_new_Ceic_Survey = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Whats_new_Ceic_Survey")));
	...
	public void successfully_Verify_World_Trend_Plus_databases_like_under_Product(String arg1, String arg2)
			throws Throwable {
		Thread.sleep(1500);
		...
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			Thread.sleep(4500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_Database_Explore_data")))
					.click();
			Thread.sleep(4500);
			ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
			login.driver.switchTo().window(tabs2.get(1));
			Thread.sleep(4500);
			WebElement World_Treand_Database_WorldTreand_in_Newinsight = login.driver.findElement(
					By.xpath(login.LOCATORS.getProperty("World_Treand_Database_WorldTreand_in_Newinsight")));
	...
	public void successfully_Verify_China_Premium_databases_like_under_Product(String arg1, String arg2, String arg3)
			throws Throwable {
		Thread.sleep(1500);
		String Y = login.driver.findElement(By.xpath(
				"//*[@id='landing_page']/div[1]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[2]/div[2]/div[3]/div[1]/div[1]"))
				.getText();
		System.out.println(Y);
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			Thread.sleep(4500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_Explore_data")))
					.click();
		...
		if (arg3.equalsIgnoreCase(arg3)) {
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//span[contains(text(),'Products')]")).click();
			WebElement China_PremiumDatabase_Watch_vedio = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_Watch_vedio")));
			login.Log4j.info("Is 'China_PremiumDatabase_Watch_vedio' Displayed? - True/False:: "
					+ China_PremiumDatabase_Watch_vedio.isDisplayed());
	...
	public void successfully_Verify_Brazil_Premium_databases_like_under_Product(String arg1, String arg2, String arg3)
			throws Throwable {

		Thread.sleep(1500);
		String Y = login.driver
				.findElement(By.xpath("//div[@class='header-menu-products--premium-body']/div/div[2]/div[1]"))
				.getText();
		System.out.println(Y);
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			login.Log4j.info("Is 'Brazil_PremiumDatabase_Explore_data_Explore_data' Displayed? - True/False:: "
					+ Brazil_PremiumDatabase_Explore_data.isDisplayed());
			Assert.assertEquals(true, Brazil_PremiumDatabase_Explore_data.isDisplayed());
			Thread.sleep(4500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_Explore_data")))
					.click();
			Thread.sleep(4500);
			ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
			login.driver.switchTo().window(tabs2.get(1));
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			login.Log4j.info("Is 'Brazil_PremiumDatabase_Footnotes' Displayed? - True/False:: "
	...
	public void successfully_Verify_India_Premium_databases_like_under_Product(String arg1, String arg2, String arg3)
			throws Throwable {
		Thread.sleep(1500);
		String Y = login.driver
				.findElement(By.xpath("//div[@class='header-menu-products--premium-body']/div/div[3]/div[1]"))
				.getText();
		System.out.println(Y);
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			Thread.sleep(4500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_Explore_data")))
					.click();
			Thread.sleep(4500);
			ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
			login.driver.switchTo().window(tabs2.get(1));
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			login.Log4j.info("Is 'India_PremiumDatabase_Footnotes' Displayed? - True/False:: "
					+ India_PremiumDatabase_Footnotes.isDisplayed());
	...
	public void successfully_Verify_Russia_Premium_databases_like_under_Product(String arg1, String arg2, String arg3)
			throws Throwable {

		Thread.sleep(1500);
		String Y = login.driver
				.findElement(By.xpath("//div[@class='header-menu-products--premium-body']/div/div[4]/div[1]"))
				.getText();
		System.out.println(Y);
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			Thread.sleep(4500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_Explore_data")))
					.click();
			Thread.sleep(4500);
			ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
			login.driver.switchTo().window(tabs2.get(1));
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			login.Log4j.info("Is 'Russia_PremiumDatabase_Footnotes' Displayed? - True/False:: "
	...
	public void successfully_Verify_Indonesia_Premium_databases_like_under_Product(String arg1, String arg2,
			String arg3) throws Throwable {

		Thread.sleep(1500);
		String Y = login.driver
				.findElement(By.xpath("//div[@class='header-menu-products--premium-body']/div/div[5]/div[1]"))
				.getText();
		System.out.println(Y);
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			login.Log4j.info("Is 'Indonesia_PremiumDatabase_Explore_data? - True/False:: "
			...
			login.driver.switchTo().window(tabs2.get(1));
			Thread.sleep(4500);
			WebElement Indonesia_PremiumDatabase_indonesia_in_Newinsight = login.driver.findElement(
					By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_indonesia_in_Newinsight")));
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			login.Log4j.info("Is 'Indonesia_PremiumDatabase_Footnotes' Displayed? - True/False:: "
					+ Indonesia_PremiumDatabase_Footnotes.isDisplayed());
			Assert.assertEquals(true, Indonesia_PremiumDatabase_Footnotes.isDisplayed());
			Thread.sleep(3500);
			login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_Footnotes")))
					.click();
			Thread.sleep(3500);
			String X = login.driver
	...
	/*
	 * @Given("^Successfully verify the Help option$") public void
	 * successfully_verify_the_Help_option() throws Throwable {
	 * 
	 * //List<WebElement> objLinks = login.driver.findElements(By.xpath(
	 * "//div[@class='header-menu-help--container']"));
	 * //System.out.println("Total Insights are : "+objLinks.size()); //for(int
	 * i=0;i<=objLinks.size();i++)
	 * //System.out.println("Total Insights are : "+objLinks.get(i).getText());
	 * 
	 * String[] expected = {"Contact Us", "Email Us", "Knowledge Base",
	 * "Diagnostics", "Report a problem", "Live Chat",
	 * "Video Tutorials","Tours","Quick Start Guide","Search Help"
	 * ,"Keyboard Shortcuts","Excel Add-in","API","R","EViews"};
	 * System.out.println("Total ecpected length : "+expected.length);
	 * List<WebElement> allOptions =
	 * login.driver.findElements(By.xpath("//div[@class='header-menu-help--btn']"));
	...
	public void successfully_Verify_profile_dropdown_as(String arg1, String arg2, String arg3, String arg4, String arg5,
		...
		/*
		 * if(arg2.equalsIgnoreCase(arg2)){ Thread.sleep(2500);
		 * select_the_profile_dropdown(); Thread.sleep(2500); String[] expected = {"中文",
		 * "日本語", "한국어", "Русский", "Bahasa"}; List<WebElement> allOptions =
		 * login.driver.findElements(By.xpath("//div[@class='languages-item -action']"))
		 * ;
		 * 
		 * // make sure you found the right number of elements if (expected.length !=
		 * allOptions.size()) {
		 ...
		 * allOptions.get(i).getAttribute("value"); if (optionValue.equals(expected[i]))
		 * { System.out.println("passed on: " + optionValue); } else {
		 * System.out.println("failed on: " + optionValue); } } //languages-item -action
		 * }
		 */
		if (arg3.equalsIgnoreCase(arg3)) {
			Thread.sleep(2500);
			...
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//div[@class='account-menu--dropdown dropdown--body']/div/div[2]"))
					.click();
			Thread.sleep(2500);
		...
		if (arg6.equalsIgnoreCase(arg6)) {
			...
			login.driver.findElement(By.xpath("//div[@class='account-menu--dropdown dropdown--body']/div/div[5]"))
					.click();
			Thread.sleep(2500);
			if (login.driver.findElements(By.xpath("//div[@class='user-profile-account']/div/div[4]/div[1]/div"))
					.size() != 0) {
				Thread.sleep(2500);
	...
	public void successfully_Verify_CopyLink_insight_option_is_working() throws Throwable {
		...
		String Copylinkinsightname = login.driver
				.findElement(By.xpath("//div[@class='page-main-header--title-field-text']")).getText();
