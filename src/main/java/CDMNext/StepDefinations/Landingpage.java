...
public class Landingpage {
	...
	/*
	 * @Given("^User2 has successful logged in$") public void
	 * user2_has_successful_logged_in() throws Throwable {
	 * 
	 * if (login.logged_in = false) { login.Invoke_browser();
	 * login.application_login(); } else if (login.logged_in = true &&
	 * !Landingpage.logged) { login.application_login(); Landingpage.logged = true;
	 * } else { System.out.println("Already Loggedin...Continue....!!!!");
	 * //Thread.sleep(5000); //login.driver.navigate().refresh(); }
	 * 
	...
	public void successfully_Verify_the_Tabs_present_in_Landing_page() throws Throwable {
		...
		if (login.driver.findElements(By.xpath("//div[@title='Insights that you have created']")).size() != 0) {
			WebElement Favorite_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Favorite_Tab_inLandingPage")));
			Assert.assertEquals(true, Favorite_Tab_inLandingPage.isDisplayed());
			Thread.sleep(500);
			WebElement MyInsight_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("MyInsight_Tab_inLandingPage")));
			Assert.assertEquals(true, MyInsight_Tab_inLandingPage.isDisplayed());
			Thread.sleep(500);
			WebElement Analytics_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Analytics_Tab_inLandingPage")));
			Assert.assertEquals(true, Analytics_Tab_inLandingPage.isDisplayed());
			Thread.sleep(500);
			WebElement SharedInsight_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("SharedInsight_Tab_inLandingPage")));
			Assert.assertEquals(true, SharedInsight_Tab_inLandingPage.isDisplayed());
			Thread.sleep(500);
			WebElement Recent_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Recent_Tab_inLandingPage")));
			Assert.assertEquals(true, Recent_Tab_inLandingPage.isDisplayed());
			Thread.sleep(500);
			WebElement All_Tab_inLandingPage = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("All_Tab_inLandingPage")));
	...
	public void verify_the_New_insight_under_My_insights_tab() throws Throwable {
		String Text1 = login.driver
				.findElement(By.xpath("//div[@class='page-main-header--title-field-text text-dots']")).getText();
		Thread.sleep(2000);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("CEIC_Logo"))).click();
		Thread.sleep(2000);
		login.driver.findElement(By.xpath("//div[@title='View as a table']")).click();
		Thread.sleep(2000);
		String Text2 = login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"))
				.getText();
		Thread.sleep(2000);
	...
	public void verify_the_insights_under_Shared_with_me_tab() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='user-avatar -default -small']")).click();
		Thread.sleep(2500);
		String Text2 = login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[4]/div[1]"))
				.getText();
		System.out.println(Text1 + ":" + Text2);
	...
	public void verify_the_New_insight_under_All_tab_as(String arg1) throws Throwable {
		...
		Thread.sleep(5500);
		String AllInsight = login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"))
				.getText();
	...
	public void get_insight_name_and_add_any_five_series_to_my_series_tab() throws Throwable {
		...
		Thread.sleep(8500);
		login.driver.findElement(By.xpath("//div[@class='page-main-header--title-field']/input"))
				.sendKeys("Insightmouseover");
		...
		Thread.sleep(2000);
		Insightmouseovername = login.driver
				.findElement(By.xpath("//div[@class='page-main-header--title-field-text text-dots']")).getText();
		Seriesadded = login.driver.findElement(By.xpath("//span[@class='series-panel--count']/span[1]/span[1]"))
				.getText();
		Thread.sleep(500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("CEIC_Logo"))).click();
	}
	...
	public void mouse_over_on_inisight_title_in_Table_mode() throws Throwable {
		...
		WebElement InsightmouseoverinIEpage = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"));
	...
	public void select_the_option_search_by_name() throws Throwable {
		...
		login.driver
				.findElement(
						By.xpath("//div[@class='insights-search-attributes dropdown dropdown__right']/div[1]/span/div"))
				.click();
		Thread.sleep(1000);
		login.driver
				.findElement(
						By.xpath("//div[@class='dropdown--body insights-search-attributes--content']/label[2]/span[1]"))
				.click();
	}
	...
	public void verify_the_search_with_tag_name_as(String arg1) throws Throwable {
		Thread.sleep(5500);
		Actions action = new Actions(login.driver);
		WebElement AddTag = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"));
		...
		Thread.sleep(2500);
		login.driver.findElement(By.xpath("//button[@class='insights-search-filter--reset-icon icon--red-cross']"))
				.click();
	}
	...
	public void add_tags_for_insight() throws Throwable {
		...
		Thread.sleep(2000);
		login.driver.findElement(By.xpath("//input[@class='ui-widget-content ui-autocomplete-input']"))
				.sendKeys("AddedTag");
		Thread.sleep(2000);
	...
	public void added_tags_should_be_available_in_dropdown_and_should_display_related_insights() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='sphere-modal-controls']/button[2]")).click();
		Thread.sleep(4500);
		login.driver.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/div/span"))
				.click();
	}
	...
	public void verify_that_tag_should_be_applied_for_all_other_tab() throws Throwable {
		...
		String AddedTagTextinMyInsight = login.driver
				.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/span/span[1]"))
				.getText();
		...
		String AddedTagTextinAnalytics = login.driver
				.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/span/span[1]"))
				.getText();
		...
		String AddedTagTextinShared = login.driver
				.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/span/span[1]"))
				.getText();
		...
		String AddedTagTextinRecent = login.driver
				.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/span/span[1]"))
				.getText();
		...
		String AddedTagTextinAll = login.driver
				.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/span/span[1]"))
				.getText();
		...
		if (AddedTagText.equalsIgnoreCase(AddedTagTextinAll)) {
			...
			Thread.sleep(4500);
			login.driver
					.findElement(By.xpath("//div[@class='landing-content--filters-panel']/div[2]/div/div/div/div/span"))
					.click();
		} else {
	...
	public void alert_dropdown_should_have_See_all_notification_option() throws Throwable {
		Thread.sleep(2500);
		WebElement See_All_notification = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("See_All_notification")));
	...
	public void successfully_redirect_to_Notification_page() throws Throwable {
		Thread.sleep(2500);
		WebElement Notification_Page = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Notification_Page")));
	...
	public void successfully_Verify_Remove_icon_for_filters() throws Throwable {
		Thread.sleep(6500);
		WebElement Remove_icon_for_filters = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Remove_icon_for_filters")));
		login.Log4j.info(
				"Is 'Remove_icon_for_filters' Displayed? - True/False:: " + Remove_icon_for_filters.isDisplayed());
	...
	public void successfully_Verify_View_as_a_grid_option() throws Throwable {
		...
		WebElement we = login.driver
				.findElement(By.xpath("//*[@id='landing_page']/div[2]/div[2]/div/div[3]/div[2]/div[1]/div/div[2]"));
	...
	public void successfully_Verify_View_as_a_table_option() throws Throwable {
		...
		Thread.sleep(1500);
		WebElement Table_open_with_new_tab = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Table_open_with_new_tab")));
		login.Log4j.info(
				"Is 'Table_open_with_new_tab' Displayed? - True/False:: " + Table_open_with_new_tab.isDisplayed());
		...
		Thread.sleep(1500);
		WebElement Table_createfolder = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Table_createfolder")));
	...
	public void successfully_Verify_Categories_dropdown() throws Throwable {
		...
		Thread.sleep(1500);
		WebElement Thematic_Analysis = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Thematic_Analysis")));
		...
		Thread.sleep(1500);
		WebElement Emerging_markets = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Emerging_markets")));
	...
	public void select_the_Hot_topics_option() throws Throwable {
		...
		Thread.sleep(4500);
		Actions action = new Actions(login.driver);
		WebElement RightclickonInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"));
		...
		login.driver.findElement(By.xpath("//div[@class='insight-settings-general']/div[4]/div/div/a/span[2]/b"))
				.click();
		Thread.sleep(4500);
	...
	public void successfully_Verify_Product_Dropdown() throws Throwable {
		...
		Thread.sleep(1500);
		WebElement Product_Global_Database = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Product_Global_Database")));
		login.Log4j.info(
				"Is 'Product_Global_Database' Displayed? - True/False:: " + Product_Global_Database.isDisplayed());
		Assert.assertEquals(true, Product_Global_Database.isDisplayed());
		Thread.sleep(1500);
		WebElement Product_World_trend_plus = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Product_World_trend_plus")));
		login.Log4j.info(
				"Is 'Product_World_trend_plus' Displayed? - True/False:: " + Product_World_trend_plus.isDisplayed());
		Assert.assertEquals(true, Product_World_trend_plus.isDisplayed());
		Thread.sleep(1500);
		WebElement Product_premium_Databases = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Product_premium_Databases")));
		login.Log4j.info(
				"Is 'Product_premium_Databases' Displayed? - True/False:: " + Product_premium_Databases.isDisplayed());
	...
	public void successfully_Verify_All_databases_like_under_Product(String arg1, String arg2, String arg3)
			throws Throwable {
		...
		if (arg1.equalsIgnoreCase(arg1)) {
			WebElement Global_Database_Explore_data = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_Explore_data")));
			login.Log4j.info("Is 'Global_Database_Explore_data' Displayed? - True/False:: "
					+ Global_Database_Explore_data.isDisplayed());
			...
			Thread.sleep(4500);
			WebElement Global_Database_global_in_Newinsight = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_global_in_Newinsight")));
			login.Log4j.info("Is 'Global_Database_global_in_Newinsight' Displayed? - True/False:: "
					+ Global_Database_global_in_Newinsight.isDisplayed());
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			Thread.sleep(3500);
			WebElement Global_Database_Footnotes = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_Footnotes")));
			login.Log4j.info("Is 'Global_Database_Footnotes' Displayed? - True/False:: "
					+ Global_Database_Footnotes.isDisplayed());
			...
			Thread.sleep(2500);
			String X = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_inside_footnotes"))).getText();
			System.out.println(X);
			Thread.sleep(4500);
			WebElement Global_Database_inside_footnotes = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_inside_footnotes")));
			login.Log4j.info("Is 'Global_Database_inside_footnotes' Displayed? - True/False:: "
					+ Global_Database_inside_footnotes.isDisplayed());
		...
		if (arg3.equalsIgnoreCase(arg3)) {
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//span[contains(text(),'Products')]")).click();
			WebElement Global_Database_Watch_vedio = login.driver
					.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_Watch_vedio")));
			login.Log4j.info("Is 'Global_Database_Watch_vedio' Displayed? - True/False:: "
					+ Global_Database_Watch_vedio.isDisplayed());
			...
			WebElement Element = login.driver
					.findElement(By.xpath("/html/body/div[1]/div/div[4]/div[2]/div/div[2]/div[1]/iframe"));
	...
	/*
	 * @And("^Select the What's New and Take the servey option$") public void
	 * select_the_What_s_New_and_Take_the_servey_option() throws Throwable {
	 * Thread.sleep(5000); login.driver.findElement(By.xpath(
	 * "//div[@class='header-menu-products--footer-link']/div")).click();
	 * Thread.sleep(12000); login.driver.findElement(By.
	 * xpath("//a[@class='announcements-container--button button button__primary']")
	 * ).click(); }
	 * 
	 * @And("^Successfully verify the Take the servey option under what's new$")
	 * public void successfully_verify_the_Take_the_servey_option_under_what_s_new()
	 * throws Throwable { Thread.sleep(5000); ArrayList<String> tabs2 = new
	 * ArrayList<String> (login.driver.getWindowHandles());
	 * login.driver.switchTo().window(tabs2.get(1)); String URL =
	 * login.driver.getCurrentUrl(); System.out.println(URL);
	 * Assert.assertEquals(URL, "http://m.mail1.euromoneyplc.net/webApp/CDMNext" );
	 * WebElement Whats_new_Ceic_Survey =
	 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty(
	 * "Whats_new_Ceic_Survey")));
	 * login.Log4j.info("Is 'Whats_new_Ceic_Survey' Displayed? - True/False:: " +
	 * Whats_new_Ceic_Survey.isDisplayed());
	 * Assert.assertEquals(true,Whats_new_Ceic_Survey.isDisplayed());
	 * login.driver.close(); login.driver.switchTo().window(tabs2.get(0));
	 * Thread.sleep(8000);
	...
	public void successfully_verify_the_Help_option_as(String arg1, String arg2, String arg3, String arg4, String arg5,
			String arg6, String arg7, String arg8, String arg9, String arg10, String arg11, String arg12, String arg13,
			String arg14, String arg15) throws Throwable {
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			Thread.sleep(1500);
			if (login.driver.findElements(By.xpath("//h4[@class='modal-title sphere-modal__title text-dots']"))
					.size() != 0) {
	...
	public void successfully_verify_the_latest_data_option_under_what_s_new() throws Throwable {
		Thread.sleep(2500);
		login.driver
				.findElement(By.xpath("//a[@class='announcements-container--button button button__info button__sm ']"))
				.click();
		...
		Assert.assertEquals(URL,
				"https://stage.ceicdata.com/file?path=/custom_files/newsletters/e7d2dd41-172b-4505-90c8-880909647558");
		Thread.sleep(8000);
		// WebElement Whats_new_Ceic_Survey =
		// login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Whats_new_Ceic_Survey")));
		// login.Log4j.info("Is 'Whats_new_Ceic_Survey' Displayed? - True/False:: " +
		// Whats_new_Ceic_Survey.isDisplayed());
		// Assert.assertEquals(true,Whats_new_Ceic_Survey.isDisplayed());
		login.driver.close();
	...
	public void successfully_Verify_Product_Newsletters() throws Throwable {
		...
		List<WebElement> objLinks = login.driver
				.findElements(By.xpath("//a[@class='announcements-files--file-link link']"));
	...
	public void select_Footnotes_option() throws Throwable {
		...
		Thread.sleep(3500);
		login.driver.findElement(By.xpath("//div[@class='page-main-header--general-panel']/div[2]/div/div[3]/div/span"))
				.click();
	...
	public void successfully_Verify_Footnotes_dropdown() throws Throwable {
		...
		WebElement Footnotes_open_Newtab = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Footnotes_open_Newtab")));
	...
	public void successfully_Verify_Insight_title_change_as(String arg1) throws Throwable {
		...
		Thread.sleep(4500);
		login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/div[1]/input"))
		...
		Thread.sleep(4500);
		String ChangeInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_Verify_favorite_icon_behavior_for_insight(String arg1) throws Throwable {
		...
		Thread.sleep(4500);
		String FavouriteInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_Verify_favorite_icon_behavior() throws Throwable {
		...
		if (login.driver
				.findElements(
						By.xpath("//div[@class='insight-favorite insight-favorite__gray insight-favorite__active']"))
				.size() != 0) {
			Thread.sleep(2500);
		...
		if (login.driver.findElements(By.xpath("//div[@class='insights-grid-body']/div[1]/div[1]/div[1]/div"))
				.size() != 0) {
			Thread.sleep(2500);
	...
	public void successfully_Verify_insights_under_My_insights_tab_as(String arg1) throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@title='View as a table']")).click();
		Thread.sleep(5500);
		String MYInsight = login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"))
				.getText();
	...
	public void successfully_Verify_Insights_under_tab_as(String arg1) throws Throwable {
		...
		Thread.sleep(5500);
		String RecentInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void select_the_View_Comments_option() throws Throwable {
		...
		Thread.sleep(2500);
		login.driver
				.findElement(By.xpath("//div[@class='comments-menu dropdown dropdown__right dropdown__open']/div/a"))
				.click();
	...
	public void select_the_Notification_option() throws Throwable {
		...
		login.driver
				.findElement(
						By.xpath("//div[@class='notifications-menu dropdown dropdown__right dropdown__open']/div/a"))
				.click();
	...
	public void successfully_Verify_profile_dropdown_as(String arg1, String arg2, String arg3, String arg4, String arg5,
		...
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			String Emailnameindrop = login.driver.findElement(By.xpath("//span[@class='account-popup--header-email']"))
					.getText();
			...
			Thread.sleep(2500);
			String Unameinprofile = login.driver
					.findElement(By.xpath("//div[@class='profile-box']/div/div[2]/div[2]/input")).getAttribute("value");
			...
			Thread.sleep(5500);
			String Emailinprofile = login.driver
					.findElement(By.xpath("//div[@class='profile-box']/div/div[4]/div[2]/input")).getAttribute("value");
		...
		if (arg3.equalsIgnoreCase(arg3)) {
			...
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//div[@class='account-menu--dropdown dropdown--body']/div/div[3]"))
					.click();
			Thread.sleep(2500);
			if (login.driver.findElements(By.xpath("//div[@class='user-profile-account']/div/div[1]/div[1]/div"))
					.size() != 0) {
				Thread.sleep(2500);
		...
		if (arg4.equalsIgnoreCase(arg4)) {
			...
			select_the_profile_dropdown();
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//div[@class='account-menu--dropdown dropdown--body']/div/div[4]"))
					.click();
			Thread.sleep(2500);
			if (login.driver.findElements(By.xpath("//div[@class='user-profile-account']/div/div[2]/div[1]/div"))
					.size() != 0) {
				Thread.sleep(2500);
		...
		if (arg5.equalsIgnoreCase(arg5)) {
			...
			select_the_profile_dropdown();
			Thread.sleep(2500);
			login.driver.findElement(By.xpath("//div[@class='account-menu--dropdown dropdown--body']/div/div[5]"))
					.click();
			Thread.sleep(2500);
			if (login.driver.findElements(By.xpath("//div[@class='user-profile-account']/div/div[3]/div[1]/div"))
					.size() != 0) {
				Thread.sleep(2500);
		...
		if (arg7.equalsIgnoreCase(arg7)) {
			...
			if (login.driver.findElements(By.xpath("//div[@class='account-popup--shortcuts-title']")).size() != 0) {
				Thread.sleep(2500);
				login.driver.findElement(By.xpath("//div[@class='account-popup--shortcuts-wrapper']/div[2]/span[2]"))
						.click();
				Thread.sleep(2500);
	...
	public void successfully_Verify_Back_button_is_working() throws Throwable {
		...
		String TEXT1 = login.driver.findElement(By.xpath("//div[@class='profile-box']/div/div[2]/div[2]/input"))
				.getText();
		...
		String TEXT2 = login.driver.findElement(By.xpath("//div[@class='profile-box']/div/div[2]/div[2]/input"))
				.getText();
		System.out.println(TEXT1 + ":" + TEXT2);
		if (TEXT1.equalsIgnoreCase(TEXT2)) {
	...
	public void successfully_Verify_Folders_having_Insights() throws Throwable {
		Thread.sleep(5500);
		String InsightCount = login.driver
				.findElement(By.xpath("//div[@title='Insights that you have created']/span[4]/span")).getText();
		System.out.println(InsightCount);
		String myString = InsightCount;
		int Result = Integer.parseInt(myString);

		List<WebElement> objLinks = login.driver
				.findElements(By.xpath("//a[@class='link insights-grid-row--title-link']"));
	...
	public void successfully_Verify_New_Folders_is_created_As(String arg1) throws Throwable {
		Thread.sleep(3500);
		login.driver.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']/div[1]/input"))
				.sendKeys(Keys.chord(Keys.CONTROL, "a"));
		Thread.sleep(3500);
		...
		Thread.sleep(3500);
		String Foldername = login.driver
				.findElement(By.xpath("//div[@class='insights-tree-node insights-tree-node--selected']/div[2]"))
				.getText();
	...
	public void successfully_Verify_Empty_folder() throws Throwable {
		Thread.sleep(2500);
		if (login.driver.findElements(By.xpath("//div[contains(text(),'Insights created or owned by you')]"))
				.size() != 0) {
			...
			// login.driver.findElement(By.xpath("//div[@class='insights-tree-node-name
			// text-dots']")).click();

			Thread.sleep(3500);
			String Insightcreated = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void select_Right_click_options_on_folder() throws Throwable {
		Thread.sleep(3500);
		Actions action = new Actions(login.driver);
		WebElement Rightcliclfolder = login.driver
				.findElement(By.xpath("//div[@class='insights-tree-node-name text-dots']"));
		action.contextClick(Rightcliclfolder).build().perform();
	}

	@Given("^Successfully Verify  Right click options as \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" on folder$")
	public void successfully_Verify_Right_click_options_as_on_folder(String arg1, String arg2, String arg3, String arg4,
	...
	public void successfully_Verify_Rename_folder_name_as(String arg1) throws Throwable {
		Thread.sleep(6500);
		// String Y =
		// login.driver.findElement(By.xpath("//div[@class='insights-tree-node-name']")).getText();
	...
	public void successfully_Verify_New_Folders_is_created_under_Existing_Folder_As(String arg1) throws Throwable {
		...
		Thread.sleep(3500);
		String Y = login.driver.findElement(By.xpath(" //*[@id='landing_page']/div[2]/div[2]/div/div[1]/div[4]/div[2]"))
				.getText();
		System.out.println(Y + ":" + arg1);
		if (Y.equalsIgnoreCase(arg1)) {
	...
	public void successfully_Verify_Add_tags_option_is_working() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='sphere-modal-controls']/button[2]")).click();
		Thread.sleep(1500);
		login.driver.findElement(By.xpath("//div[@class='insights-search-left-panel']/div[2]/div/div/div/div/span"))
				.click();
	}
	...
	public void successfully_Verify_Delete_folder_option_is_working() throws Throwable {
		...
		Thread.sleep(15500);
		List<WebElement> objLinks2 = login.driver
				.findElements(By.xpath("//div[@class='insights-tree-node-name text-dots']"));
	...
	public void successfully_Verify_Right_click_options_as(String arg1, String arg2, String arg3, String arg4,
	...
	public void successfully_Verify_Copy_insight_option_is_working() throws Throwable {
		...
		String IECopyInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_Verify_Delete_option_is_working_for_insight() throws Throwable {
		...
		String BeforeDelete = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		...
		Thread.sleep(5500);
		String AfterDelete = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		System.out.println(BeforeDelete + ":" + AfterDelete);
		if (BeforeDelete != AfterDelete) {
			System.out
					.println("Deleating Functionality is working Succesfully,Deleated Insight is  :- " + BeforeDelete);
		} else {
	...
	public void select_two_or_more_Insights() throws Throwable {
		...
		for (int i = 1; i <= n; i++)
			actions.keyDown(Keys.LEFT_CONTROL)
					...
					// .click(
					// login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[2]")))
					// .click(
					// login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[3]")))
					// .click(
					// login.driver.findElement(By.xpath("//div[@class='insights-grid-body']/div[4]")))
	...
	public void successfully_Verify_Add_Tag_count_in_the_pop_up_window() throws Throwable {
		...
		Thread.sleep(4000);
		WebElement element = login.driver
				.findElement(By.xpath("//h4[@class='modal-title sphere-modal__title text-dots']"));
	...
	public void successfully_Verify_Last_Opened_Insights() throws Throwable {
		...
		Thread.sleep(2500);
		String Last_Opened_Insights = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void insights_should_be_moved_to_existing_new_folder() throws Throwable {
		String Movefoldernamefirst = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		Actions action1 = new Actions(login.driver);
		...
		String MovefoldernameAfter = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void insights_should_be_moved_to_existing_folder() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='insights-breadcrumbs-icon']")).click();
		/*
		 * Thread.sleep(1500); select_Right_click_options_on_folder();
		 * Thread.sleep(1500);
		 * login.driver.findElement(By.xpath("//span[contains(text(),'Delete folder')]")
		 * ).click(); Thread.sleep(15500); login.driver.findElement(By.
		 * xpath("//button[contains(text(),'Delete forever')]")).click();
		 */
	}
	...
	public void select_the_Insigt_and_create_Folder() throws Throwable {
		...
		MoveCreatefoldernamefirst = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_Verify_Insights_moved_to_created_folder() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@title='View as a table']")).click();
		// Thread.sleep(5500);
		// login.driver.findElement(By.xpath("//div[@class='insights-tree-toggle-right
		// fa fa-angle-right']")).click();
		Thread.sleep(5500);
		login.driver.findElement(By.xpath("//div[@class='insights-list--wrapper splitter_panel']/div[1]/div[1]"))
				.click();
		Thread.sleep(5500);
		String MoveCreatefoldernameafter = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_Verify_Share_insight_count_is_working() throws Throwable {
		Thread.sleep(5500);
		String ShareInsightCount = login.driver
				.findElement(By.xpath("//h4[@class='modal-title sphere-modal__title text-dots']")).getText();
		String numbers;
	...
	public void successfully_Verify_share_option_is_working() throws Throwable {
		...
		// login.driver.findElements(By.xpath("//a[@class='link
		// insights-grid-row--title-link']"));
		// System.out.println(objLinks.size());
		// Thread.sleep(3500);
		// Actions action = new Actions(login.driver);
		// WebElement Rightcliclfolder =
		// login.driver.findElement(By.xpath("//div[@class='insights-tree ps-container
		// ps-theme-default left_panel ui-sortable insights-tree--opened']/div[5]"));
		// action.contextClick(Rightcliclfolder).build().perform();
		// System.out.println(InsightCount +":"+ objLinks.size());
		// Thread.sleep(3500);
		...
		// login.driver.findElement(By.xpath("//div[@class='insights-breadcrumbs']/div[1]")).click();
		// Thread.sleep(3500);
		// login.driver.findElement(By.xpath("//div[@class='insights-tree-toggle-left fa
		// fa-angle-left']")).click();
	}
	...
	public void select_Insights_Counts_for_each_tabs() throws Throwable {
		...
		Thread.sleep(4500);
		WebElement element = login.driver
				.findElement(By.xpath("//div[@title='Insights that you have created']/span[3]/span"));
		...
		WebElement element2 = login.driver
				.findElement(By.xpath("//div[@title='Insights that other users have shared with you']/span[3]/span"));
	...
	public void successfully_Verify_Insights_Counts_equal_to_ALl_tab() throws Throwable {
		WebElement element = login.driver
				.findElement(By.xpath("//div[@title='All insights you have access to']/span[3]/span"));
	...
	public void search_insight_in_tab_and_and_Successfully_Verify_the_same_insight_in_All_tab(String arg1, String arg2,
		...
		if (arg1.equalsIgnoreCase(arg1)) {
			...
			Thread.sleep(5500);
			String Myinsightsearch = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
			...
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).sendKeys(X);
			Thread.sleep(5500);
			String Myinsightsearch1 = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		...
		if (arg2.equalsIgnoreCase(arg2)) {
			...
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).sendKeys(X);
			Thread.sleep(5500);
			String Analyticssearch = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
			...
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).sendKeys(X);
			Thread.sleep(5500);
			String Analyticssearch1 = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		...
		if (arg3.equalsIgnoreCase(arg3)) {
			...
			login.driver.findElement(By.xpath("//div[@title='Insights that other users have shared with you']"))
					.click();
			Thread.sleep(5500);
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).click();
			Thread.sleep(5500);
			...
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).sendKeys(X);
			Thread.sleep(5500);
			String Sharedsearch = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
			...
			login.driver.findElement(By.xpath("//input[@class='insights-search-filter--input']")).sendKeys(X);
			Thread.sleep(5500);
			String Sharedsearch1 = login.driver
					.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void verify_the_World_Economy_category_in(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
			Thread.sleep(5500);
	...
	public void verify_the_Emerging_Markets_category_in(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
			Thread.sleep(5500);
	...
	public void verify_the_Thematic_Analysis_category_in(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
			Thread.sleep(5500);
	...
	public void verify_the_New_Datasets_category_in(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(1500);
		if (arg1.equalsIgnoreCase(arg1)) {
			Thread.sleep(5500);
	...
	public void select_CopyLink_options() throws Throwable {
		...
		Thread.sleep(2500);
		CopylinkRightclick = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	}
	...
	public void successfully_Verify_CopyLink_insight_option_is_working() throws Throwable {
		...
		String Copylinkinsightname = login.driver
				.findElement(By.xpath("//div[@class='page-main-header--title-field-text text-dots']")).getText();
	...
	public void verify_the_insight_name_as_for_Successful_landing_page_search_with_Series_ID_as(String arg1,
	...
	public void verify_the_insight_name_as_for_Successful_landing_page_search_by_Name(String arg1) throws Throwable {
		Thread.sleep(10000);
		String searchInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void verify_that_insight_should_not_display_for_Series_ID_when_search_by_Name_is_selected()
			throws Throwable {

		if (login.driver.findElements(By.xpath(
				"//div[@class='search-create-item search-create-item__create-blank insight-list-empty--wrapper']"))
				.size() != 0) {
			...
			login.driver
					.findElement(By.xpath(
							"//div[@class='insights-search-attributes dropdown dropdown__right']/div[1]/span/div"))
					.click();
			Thread.sleep(6000);
			login.driver
					.findElement(
							By.xpath("//div[@class='dropdown--body insights-search-attributes--content']/label[1]"))
					.click();
	...
	public void gives_a_Description_as(String arg1) throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='header-menu-item--dropdown']/div[10]")).click();
		Thread.sleep(2500);
		login.driver.findElement(By.xpath("//div[@class='insight-settings-general']/div[5]/div/textarea"))
				.sendKeys(arg1);
		Thread.sleep(4500);
		login.driver.findElement(By.xpath("//button[contains(text(),'Save')]")).click();
		Thread.sleep(2500);
	...
	public void select_Insight_attributes_drop_down() throws Throwable {
		...
		Thread.sleep(6000);
		login.driver
				.findElement(By.xpath("//div[@class='dropdown--body insights-search-attributes--content']/label[1]"))
				.click();
		...
		if (login.driver
				.findElement(By.xpath(
						"//div[@class='dropdown--body insights-search-attributes--content']/div/div[2]/label/span[1]"))
				.isEnabled())
			;
		{
			Thread.sleep(1000);
		...
		Thread.sleep(1000);
		login.driver.findElement(By.xpath("//div[@class='dropdown--button insights-search-attributes--button']"))
				.click();
	}
	...
	public void verify_the_insight_as_with_Description_for_search_by_all_content_Insight_attributes(String arg1,
			String arg2) throws Throwable {
		Thread.sleep(5000);
		String searchInsightwithInsightattributes = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		System.out.println(arg1 + ":" + searchInsightwithInsightattributes);

		if (arg1.equalsIgnoreCase(searchInsightwithInsightattributes)) {
			System.out.println(
					"Landing page Search for search by all content - Insight attributes is Verified Successfully");

		} else {
			Assert.fail(
					"Landing page Search for search by all content - Insight attributes is NOT Verified Successfully");
		...
		login.driver.findElement(By.xpath("//div[@class='header-menu-item--dropdown']/div[10]")).click();
		Thread.sleep(2500);
		String searchInsightwithInsightattributesDescription = login.driver
				.findElement(By.xpath("//div[@class='insight-settings-general']/div[5]/div/textarea")).getText();
	...
	public void take_a_copy_of_the_series_ID() throws Throwable {
		...
		Thread.sleep(2000);
		Actions action = new Actions(login.driver);
		WebElement SeriesSSPWindow = login.driver
				.findElement(By.xpath("//ul[@class='search-series-list scrollable']/li[1]/div/a[1]/div[1]"));
		action.moveToElement(SeriesSSPWindow).build().perform();
		Thread.sleep(2000);
		login.driver.findElement(By.xpath("//ul[@class='search-series-list scrollable']/li[1]/div/a[1]/div[1]"))
				.click();
		Thread.sleep(2000);
		String SeriesIDforSeriesAttributes = login.driver
				.findElement(By.xpath("//div[@class='main-series-information--data']/div[2]/div[1]/div[1]")).getText();
	...
	public void select_Insight_attributes_drop_down_as_Series_attributes() throws Throwable {
		...
		if (login.driver
				.findElement(By.xpath(
						"//div[@class='dropdown--body insights-search-attributes--content']/div/div[1]/label/span[1]"))
				.isEnabled())
			;
		{
			Thread.sleep(2000);
	...
	public void verify_the_insight_as_with_Series_ID_as_for_search_as_by_all_content_Series_attributes(String arg1,
			String arg2) throws Throwable {
		Thread.sleep(8000);
		String InsightnameforSeriesattributessearch = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		Thread.sleep(1000);
		...
		Thread.sleep(6000);
		login.driver
				.findElement(By.xpath("//div[@class='view-selection--btn-icon view-selection--btn-icon__my-series']"))
				.click();
		Thread.sleep(8000);
		Actions action1 = new Actions(login.driver);
		...
		String VerifyingSeriesIDforSeriesAttributes = login.driver
				.findElement(By.xpath("//div[@class='main-series-information--data']/div[2]/div[1]/div[1]")).getText();
	...
	public void create_a_insight_name_as(String arg1) throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[@class='sphere-modal-controls']/button[2]")).click();
		Thread.sleep(3500);
		NewInsightnameForInvalidKeyword = login.driver
				.findElement(By.xpath("//div[@title='Click to edit the Insight']")).getText();
	...
	public void verify_that_Create_insight_Functionality_is_working_by_creating_Insight() throws Throwable {
		...
		login.driver.findElement(By.xpath("//button[@class='insights-search-filter--reset-icon icon--red-cross']"))
				.click();
		Thread.sleep(5000);
		String Insightnamecreatedatinvalidkeyword = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
		Thread.sleep(5000);
	...
	public void select_Search_by_name() throws Throwable {
		Thread.sleep(10000);
		login.driver
				.findElement(By.xpath("//div[@class='dropdown--body insights-search-attributes--content']/label[2]"))
				.click();
	}

	@And("^Verify that Insight attributes and Series attributes in search drop down is disabled$")
	public void verify_that_Insight_attributes_and_Series_attributes_in_search_drop_down_is_disabled()
			throws Throwable {
		select_the_Search_Dropdown();
		Thread.sleep(9000);
		boolean CheckboxDefaultStatus = login.driver
				.findElement(By.xpath("//div[@class='dropdown--body insights-search-attributes--content']/label[1]"))
				.isSelected();
		...
		if (CheckboxDefaultStatus == true) {
			...
			Assert.fail(
					"Insight attributes and Series attributes in search drop down is NOT disabled Successfully !! ");
			HTML_Report.strTCResult = "FAIL";
			HTML_Report.execRemarks = "Insight attributes and Series attributes in search drop down is NOT disabled Successfully !! ";
		} else {
			System.out.println(
					"Insight attributes and Series attributes in search drop down is disabled Successfully !!");
			HTML_Report.strTCResult = "PASS";
	...
	public void applay_Tag_for_the_insight(String arg1) throws Throwable {
		...
		Actions action = new Actions(login.driver);
		WebElement RightclickonInsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[2]/div[2]/div/a"));
		action.contextClick(RightclickonInsight).build().perform();
		Thread.sleep(1000);
		login.driver.findElement(By.xpath("//div[@class='items-wrapper']/li[9]")).click();
		Thread.sleep(1000);
	...
	public void verify_the_search_with_in_available_insights_and_work_with_respect_to_the_applied_filters()
			throws Throwable {
	...
	public void verify_message_for_no_insights_search_in_current_tab() throws Throwable {
		...
		if (login.driver.findElements(By.xpath(
				"//span[contains(text(),'No insights were found in this group. But there are some in the other one - ')] "))
				.size() != 0) {
	...
	public void verify_All_available_hyperlink_functionality_is_working() throws Throwable {
		...
		Thread.sleep(5500);
		String Insightcountforallhyperlinkinalltabs = login.driver
				.findElement(By.xpath("//div[@class='insights-groups']/div[6]/span[3]/span")).getText();
		...
		if (Insightcountforallhyperlinkinalltab == (Insightcountforallhyperlink)) {
			System.out.println(
					"All available hyperlink for no insights search in Other tab than Myinsight is verified Successfully");
			HTML_Report.strTCResult = "PASS";
	...
	public void verify_the_number_of_insight_count_with_search() throws Throwable {
		Thread.sleep(5500);
		String InsightcountforallhyperlinkinMyinsighttabs = login.driver
				.findElement(By.xpath("//div[@class='insights-groups']/div[6]/span[3]/span")).getText();
	...
	public void verify_number_of_insights_for_a_tag_Applied() throws Throwable {
		...
		select_the_All_tag_dropdown();
		Thread.sleep(5500);
		String Insightcountfortagappliedindropdown = login.driver
				.findElement(By.xpath("//div[@class='custom-select-item--link insights-tags-item--tag-box']/span[2]"))
				.getText();
		...
		Thread.sleep(8500);
		String Text1 = login.driver.findElement(By.xpath("//div[@class='insights-groups']/div[2]/span[3]/span"))
				.getText();
	...
	public void successfully_Verify_tag_behavior_when_any_other_filters_applied() throws Throwable {
		...
		Thread.sleep(1500);
		String Text1 = login.driver.findElement(By.xpath("//span[@class='insights-tags-item--tag-title text-dots']"))
				.getText();

		Thread.sleep(1500);
		String Text3 = login.driver
				.findElement(
						By.xpath("//*[@id='landing_page']/div[2]/div[1]/div[2]/div[3]/div[1]/div/div/div/span/span[1]"))
				.getText();
		Thread.sleep(4500);
		Actions action1 = new Actions(login.driver);
		WebElement RightclickonInsight1 = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a"));
		...
		login.driver.findElement(By.xpath("//div[@class='header-menu-item--dropdown']/div[10]")).click();
		Thread.sleep(4500);
		String Text4 = login.driver
				.findElement(By.xpath("//div[@class='insight-settings-general']/div[4]/div/div/a/span/div[2]"))
				.getText();
		Thread.sleep(2500);
		login.driver.findElement(By.xpath("//div[@class='sphere-modal__close']")).click();
		Thread.sleep(1500);
	...
	public void successfully_Verify_sort_by_behavior_for(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(6500);
	...
	public void successfully_Verify_Last_opened_option_for(String arg1, String arg2, String arg3, String arg4)
			throws Throwable {
		Thread.sleep(6500);
	...
	public void share_the_insight() throws Throwable {
		...
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("inputinshredpopup")))
				.sendKeys("ceicsuresh13@gmail.com");
		Thread.sleep(5500);
	...
	public void login_to_the_Normal_account() throws Throwable {
		...
		Thread.sleep(6500);
		Profilenameforlasteditor = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Profilename")))
				.getText();
		...
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("input_password"))).sendKeys("pKumar@2018$");
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("btnLogin"))).click();
	}
	...
	public void successfully_Verify_Sort_by_Last_Editor() throws Throwable {
		...
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Last_editor"))).click();
		Thread.sleep(6500);
		String Lasteditornameintosharedaccnt = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Lasteditornameintosharedaccnt"))).getText();
	...
	public void edit_the_Second_insight_as(String arg1) throws Throwable {
		...
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Editinsightsearchinputforsecondinsight")))
				.clear();
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Editinsightsearchinputforsecondinsight")))
				.sendKeys(arg1);
	...
	public void successfully_Verify_Title_functionality_as_and(String arg1, String arg2) throws Throwable {
		...
		Thread.sleep(8500);
		String firstinsight = login.driver
				.findElement(By.xpath("//div[@class='insights-grid-body']/div[1]/div[2]/div/a")).getText();
	...
	public void successfully_verify_default_option_for_dropdown() throws Throwable {
		Thread.sleep(2500);
		if (login.driver.findElements(By.xpath(login.LOCATORS.getProperty("Productwatsnewexploredatabydropdown")))
				.size() != 0) {
	...
	public void successfully_CEIC_Insider_insight_of_world_trend_plus_in_What_s_new() throws Throwable {
		Thread.sleep(5000);
		List<WebElement> Totalinsights = login.driver
				.findElements(By.xpath("//div[@class='announcements-container--body']/div/div"));
	...
	public void successfully_verify_CEIC_Insider_insight_of_Indonesia_Premium_Database_in_What_s_new()
			throws Throwable {
		Thread.sleep(5000);
		List<WebElement> Totalinsights = login.driver
				.findElements(By.xpath("//div[@class='announcements-container--body']/div/div"));
	...
	public void successfully_verify_the_insight_permission_for_other_users_after_add_to_CEIC_Insider()
			throws Throwable {
		Thread.sleep(5000);
		ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
		login.driver.switchTo().window(tabs2.get(1));
		...
		if (login.driver.findElements(By.xpath("//div[@class='items-wrapper']/li[1]")).size() != 0) {
			System.out
					.println("Successfully verified the insight permission for other users after add to CEIC Insider");
		} else {
	...
	public void verify_Explore_data_for_Global_DB() throws Throwable {
		Thread.sleep(5500);
		String Text1 = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Product_Global_Database")))
				.getText();
		...
		login.Log4j.info("Is 'Global_Database_global_in_Newinsight' Displayed? - True/False:: "
				+ Global_Database_global_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_global_in_Newinsight"))).getText();
		System.out.println(X);
		Assert.assertEquals(true, Global_Database_global_in_Newinsight.isDisplayed());
		login.driver.close();
		login.driver.switchTo().window(tabs2.get(0));
	...
	public void verify_Footnotes_for_Global_DB() throws Throwable {
		...
		WebElement Global_Database_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_Footnotes")));
		login.Log4j.info(
				"Is 'Global_Database_Footnotes' Displayed? - True/False:: " + Global_Database_Footnotes.isDisplayed());
		Assert.assertEquals(true, Global_Database_Footnotes.isDisplayed());
		Thread.sleep(3500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_Footnotes"))).click();
		Thread.sleep(2500);
		String X = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Global_Database_inside_footnotes")))
				.getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement Global_Database_inside_footnotes = login.driver
	...
	public void verify_Explore_data_for_World_Trend_Plus_databases() throws Throwable {
		...
		System.out.println(Y);
		WebElement World_Treand_Database_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_Database_Explore_data")));
		login.Log4j.info("Is 'World_Treand_Database_Explore_data' Displayed? - True/False:: "
				+ World_Treand_Database_Explore_data.isDisplayed());
		...
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement World_Treand_Database_WorldTreand_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_Database_WorldTreand_in_Newinsight")));
		login.Log4j.info("Is 'World_Treand_Database_WorldTreand_in_Newinsight' Displayed? - True/False:: "
				+ World_Treand_Database_WorldTreand_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_Database_WorldTreand_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_World_Trend_Plus_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement World_Treand_Database_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_Database_Footnotes")));
		login.Log4j.info("Is 'World_Treand_Database_Footnotes' Displayed? - True/False:: "
				+ World_Treand_Database_Footnotes.isDisplayed());
		...
		Thread.sleep(3500);
		String X = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_inside_footnotes")))
				.getText();
		System.out.println(X);
		// div[@class='footnotes-bread-crumbs']/div/div[1]
		Thread.sleep(4500);
		WebElement World_Treand_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("World_Treand_inside_footnotes")));
		login.Log4j.info("Is 'World_Treand_inside_footnotes' Displayed? - True/False:: "
				+ World_Treand_inside_footnotes.isDisplayed());
	...
	public void verify_Explore_data_for_China_Premium_databases_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(1500);
		WebElement China_PremiumDatabase_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_Explore_data")));
		login.Log4j.info("Is 'China_PremiumDatabase_Explore_data' Displayed? - True/False:: "
				+ China_PremiumDatabase_Explore_data.isDisplayed());
		...
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement China_PremiumDatabase_china_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_china_in_Newinsight")));
		login.Log4j.info("Is 'China_PremiumDatabase_china_in_Newinsight' Displayed? - True/False:: "
				+ China_PremiumDatabase_china_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_china_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_China_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement China_PremiumDatabase_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_Footnotes")));
		login.Log4j.info("Is 'China_Database_Footnotes' Displayed? - True/False:: "
				+ China_PremiumDatabase_Footnotes.isDisplayed());
		...
		Thread.sleep(2500);
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_inside_footnotes"))).getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement China_PremiumDatabase_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("China_PremiumDatabase_inside_footnotes")));
		login.Log4j.info("Is 'China_PremiumDatabase_inside_footnotes' Displayed? - True/False:: "
				+ China_PremiumDatabase_inside_footnotes.isDisplayed());
	...
	public void verify_Explore_data_for_Brazil_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(1500);
		WebElement Brazil_PremiumDatabase_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_Explore_data")));
		login.Log4j.info("Is 'Brazil_PremiumDatabase_Explore_data' Displayed? - True/False:: "
				+ Brazil_PremiumDatabase_Explore_data.isDisplayed());
		...
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement Brazil_PremiumDatabase_brazil_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_brazil_in_Newinsight")));
		login.Log4j.info("Is 'Brazil_PremiumDatabase_brazil_in_Newinsight' Displayed? - True/False:: "
				+ Brazil_PremiumDatabase_brazil_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_brazil_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_Brazil_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement Brazil_PremiumDatabase_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_Footnotes")));
		login.Log4j.info("Is 'Brazil_PremiumDatabase_Footnotes? - True/False:: "
				+ Brazil_PremiumDatabase_Footnotes.isDisplayed());
		...
		Thread.sleep(2500);
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_inside_footnotes"))).getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement Brazil_PremiumDatabase_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Brazil_PremiumDatabase_inside_footnotes")));
		login.Log4j.info("Is 'Brazil_PremiumDatabase_inside_footnotes' Displayed? - True/False:: "
				+ Brazil_PremiumDatabase_inside_footnotes.isDisplayed());
	...
	public void verify_Explore_data_for_India_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(1500);
		WebElement India_PremiumDatabase_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_Explore_data")));
		login.Log4j.info("Is 'India_PremiumDatabase_Explore_data' Displayed? - True/False:: "
				+ India_PremiumDatabase_Explore_data.isDisplayed());
		...
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement India_PremiumDatabase_india_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_india_in_Newinsight")));
		login.Log4j.info("Is 'India_PremiumDatabase_india_in_Newinsight' Displayed? - True/False:: "
				+ India_PremiumDatabase_india_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_india_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_India_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement India_PremiumDatabase_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_Footnotes")));
		login.Log4j.info(
				"Is 'India_PremiumDatabase_Footnotes? - True/False:: " + India_PremiumDatabase_Footnotes.isDisplayed());
		...
		Thread.sleep(2500);
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_inside_footnotes"))).getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement India_PremiumDatabase_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("India_PremiumDatabase_inside_footnotes")));
		login.Log4j.info("Is 'India_PremiumDatabase_inside_footnotes' Displayed? - True/False:: "
				+ India_PremiumDatabase_inside_footnotes.isDisplayed());
	...
	public void verify_Explore_data_for_Russia_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(1500);
		WebElement Russia_PremiumDatabase_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_Explore_data")));
		login.Log4j.info("Is 'Russia_PremiumDatabase_Explore_data' Displayed? - True/False:: "
				+ Russia_PremiumDatabase_Explore_data.isDisplayed());
		...
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement Russia_PremiumDatabase_russia_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_russia_in_Newinsight")));
		login.Log4j.info("Is 'Russia_PremiumDatabase_russia_in_Newinsight' Displayed? - True/False:: "
				+ Russia_PremiumDatabase_russia_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_russia_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_Russia_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement Russia_PremiumDatabase_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_Footnotes")));
		login.Log4j.info("Is 'India_PremiumDatabase_Footnotes? - True/False:: "
				+ Russia_PremiumDatabase_Footnotes.isDisplayed());
		...
		Thread.sleep(2500);
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_inside_footnotes"))).getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement Russia_PremiumDatabase_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Russia_PremiumDatabase_inside_footnotes")));
		login.Log4j.info("Is 'Russia_PremiumDatabase_inside_footnotes' Displayed? - True/False:: "
				+ Russia_PremiumDatabase_inside_footnotes.isDisplayed());
	...
	public void verify_Explore_data_for_Indonesia_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(1500);
		WebElement Indonesia_PremiumDatabase_Explore_data = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_Explore_data")));
		login.Log4j.info("Is 'Indonesia_PremiumDatabase_Explore_data' Displayed? - True/False:: "
				+ Indonesia_PremiumDatabase_Explore_data.isDisplayed());
		Assert.assertEquals(true, Indonesia_PremiumDatabase_Explore_data.isDisplayed());
		Thread.sleep(4500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_Explore_data")))
				.click();
		ArrayList<String> tabs2 = new ArrayList<String>(login.driver.getWindowHandles());
		login.driver.switchTo().window(tabs2.get(1));
		Thread.sleep(4500);
		WebElement Indonesia_PremiumDatabase_indonesia_in_Newinsight = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_indonesia_in_Newinsight")));
		login.Log4j.info("Is 'Indonesia_PremiumDatabase_indonesia_in_Newinsight' Displayed? - True/False:: "
				+ Indonesia_PremiumDatabase_indonesia_in_Newinsight.isDisplayed());
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_indonesia_in_Newinsight")))
				.getText();
		System.out.println(X);
	...
	public void verify_Footnotes_for_Indonesia_Premium_databases() throws Throwable {
		...
		System.out.println(Y);
		Thread.sleep(3500);
		WebElement Indonesia_PremiumDatabase_Footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_Footnotes")));
		login.Log4j.info("Is 'Indonesia_PremiumDatabase_Footnotes? - True/False:: "
				+ Indonesia_PremiumDatabase_Footnotes.isDisplayed());
		...
		Thread.sleep(2500);
		String X = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_inside_footnotes")))
				.getText();
		System.out.println(X);
		Thread.sleep(4500);
		WebElement Indonesia_PremiumDatabase_inside_footnotes = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Indonesia_PremiumDatabase_inside_footnotes")));
		login.Log4j.info("Is 'Indonesia_PremiumDatabase_inside_footnotes' Displayed? - True/False:: "
				+ Indonesia_PremiumDatabase_inside_footnotes.isDisplayed());
	...
	public void verify_default_insight_title_while_coping_insight() throws Throwable {
		Thread.sleep(4500);
		String Text1 = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Insightnameinpreviewmode")))
				.getText();
		Thread.sleep(4500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("copyinviewingridmode"))).click();
		Thread.sleep(4500);
		...
		Thread.sleep(4500);
		String Text2 = login.driver.findElement(By.xpath("//div[@title='Click to edit the Insight']")).getText();
	...
	public void select_the_create_a_folder() throws Throwable {
		...
		Defaultfoldername = login.driver
				.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']/div[1]/input"))
				.getAttribute("value");
	...
	public void successfully_Verify_Save_button_is_disabled() throws Throwable {
		Thread.sleep(5000);
		boolean Savebtn = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Savebuttoninaddtagpopup")))
				.isEnabled();
	...
	public void verify_Copy_insight_functionality() throws Throwable {
		...
		String IECopyInsight = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Firstinsightingridmode")))
				.getText();
	...
	public void verify_Delete_functionality_in_gridmode() throws Throwable {
		...
		String BeforeDelete = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Firstinsightingridmode")))
				.getText();
		WebElement Delete_forever = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Delete_forever")));
		login.Log4j.info("Is 'Delete_forever' Displayed? - True/False:: " + Delete_forever.isDisplayed());
		Assert.assertEquals(true, Delete_forever.isDisplayed());
		...
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Delete_forever"))).click();
		Thread.sleep(5500);
		String AfterDelete = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Firstinsightingridmode")))
				.getText();
		System.out.println(BeforeDelete + ":" + AfterDelete);
		if (BeforeDelete != AfterDelete) {
			System.out.println("Deleating Functionality is working Succesfully in Grid Mode ,Deleated Insight is  :- "
					+ BeforeDelete);
		} else {
	...
	public void verify_Favorite_icon_functionality_in_gridmode() throws Throwable {
		Thread.sleep(5500);
		String Insightnamebeforefavorite = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Firstinsightingridmode"))).getText();
		Thread.sleep(5500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Favorite_Tab_inLandingPage"))).click();
		Thread.sleep(5500);
		String Insightnameafterfavorite = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Firstinsightingridmode"))).getText();
	...
	public void verify_insight_description_functionality_in_gridmode() throws Throwable {
		mouseover_on_insight();
		String DescriptioninIEPage = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Description_in_Grid"))).getText();
		Thread.sleep(5500);
	...
	public void successfully_Verify_Sort_by_Last_Editor_in_gridmode() throws Throwable {
		...
		Thread.sleep(6500);
		String Lasteditornameintosharedaccnt = login.driver
				.findElement(By.xpath(login.LOCATORS.getProperty("Lasteditornameintosharedaccntingridmode"))).getText();
		System.out.println(Profilenameforlasteditor + ":" + Lasteditornameintosharedaccnt);
		Thread.sleep(5500);
		if (Profilenameforlasteditor.equalsIgnoreCase(Lasteditornameintosharedaccnt)) {
