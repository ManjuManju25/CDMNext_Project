...
public class Myseries {
	...
	public void select_the_Expand_Icon() throws Throwable {
		Thread.sleep(6000);
		login.driver
				.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/div[2]/div[3]/div[2]/div[1]/div[1]/div"))
				.click();
	}
	...
	public void verify_View_panel_which_should_be_Expanded() throws Throwable {
		Thread.sleep(6000);
		if (login.driver.findElements(By.xpath("/html/body/div[1]/div/div[1]/div/div/div[2]/div[3]/div[1]/div[1]/div"))
				.size() != 0) {
			System.out.println("Expand icon is working Successfully");
		} else {
			Assert.fail("Expand icon is NOT working Successfully");
		}
		login.driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/div[2]/div[3]/div[1]/div[1]/div"))
				.click();
	}
	...
	public void verify_for_series_functionality_under_tab(String arg1, String arg2) throws Throwable {
		Thread.sleep(6000);
		if (login.driver.findElements(By.xpath("//div[@class='insight-data disabled']/div[1]/div[1]/div/div[1]/div[2]"))
				.size() != 0) {
			System.out.println("Related Series option is disabled");
		}
		if (login.driver.findElements(By.xpath("//div[@class='insight-data disabled']/div/div[7]/div[1]"))
				.size() != 0) {
	...
	public void verify_Validation_message_for_more_than_series_added_to_preview_window(int arg1) throws Throwable {
		...
		Thread.sleep(8000);
		login.driver
				.findElement(By.xpath("//button[@class='button button__action button__sm series-preview--refresh']"))
				.click();
		Thread.sleep(4000);
	...
	public void select_the_select_all_option() throws Throwable {
		Thread.sleep(8000);
		login.driver.findElement(By.xpath("//div[@class='data-action-panel insight-action-panel']/div[7]/div[2]"))
				.click();
		Thread.sleep(8000);
	...
	public void verify_Seperator_functionality_for_Series() throws Throwable {
		...
		if (login.driver.findElements(By.xpath(
				"//div[@class='download-button download-button__header download-button__algae download-button__disabled download-button__unavailable']"))
				.size() != 0) {
