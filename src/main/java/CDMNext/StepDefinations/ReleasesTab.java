...
public class ReleasesTab {
	...
	public void the_should_present(String arg1) throws Throwable {
		if (login.driver.findElements(By.xpath("//*[contains(@class,'time-frame-button')]")).size() == 12) {
			List<WebElement> timeframes = login.driver
					.findElements(By.xpath("//*[contains(@class,'time-frame-button')]"));
			for (int i = 1; i <= timeframes.size(); i++) {
				new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,
						"//*[contains(@class,'time-frame-button')][" + i + "]", 4)).click().build().perform();
				CommonFunctionality.wait(4000);
				CommonFunctionality.wait.until(
						ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@class='nodes-list--tree']")));
	...
	public void select_timeframe_button(String arg1) throws Throwable {
		CommonFunctionality.wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[contains(@class,'time-frame-button') and contains(text(),'" + arg1 + "')]")));
		new Actions(login.driver)
				.moveToElement(CommonFunctionality.getElementByXpath(login.driver,
						"//*[contains(@class,'time-frame-button') and contains(text(),'" + arg1 + "')]", 4))
	...
	public void release_status_should_present(String arg1) throws Throwable {
		WebElement status = CommonFunctionality.getElementByXpath(login.driver,
				"//*[@class='toggler-control-item--label' and contains(text(),'" + arg1 + "')]", 4);
	...
	public void hovoring_option_and(String arg1, String arg2) throws Throwable {
		new Actions(login.driver).moveToElement(
				...
				.build().perform();
		dropdown_title = CommonFunctionality
				.getElementByXpath(login.driver, "//span[contains(text(),'" + arg2 + "')]/parent::*", 4)
				.getAttribute("title");
	}
	...
	public void hovoring_option_and_get_the_text(String arg1, String arg2) throws Throwable {
		new Actions(login.driver).moveToElement(
				CommonFunctionality.getElementByXpath(login.driver, "//span[contains(text(),'" + arg1 + "')]", 4))
				.build().perform();
		watchlist_text = CommonFunctionality.getElementByXpath(login.driver, "//*[@name='" + arg2 + "']", 4).getText();
	}

	@And("^Check the deselected option$")
	public void check_the_deselected_option() throws Throwable {
		List<WebElement> deselect_all = login.driver.findElements(By.xpath(
				"//*[contains(@class,'toggler-control__light_purple')]//label[contains(@class,'toggler-control-item')]"));
	...
	public void right_Click_the_first_dataset() throws Throwable {
		WebElement collapse = CommonFunctionality.getElementByXpath(login.driver,
				"(//*[@class='release-scheduler-tree-node--title'])[1]/preceding::*[@class='toggle']/parent::div", 4);
	...
	public void get_Text_of_Dataset() throws Throwable {
		dataset_text = CommonFunctionality
				.getElementByXpath(login.driver, "(//*[@class='release-scheduler-tree-node--title'])[1]", 4).getText();
	}
	...
	public void rename_Insight_to_Download() throws Throwable {
		CommonFunctionality
				.getElementByXpath(login.driver, "//*[contains(@class,'insight-breadcrumb--title__editable')]", 4)
				.click();
		WebElement name = CommonFunctionality.getElementByXpath(login.driver,
				"//*[@class='insight-breadcrumb--title-input']", 4);
	...
	public void click_to(String arg1) throws Throwable {
		...
		new_insight_name = CommonFunctionality
				.getElementByXpath(login.driver,
						"//*[contains(@class,'sphere-modal__content')]//input[@class='form--control']", 4)
				.getAttribute("value");
		CommonFunctionality.getElementByXpath(login.driver,
				"//*[text()='Create insight' and contains(@class,'button__primary')]", 4).click();
		WebElement source = CommonFunctionality.getElementByXpath(login.driver, "(//*[@class='series-item--name'])[1]",
				4);
		...
		co.hovor_on_series_level_only_without_click();
		...
		if (login.driver.findElements(By.xpath("(//*[text()='" + new_insight_name
				+ "']/preceding::*[contains(@title,'favorite')])[1]/following-sibling::div[@title='" + arg1 + "']"))
				.size() == 0) {
	...
	public void select_first_dataset() throws Throwable {
		...
		WebElement dataset = CommonFunctionality.getElementByXpath(login.driver,
				"(//*[@class='release-scheduler-tree-node--title']/preceding-sibling::span)[1]", 4);
	...
	public void get_the_text_of_expanded_dataset() throws Throwable {
		String dataset = CommonFunctionality.getElementByXpath(login.driver,
				"//*[contains(@class,'full-expanded open')]//span[@class='release-scheduler-tree-node--title']", 4)
				.getText();
	...
	public void select_related_database() throws Throwable {
		new Actions(login.driver).moveToElement(CommonFunctionality.getElementByXpath(login.driver,
				"(//*[contains(@class,'release-scheduler-tree-node--marker__released')])[1]/following::*[@class='toggle'][1]",
	...
	public void select_option_from_watchlist(String arg1) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("Daily") || arg1.equalsIgnoreCase("Weekly") || arg1.equalsIgnoreCase("Monthly")
				|| arg1.equalsIgnoreCase("Hourly")) {
			boolean frequency = login.driver
					.findElement(By.xpath(
							"//*[@class='items-wrapper']//*[contains(text(),'" + arg1 + "')]/preceding-sibling::input"))
					.isSelected();
			if (frequency == false) {
				new Actions(login.driver)
						.moveToElement(
			...
			boolean checkbox = login.driver
					.findElement(By.xpath("//*[@class='items-wrapper']//*[@name='" + arg1 + "']")).isSelected();
			if (checkbox == false) {
				new Actions(login.driver)
						.moveToElement(CommonFunctionality.getElementByXpath(login.driver,
								"//*[@class='items-wrapper']//*[@name='" + arg1 + "']//following-sibling::span[1]", 4))
						.pause(1000).click().build().perform();
			}
		}
	}
	...
	public void verify_no_release_status_should_select() throws Throwable {
		WebElement no_release = CommonFunctionality.getElementByXpath(login.driver,
				"//*[contains(@class,'toggler-control__light_purple')]//*[contains(@class,'toggler-control-item')]",
				4);
	...
	public void verify_the_dataset(String arg1) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("collapsed")) {
			...
			CommonFunctionality.wait
					.until(ExpectedConditions.elementToBeClickable(By.xpath("(//*[@class='toggle'])[1]/parent::div")));
			WebElement collapse = CommonFunctionality.getElementByXpath(login.driver,
					"(//*[@class='toggle'])[1]/parent::div", 4);
			if (collapse.getAttribute("class").contains("full-expanded")) {
	...
	public void only_status_icon_should_present(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("Released")) {
			if (login.driver.findElements(By.cssSelector("span[title='Released']")).size() > 0) {
				// if(login.driver.findElements(By.xpath("//*[@class='release-scheduler-tree-node--markers']/span[not(contains(@title,'elease'))]")).size()>0
				// || login.driver.findElements(By.cssSelector("span[title='Delayed
				// releases']")).size()>0) {
		...
		if (arg1.equalsIgnoreCase("Pending")) {
			if (login.driver
					.findElements(By.cssSelector(".release-scheduler-tree-node .release-scheduler-tree-node--markers"))
					.size() > 0) {
				if (login.driver.findElements(By.cssSelector("span[title='Released']")).size() > 0
						|| login.driver.findElements(By.cssSelector("span[title='Delayed releases']")).size() > 0) {
					fail("Other icons are also present on clicking " + arg1 + " status icon");
				}
			} else {
				fail("No data is present on clicking " + arg1 + " tab");
		...
		if (arg1.equalsIgnoreCase("Delayed")) {
			...
			if (login.driver.findElements(By.cssSelector("span[title='Delayed releases']")).size() > 0) {
				if (login.driver.findElements(By.cssSelector("span[title='Released']")).size() > 0
						|| login.driver.findElements(By.cssSelector("span[title='Delayed releases']")).size() > 50) {
					fail("Other icons are also present on clicking " + arg1 + " status icon");
				}
			} else {
		...
		if (arg1.equalsIgnoreCase("All")) {
			select_timeframe_button("-1Y");
			if (!(login.driver
					.findElements(By.xpath("//*[contains(@class,'release-scheduler-tree-node--marker__released')]"))
					.size() > 0
					|| login.driver.findElements(By.cssSelector(".release-scheduler-tree-node--marker__delayed"))
							.size() > 0)) {
				sa.fail("No data is present on clicking " + arg1 + " tab");
			}
		}
	...
	public void download_button_should_enable_and_x_series_selected_should_appear_in_search() throws Throwable {
		WebElement download = CommonFunctionality.getElementBycssSelector(login.driver,
				".download-button--button.button.button__download-btn", 4);
		if (download.isEnabled()) {
			login.Log4j.info("Download button is enabled");
		} else {
			sa.fail("Verification Failed");
		}
		String text = CommonFunctionality.getElementByClassName(login.driver, "search-input--selected-count", 4)
				.getText();
		int count = Integer.parseInt(text);
		if (count != 0) {
			WebElement series_count = CommonFunctionality.getElementBycssSelector(login.driver,
					"span[title='Edit your result selection']", 4);
	...
	public void check_the_download_button_and_search_box() throws Throwable {
		WebElement download = login.driver.findElement(By.xpath(
				"//*[contains(@class,'download-button__header')]//*[contains(@class,'button__download-btn')][1]"));
		...
		boolean series_count = login.driver.findElement(By.cssSelector("span[title='Edit your result selection']"))
				.isDisplayed();
	...
	public void the_Option_Should_show(String arg1) throws Throwable {
		if (arg1.equalsIgnoreCase("Multiple Footnotes") || arg1.equalsIgnoreCase("Multiple Footnotes - More actions")) {
			List<WebElement> footnotes = login.driver.findElements(
					By.xpath("//*[@title='Footnotes']//following-sibling::ul[@class='dropdown-menu']/li/span/span/b"));
			for (int i = 1; i <= footnotes.size(); i++) {
				String footnotes_text = CommonFunctionality.getElementByXpath(login.driver,
						"//*[@title='Footnotes']//following-sibling::ul[@class='dropdown-menu']/li[" + i
								+ "]/span/span/b",
						4).getText();
				CommonFunctionality.getElementByXpath(login.driver,
						"//*[@title='Footnotes']//following-sibling::ul[@class='dropdown-menu']/li[" + i + "]", 4)
						.click();
				CommonFunctionality.wait(3000);
	...
	public void the_options_should_available(String arg1, String arg2, String arg3, String arg4, String arg5,
		...
		for (WebElement item : items) {
			String value = item.getAttribute("title");
			if (value.equals(arg1) || value.equals(arg2) || value.equals(arg3) || value.equals(arg4)
					|| value.equals(arg5) || value.equals(arg6)) {
				login.Log4j.info(value + " option is present on hovoring/right clicking the Datatable");
			} else {
				sa.fail(item + " not present");
			}
	...
	public void the_button_should_present(String arg1) throws Throwable {
		WebElement load = login.driver.findElement(By.xpath(
				"//*[@class='nodes-list--footer']//*[@js-more-indicators='' and contains(text(),'" + arg1 + "')]"));
	...
	public void selected_dataset_should_get_deselected() throws Throwable {
		WebElement deselect = CommonFunctionality.getElementByXpath(login.driver,
				"(//*[@class='release-scheduler-tree-node--title'])[1]/preceding-sibling::*", 4);
	...
	public void the_option_in_dataset_should_get_verified(String arg1) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("Edit Table")) {
			if (login.driver
					.findElements(By.xpath("//*[text()='Confirmation']//following::*[contains(text(),'Proceed with')]"))
					.size() > 0) {
				CommonFunctionality.getElementByXpath(login.driver,
						"//*[contains(@class,'sphere-modal__content')]//*[text()='Ok']", 4).click();
				CommonFunctionality.wait(3000);
		...
		if (arg1.equalsIgnoreCase("Edit Histogram")) {
			List<WebElement> histogram_series = login.driver.findElements(By.xpath(
	...
	public void the_link_should_display_in_color(String arg1, String arg2) throws Throwable {
		String actual = CommonFunctionality.getElementByXpath(login.driver,
				"//div[@class='selection-control' and not(contains(@style,'display: none;'))]", 4).getText();
		String unselect_color = CommonFunctionality
				.getElementByXpath(login.driver,
						"//div[@class='selection-control' and not(contains(@style,'display: none;'))]", 4)
				.getCssValue("color");
	...
	public void the_date_difference_in_timeframe_buttons_should_match(String arg1) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("+1W") || arg1.equalsIgnoreCase("+1M") || arg1.equalsIgnoreCase("+1Y")) {
			...
			CommonFunctionality.wait.until(
					ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'" + arg1 + "')]")));
			timeframe_date = CommonFunctionality
	...
	public void the_for_series_should_present(String arg1) throws Throwable {
		String title = null;
		try {
			title = CommonFunctionality.getElementByXpath(login.driver, "//span[@title='" + arg1 + "']", 4)
					.getAttribute("title");
		} catch (Exception e) {
			title = CommonFunctionality.getElementByXpath(login.driver, "(//span[@title='" + arg1 + "'])[2]", 4)
					.getAttribute("title");
		}
