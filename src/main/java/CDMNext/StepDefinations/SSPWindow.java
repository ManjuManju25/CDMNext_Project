...
public class SSPWindow {
	...
	public void check_for_prerequesties() throws Throwable {
		...
		if (login.driver
				...
				.size() > 0) {
			CommonFunctionality
					.getElementByXpath(login.driver, "//*[@class='movable-modal--window']//*[text()='Start new']", 4)
					.click();
	 ...
	 * public void
	 * hightlight_any_one_series_from_search_list_and_click_on_series_name() throws
	 * Throwable { CommonFunctionality.wait(2000); try { WebElement one_series =
	 * login.driver.findElement(By.
	 * xpath("//*[@class='series-name-wrapper ']//*[@class='series-name-field-title']"
	 * )); new
	 * Actions(login.driver).moveToElement(one_series).pause(3000).click().build().
	 * perform(); } catch (StaleElementReferenceException e) { WebElement one_series
	 * = login.driver.findElement(By.
	 * xpath("//*[@class='series-name-wrapper ']//*[@class='series-name-field-title']"
	 * )); new
	 * Actions(login.driver).moveToElement(one_series).pause(3000).click().build().
	...
	public void hightlight_any_one_series_and_click_on_series_name() throws Throwable {
		CommonFunctionality.wait(2000);
		try {
			WebElement one_series = login.driver
					.findElement(By.xpath("//*[@class='series-name-wrapper ']//*[@class='series-name-field-title']"));
			new Actions(login.driver).moveToElement(one_series).pause(3000).click().build().perform();
	...
	@SuppressWarnings("deprecation")
	@And("^hightlight any one series from search list and click on series name$")
	public void hightlight_any_one_series_from_search_list_and_click_on_series_name() throws Throwable {
		CommonFunctionality.wait(2000);
		...
		new Actions(login.driver).moveToElement(first_series).pause(2000)
				.click(login.driver.findElement(By.xpath(login.LOCATORS.getProperty("One_series_from_seriesList"))))
				.build().perform();
	}
	...
	public void verify_options_on_top_bar_of_window() throws Throwable {
		...
		WebElement chart = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--chart-line_large')]", 4);
		if (chart.isDisplayed()) {
			System.out.println("Chart Option is present");
		} else {
			Assert.fail("Chart option are not present");
		}
		WebElement map = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--map-filled_large')]", 4);
		if (map.isDisplayed()) {
		...
		WebElement table = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--table-vertical_large')]", 4);
		if (table.isDisplayed()) {
			System.out.println("Table Option is present");
		} else {
			Assert.fail("Table option not present");
		}
		WebElement pie = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--pie_chart-pie_large')]", 4);
		if (pie.isDisplayed()) {
			System.out.println("Pie Option is present");
		} else {
			Assert.fail("Pie option not present");
		}
		WebElement heatmap = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--heatmap_large')]", 4);
		if (heatmap.isDisplayed()) {
			System.out.println("Heat map Option is present");
		} else {
			Assert.fail("Heat map option not present");
		}
		WebElement histogram = CommonFunctionality.getElementByXpath(login.driver,
				"//div[contains(@class,'icon--histogram_large')]", 4);
	...
	public void the_series_should_add_into_right_pane() throws Throwable {
		CommonFunctionality.wait(1000);
		String series_item_name = login.driver.findElement(By.xpath("(//div[@class='series-item--name'])[1]")).getText();
		CommonFunctionality.wait(1000);
	...
	public void any_insight_could_be_selected_for_the_series_to_add() throws Throwable {
		CommonFunctionality.wait(2000);
		List<WebElement> insights_all = login.driver
				.findElements(By.xpath("//div[@class='add-to-insights__list']//div"));
		...
		String expected = CommonFunctionality.getElementByXpath(login.driver,
				"//*[@class='growl-message--link growl-message--link__highlighted'] | //*[@class='growl-message growl-success']//*[@class='button growl-message-content--btns__fill']",
				4).getText();

		if (expected.contains("Name your insight")) {
			login.Log4j.info("Add to existing insight has been verified");
			login.driver.findElement(By.xpath("//button[@class='button  button__primary'][contains(text(),'Refresh')]"))
					.click();
		} else {
	...
	public void click_on_suggestions_subscription_link(String arg1) throws Throwable {
		...
		try {
			Thread.sleep(2000);
			// manage_series_id =
			// login.driver.findElement(By.xpath("//*[@class='main-series-information--right']//*[@class='main-series-information--series-id']/div[1]")).getText();
			manage_series_id = login.driver
					.findElement(By.xpath("(//span[@class='series-information--info-value'])[1]")).getText();
			login.driver.findElement(By.xpath(
					"//span[@class='single-series-preview-actions--manage-replacements button button__sm button__special']"))
					.click();
	...
	public void click_on_and_buttons(String arg1, String arg2, String arg3) throws Throwable {
		...
		try {
			login.driver.findElement(By.xpath(
					"//button[@class='button button__sm button__secondary_purple suggested-series-control--add']//*[contains(text(),'"
							+ arg1 + "')]"))
					.click();
		} catch (Exception j) {
	...
	@And("^Click on \"([^\"]*)\" , \"([^\"]*)\" and \"([^\"]*)\" button$")
	public void click_on_and_button(String arg1, String arg2, String arg3) throws Throwable {
		CommonFunctionality.wait(3000);
		try {
			login.driver
					.findElement(By
							.xpath("//div[@class='series-with-suggestions-mode']//*[contains(text(),'" + arg1 + "')]"))
					.click();
		} catch (Exception j) {
			suggested_series = login.driver.findElement(By.xpath("//div[@class='suggested-series-item--title']"))
					.getText();
	...
	public void chart_should_be_created_in_a_view_for_series() throws Throwable {
		...
		String expected = login.driver
				.findElement(By.cssSelector(".highcharts-title .text-dots , span[data-name='title']")).getText();
	...
	public void click_on_Download_button() throws Throwable {
		...
		login.driver.findElement(By.xpath("(//span[@class='download-button--text drop-down-button--label'])[2]"))
				.click();
	...
	public void verify_the_of_the_series_should_be(String arg1, String arg2) throws Throwable {
		...
		String actual = login.driver
				.findElement(By.xpath("(//*[contains(text(),'" + arg1 + "')]//following::div//span)[1]")).getText();
	...
	public void verify_the_of_the_series_should_be11(String arg1, String arg2) throws Throwable {
		...
		String expected = arg2;
		String actual = login.driver.findElement(By.xpath("(//*[contains(text(),'" + arg1
				+ "')]//following::div[@class='main-series-information--field-value'])[1]")).getText();
	...
	public void Enter_some_text_in_the_update_request_popup_opened() throws Throwable {
		...
		if (login.driver.findElements(By.xpath(login.LOCATORS.getProperty("Submit_button_in_update"))).size() == 1) {
			...
			// WebElement submit =
			// login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Submit_button_in_update")));
			// if (submit.isEnabled()) {
			// submit.click();
			...
			CommonFunctionality.wait(6000);
			new Actions(login.driver).moveToElement(login.driver.findElement(By.className("movable-modal--close")))
					.click().build().perform();
	...
	public void click_on_Related_data_tab() throws Throwable {
		login.driver.findElement(By.xpath("//div[@class='single-series-preview-actions--related-container'][2]"))
				.click();
		CommonFunctionality.wait(500);
	}
	...
	public void in_Chart_tab_click_on_timeframe_date_field_and_change_date() throws Throwable {
		...
		CommonFunctionality.wait(500);
		// login.driver.findElement(By.xpath("//*[@class='dropdown--button
		// public-js-views-insight_visuals-chart-parts-range_controls-picker-date_picker_dropdown-module__date_picker_header']")).click();
		...
		// login.driver.findElement(By.xpath("//span[contains(text(),'No end
		// date')]")).click();
		// CommonFunctionality.wait(500);
		...
		dateto = login.driver.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[2]"))
				.getText();
	...
	public void select_tab(String arg1) throws Throwable {
		 ...
		 * login.driver.findElement(By.xpath("//*[@data-tab='views']")).click(); } else
		 * { String tab = arg1.toLowerCase(); try { login.driver .findElement(By.xpath(
		 * "//*[@data-tab='" + tab + "']")) .click(); } catch
		 * (org.openqa.selenium.StaleElementReferenceException ex) {
		 * 
		 * login.driver .findElement(By.xpath( "//*[@data-tab='" + tab + "']"))
	...
	public void select_tabs(String arg1, String arg2, String arg3, String arg4, String arg5) throws Throwable {
		...
		login.driver
				.findElement(
						By.xpath("//*[@class='zoom-button button button__sm']//*[contains(text(),'" + arg1 + "')]"))
				.click();
		CommonFunctionality.wait(3000);
		...
		start_ytd = ytd_start.substring(3);
		end_ytd = ytd_end.substring(3);
		
		login.driver
				.findElement(
						By.xpath("//*[@class='zoom-button button button__sm']//*[contains(text(),'" + arg2 + "')]"))
				.click();
		...
		String y1_end = login.driver
				.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[1]")).getText();
		start_1y = y1_start.substring(3);
		end_1y = y1_end.substring(3);
		login.driver
				.findElement(
						By.xpath("//*[@class='zoom-button button button__sm']//*[contains(text(),'" + arg3 + "')]"))
				.click();
		CommonFunctionality.wait(5000);
		String y3_start = login.driver.findElement(By.xpath("//*[contains(@class,'highcharts-xaxis-labels')]/*[3]"))
				.getText();
		String y3_end = login.driver
				.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[1]")).getText();
		start_3y = y3_start.substring(3);
		end_3y = y3_end.substring(3);
		login.driver
				.findElement(
						By.xpath("//*[@class='zoom-button button button__sm']//*[contains(text(),'" + arg4 + "')]"))
				.click();
		CommonFunctionality.wait(5000);
		...
		String y5_end = login.driver
				.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[1]")).getText();
		start_5y = y5_start.substring(3);
		end_5y = y5_end.substring(3);
		login.driver
				.findElement(
						By.xpath("//*[@class='zoom-button button button__sm']//*[contains(text(),'" + arg5 + "')]"))
				.click();
		CommonFunctionality.wait(5000);
		...
		String All_end = login.driver
				.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[1]")).getText();
		start_All = All_start.substring(3);
		end_All = All_end.substring(3);
	}
	...
	public void last_year_year_year_data_to_be_plotted_in_chart_visual(int arg1, int arg2, int arg3, String arg4)
		...
		if ((B == A) || (B < A)) {
			...
			login.Log4j.info("Chart has been verified with YTD data");
		} else {
			Assert.fail("Verification Failed");
		}
		...
		if (Math.abs(D - C) == arg1) {
			...
			login.Log4j.info("Chart has been verified with " + arg1 + " year data");
		} else {
			Assert.fail("Verification Failed");
		}
		...
		if (Math.abs(F - E) == arg2) {
			...
			login.Log4j.info("Chart has been verified with " + arg2 + " year data");
		} else {
			Assert.fail("Verification Failed");
		}
		...
		if (Math.abs(H - G) == arg3) {
			...
			login.Log4j.info("Chart has been verified with " + arg3 + " year data");
		} else {
			Assert.fail("Verification Failed");
		}
		if (!(start_All.equals(end_All))) {
			// System.out.println("Chart has been verified with " + arg4 + " data");
			login.Log4j.info("Chart has been verified with " + arg4 + " data");
		} else {
			Assert.fail("Verification Failed");
		}
		// CommonFunctionality.Views_list();
	...
	public void recently_updated_timepoints_within_days_should_highlight_in_blue_color(int arg1) throws Throwable {
		...
		try {
			...
			login.driver.findElement(By.xpath("(//*[@class='preview-series-data']//*[@class='tabs__tab-item'])[1]"))
					.click();
	 ...
	 * 
	 * 
	 * // get the data from dataTab login.driver.findElement(By.xpath(
	 * "(//*[@class='preview-series-time-points--point-value'])[1]")).getCssValue(
	 * add_to_recent_insight);
	 * 
	 * 
	 * 
	 * 
	 * List<WebElement> color = login.driver.findElements(By.
	 * xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden')]"
	 * )); int len = color.size(); WebElement blue = login.driver.findElement(By.
	 * xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden')]["
	 * +len+"]")); if (blue.getAttribute("fill").contains("#2B60D0")) {
	 * System.out.println("Recently updated timepoints within " + arg1 +
	 * " days is highlighting in blue color"); } else {
	 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Close"))).click
	 * (); Assert.fail("Verification Failed"); } } catch
	 * (StaleElementReferenceException e) { List<WebElement> color =
	...
	/*
	 * 
	 * try { List<WebElement> color = login.driver.findElements(By.
	 * xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden')]"
	 * )); int len = color.size(); int len2 = color.size()-1; WebElement orange =
	 * login.driver.findElement(By.
	 * xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden')]["
	 * +len+"]")); WebElement orange2 = login.driver.findElement(By.
	 * xpath("//*[@class='highcharts-point' and not(@visibility='hidden') or @class='highcharts-point ' and not(@visibility='hidden')]["
	 * +len2+"]")); if(orange.getAttribute("fill").contains("#FFA500")) {
	...
	public void should_display_chart_for_timepoints_within_that_timeframe_range() throws Throwable {
		String range = login.driver
				.findElement(By.xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']")).getText();
		if (range.contains(datefrom) && range.contains(dateto)) {
			// if (start.contains(datefrom)) {
			// System.out.println("Start date & end date has been verified successfully");
			login.Log4j.info("Start date & end date has been verified successfully");
			CommonFunctionality.wait(500);
			...
			/*
			 * String end = login.driver .findElement(By.
			 * xpath("//*[@class='highcharts-axis-labels highcharts-xaxis-labels']/*[2]")).
			 * getText(); if (end.contains(dateto)) {
			 * System.out.println("End date has been verified successfully");
			 */

			/*
			 * if(login.driver.findElements(By.xpath(login.LOCATORS.getProperty("Close"))).
			 * size()>0) { CommonFunctionality.Hidden_Webelements_handling(login.driver,
			 * "className", "movable-modal--close"); }
			 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Series_tab"))).
			 * click(); CommonFunctionality.DeleteSeries();
			 * if(login.driver.findElements(By.xpath("//*[text()='Delete series']")).size()>
			 * 0) { login.driver.findElement(By.xpath("//*[text()='Ok']")).click(); } }else
			 * {
			 * if(login.driver.findElements(By.xpath(login.LOCATORS.getProperty("Close"))).
			 * size()>0) { CommonFunctionality.Hidden_Webelements_handling(login.driver,
			 * "className", "movable-modal--close"); }
			 ...
			 * click(); CommonFunctionality.DeleteSeries();
			 * if(login.driver.findElements(By.xpath("//*[text()='Delete series']")).size()>
			 * 0) { login.driver.findElement(By.xpath("//*[text()='Ok']")).click(); }
			 */
	...
	public void close_the_replacement_popup_if_appeared() throws Throwable {
		if (login.driver
				.findElements(By.xpath(
						"//*[contains(@class,'movable-modal--title')]//*[text()='Latest changes in your Insight']"))
				.size() > 0) {
			boolean check = login.driver
					.findElement(By.xpath("//*[text()='Do not show again']/preceding-sibling::input")).isSelected();
			if (check == false) {
				new Actions(login.driver)
						.moveToElement(CommonFunctionality.getElementByXpath(login.driver,
								"//*[text()='Do not show again']/preceding-sibling::span", 4))
						.click().build().perform();
			}
			CommonFunctionality.getElementByXpath(login.driver,
					"//*[contains(@class,'button__secondary_purple') and text()='Dismiss']", 4).click();
		}
	}
	...
	public void click_on_mnemonic_hyperlink() throws Throwable {
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[@class='single-series-preview--operations'][2]//span[2]")));
		mnemonic_code_id = login.driver
				.findElement(By.xpath("//div[@class='single-series-preview--operations'][2]//span[2]")).getText();
		System.out.println(mnemonic_code_id);
		login.driver.findElement(By.xpath("//div[@class='single-series-preview--operations'][2]//span[2]")).click();
		Thread.sleep(1000);
	...
	public void verify_the_Series_id_should_be(String arg1) throws Throwable {
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='series-information--id']")));
		String id = login.driver.findElement(By.xpath("//div[@class='series-information--id']")).getText();
		if (id.contains(arg1)) {
	...
	public void sr_code_has_to_be(String arg1) throws Throwable {
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//div[@class='single-series-preview--operations'][1]")));
		String SR = login.driver.findElement(By.xpath("//div[@class='single-series-preview--operations'][1]"))
				.getText();
		if (SR.contains(arg1)) {
	...
	public void mnemonic_code_should_be(String arg1) throws Throwable {
		String Mnemonic = login.driver.findElement(By.xpath("//div[@class='single-series-preview--operations'][2]"))
				.getText();
	...
	public void respective_remarks_of_series_should_display() throws Throwable {
		...
		// String values =
		// login.driver.findElement(By.xpath("//*[@class='main-series-information--remark-item'][2]")).getText();
		// String values1 =
		// login.driver.findElement(By.xpath("//*[@class='main-series-information--remark-item'][3]")).getText();
	...
	public void navigate_to_search_result_of_same_series_in_series_pane() throws Throwable {
		...
		String mnemonic_text = login.driver
				.findElement(By.xpath("//td[contains(text(),'Mnemonic')]/following-sibling::*")).getText();
	...
	public void clicking_indicator_drop_down() throws Throwable {
		...
		CommonFunctionality.wait(500);
		login.driver.findElement(By.xpath(
				"//div[@class='main-series-information--indicator']//span[@class='main-series-information--link'][1]"))
				.click();
	...
	public void click_on_name(String arg1) throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"(//div[@class='main-series-information--field-name'])[4]//following::div[@class='main-series-information--field-value main-series-information--link']")));
		login.driver.findElement(By.xpath(
				"(//div[@class='main-series-information--field-name'])[4]//following::div[@class='main-series-information--field-value main-series-information--link']"))
				.click();
	...
	public void click_on_button(String arg1) throws Throwable {
		...
		if (arg1.equalsIgnoreCase("Preview")) {
			...
			// new
			// Actions(login.driver).moveToElement(preview).click(preview).build().perform();
		} else if (arg1.equalsIgnoreCase("Search")) {
			CommonFunctionality
					.getElementByXpath(login.driver,
							"//*[@class='modal-window modal-window__active']//*[contains(text(),'" + arg1 + "')]", 10)
					.click();
			...
			CommonFunctionality
					.getElementByXpath(login.driver,
							"//*[contains(@class,'movable-modal__active')]//*[contains(text(),'" + arg1 + "')]", 10)
					.click();
	...
	public void click_on_tab(String arg1) throws Throwable {
		 ...
		 * CommonFunctionality.wait(5000); login.driver .findElement(By.
		 * xpath("//*[contains(@class,'operations--related') and @js-related-insights=\"\"]"
		 * )) .click(); } else { login.driver
		 * .findElement(By.xpath("//*[@class='tabs__tabs-box']//*[contains(text(),'" +
		 * arg1 +
		 * "')] | //*[contains(@class,'operations--related') and @js-related-datasets=\"\"]"
		 * )) .click(); }
		 */

		login.driver.findElement(By.xpath("//div[@class='tabs__tab-item'][contains(text(),'Data')]")).click();
		CommonFunctionality.wait(1000);
	}

	@And("^Click on the \"([^\"]*)\" tab$")
	public void click_on_the_tab(String arg1) throws Throwable {

		login.driver.findElement(By.xpath(
				"//div[@class='single-series-preview-actions--related single-series-preview-actions--related__insights']"))
				.click();
		CommonFunctionality.wait(1000);
	}
	...
	public void check_contents_inside_Related_data() throws Throwable {
		CommonFunctionality.wait(1000);
		Boolean Related_data = login.driver
				.findElement(By.xpath("//div[@class='single-series-preview-actions--related']")).isDisplayed();
		Boolean Related_insight = login.driver.findElement(By.xpath(
				"//div[@class='single-series-preview-actions--related single-series-preview-actions--related__insights']"))
				.isDisplayed();

		if (Related_data == true && Related_insight == true) {
	...
	public void observe_full_data_display() throws Throwable {
		...
		System.out.println("Dates displayed " + obs_date);
	}
...
//		jse.executeScript("arguments[0].click();", apply);
			...
			// String a =
			// login.driver.findElement(By.xpath("//*[@class='series-name-field--series-name']")).getText();
			// System.out.println(a);
			WebElement seriess = login.driver.findElement(By.xpath("//span[@class='series-name-field--text']"));
		...
		//	b = login.driver.findElement(By.xpath("//*[@class='series-functions-title']")).getText();
			...
			b = login.driver.findElement(By.xpath("(//td[@class='ZWIWBTEmdUe4e_gnuHOw nfnBRpaJ0CSBYW8UqGWU'])[3]")).getText();
			...
			CommonFunctionality.wait(200);
			// WebElement apply =
			// login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Functions_apply")));
			// jse.executeScript("arguments[0].click();", apply);
	...
	public void drop_down_should_display_indicators_list_and_clicking_on_specific_indicators_should_navigate_to_results_page()
		...
		List<WebElement> dropdown_list = login.driver
				.findElements(By.xpath("//*[@class='main-series-information--indicator']"));
	...
	public void selecting_indicator_from_indicator_dropdown_should_show_search_result_in_left_for_same_indicator()
		...
		for (int i = 0; i < dropdown_list.size(); i++) {
			...
			System.out.println("Indicators list are : \n" + values);
			indicator_value = dropdown_list.get(0).getText();
			System.out.println("Indicators value: \n" + indicator_value);
			dropdown_list.get(0).click();
		}
		CommonFunctionality.wait(500);
		login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Close"))).click();
		...
		String expected = login.driver.findElement(By.xpath("//*[contains(text(),'Indicator')]/following-sibling::*"))
				.getText();
		if (indicator_value.contains("Demographic and Labour Market")) {
			login.Log4j
	...
	public void it_should_apply_source_filter_in_search_pane_to_display_it_s_result() throws Throwable {
		CommonFunctionality.wait(2000);
		String actual = login.driver
				.findElement(By.xpath("((//div[@class='main-series-information--field-name'])[4]//following::div)[1]"))
				.getText();
		...
		// String expected =
		// login.driver.findElement(By.xpath("//*[contains(text(),'Source')]/following-sibling::*")).getText();

		// String expected =
		// login.driver.findElement(By.xpath("(//*[contains(text(),'Source:')]//following::div[@class='main-series-information--field-value
		// main-series-information--link'])")).getText();

		Thread.sleep(2000);
		String expected = login.driver.findElement(By.xpath("(//*[contains(text(),'Source')]//following::div)[1]"))
				.getText();
	...
	public void footnotes_window_should_be_displayed_with_related_details() throws Throwable {
		...
		/*
		 * String a =
		 * login.driver.findElement(By.xpath("//div[contains(text(),'Footnotes')]")).
		 * getText(); String b = "Footnotes"; if (a.contains(b)) { Thread.sleep(5000);
		 * login.driver.findElement(By.xpath(
		 * "//*[@class='footnotes-modal']/following::*[@title='Close']")).click(); }
		 * else { Assert.fail(); }
		 */

		/*
		 * String a = login.driver.findElement(By.xpath(login.LOCATORS.getProperty(
		 * "footnotes_title_text"))).getText(); String b = "Footnotes"; String c =
		 * login.driver.findElement(By.xpath("//*[@class='footnotes-modal--name']/*")).
		 * getText(); String d =
		 * login.driver.findElement(By.className("series-preview-modal-header--link")).
		 * getText();
		 * 
		 * if (a.contains(b)) { login.driver.findElement(By.xpath(
		 * "//*[@class='footnotes-modal']/following::*[@title='Close']")).click(); } if
		 * (c.contains(d)) { login.Log4j.
		 * info("Footnotes window is displayed with related details and it has been verified"
		 * );
		 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Close"))).click
		 * (); CommonFunctionality.DeleteSeries(); } else {
		 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty("Close"))).click
		 * (); CommonFunctionality.DeleteSeries(); Assert.fail("Verification failed"); }
		 */
	}
	...
	public void complete_observations_must_be_displayed() throws Throwable {
		...
		String obs1 = obs_date.substring(0, 2);
		String obs2 = obs_date.substring(5);
	...
	public void click_on_first_link_available_under_and_verify_the_changes(String arg1) throws Throwable {
		if (login.driver
				...
				.isDisplayed()) {
			List<WebElement> related = login.driver.findElements(By.xpath("//*[@class='series-data-set--table-name']"));
			for (WebElement rel : related) {
				CommonFunctionality.wait(1000);
				String actual = login.driver.findElement(By.xpath("//*[@class='series-data-set--table-name']"))
						.getText();
				rel.click();
	...
	public void check_the_data_of_first_insight() throws Throwable {
		List<WebElement> insights = login.driver
				.findElements(By.xpath("//div[@class='insight-table-item--title-wrapper text-dots']"));
		for (WebElement insight : insights) {
			String actual = insight.getText();
			insight.click();
			CommonFunctionality.wait(1000);
			String expected = CommonFunctionality
					.getElementByXpath(login.driver, "//*[contains(@class,'insight-preview--title')]", 4).getText();
	...
	public void check_the_data_of_second_insight() throws Throwable {
		// CommonFunctionality.getElementByXpath(login.driver,
		// "//*[@js-related-insights='']", 4).click();
		List<WebElement> insights = login.driver
				.findElements(By.xpath("(//*[contains(@class,'link insight-table-item--title-link text-dots')])[2]"));
		for (WebElement insight : insights) {
			String actual = insight.getText();
			insight.click();
			CommonFunctionality.wait(1000);
			/*
			 * if (login.driver.findElements(By.xpath(
			 * "//*[contains(@class,'sphere-modal__content')]//*[text()='Continue']"))
			 * .size() > 0) { CommonFunctionality.getElementByXpath(login.driver,
			 * "//*[contains(@class,'sphere-modal__content')]//*[text()='Continue']",
			 * 4).click(); }
			 */
...
//		}
	...
	public void the_discontinued_series_has_to_be_replaced_with_suggested_series_into_right() throws Throwable {
		...
		WebElement one_series = login.driver
				.findElement(By.xpath("//*[@class='series-name-wrapper ']//*[@class='series-name-field-title']"));
		new Actions(login.driver).moveToElement(one_series).pause(4000).click().build().perform();
		CommonFunctionality.wait(200);
		String replaced_text = login.driver
				.findElement(By.xpath("(//span[@class='series-information--info-value'])[1]")).getText();
	...
	@Then("^Suggested series has to be added into right pane into the same insight$")
		...
		WebElement one_series = login.driver.findElement(By.xpath("(//*[@class='series-name-field--text'])[2]"));
		new Actions(login.driver).moveToElement(one_series).build().perform();

		String suggested_series1 = login.driver.findElement(By.xpath("(//*[@class='series-name-field--text'])[2]"))
				.getText();
	...
	public void both_inactive_and_suggestion_should_be_viewed_as_chart() throws Throwable {
		CommonFunctionality.wait(1000);
		List<WebElement> element = login.driver.findElements(
				By.xpath("//*[contains(@class,'legend-item')]//*[contains(@class,'series-edit--title')]"));
		if (element.size() > 1) {
	...
	public void ssp_should_be_opened_for_the_series_and_series_name_should_be_suffixed_with_function_name()
			throws Throwable {
		CommonFunctionality.wait(1000);
		String function_title = login.driver.findElement(By.xpath("//*[@class='series-functions--modal-title-label']"))
				.getText();
		...
		if (function_title.equalsIgnoreCase(value)) {
