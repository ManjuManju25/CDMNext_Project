...
//							.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--name']"));
//					SeriesNames = copiedSeries.getText();
			...
			Thread.sleep(2000);
			rightClickElement = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--name']"));
...
//			List<WebElement> li_All = ul_element.findElements(By.tagName(login.LOCATORS.getProperty("List")));
			...
			if (sName.size() > 0) {
				for (int i = 0; i < sName.size(); i++) {
					...
					element = login.driver
							.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-list-item--info-icon-i']"));
					element.click();
	...
	public void click_on(String arg1) throws Throwable {
		...
		case "Expand all":
			...
			// CommonFunctionality.getElementByXpath(login.driver,
			// "//*[@class='database-representation--state-actions']/*[2]//*[contains(text(),'"
			// + arg1 + "')]",4)
			// .click();
		...
		case "Collapse all":
			...
			// CommonFunctionality.getElementByXpath(login.driver,"//*[contains(text(),'" +
			// arg1 + "')]",6).click();
			CommonFunctionality.getElementByXpath(login.driver, "//*[@title='Collapse tree']", 10).click();
			break;
		...
		case "Ok":
			...
			try {
				CommonFunctionality
						.getElementByXpath(login.driver,
								"//*[@class='sphere-modal-controls']//button[contains(text(),'" + arg1 + "')]", 6)
						.click();
			} catch (Exception e) {
				CommonFunctionality.getElementByXpath(login.driver,
						"//*[@class='suggestions-wizard--footer-right']//button[contains(text(),'" + arg1 + "')]", 6)
		...
		case "View as Chart. Type `c`":
			...
			CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='search-series-list scrollable']/*[1]//span[@title='" + arg1 + "']", 10).click();
			break;
		case "More actions":
			CommonFunctionality.getElementByXpath(login.driver, "//ul[@class='search-series-list scrollable']/*[5]//span[@title='" + arg1 + "']", 10).click();
			break;
		case "Unselect all":
			CommonFunctionality.getElementByXpath(login.driver, "//*[contains(text(),'" + arg1 + "')]", 10).click();
			break;
		...
		case "Table properties":
			CommonFunctionality.getElementByXpath(login.driver,
					"//*[contains(@class,'mce-menu-align mce-in')]//*[@class='mce-container-body mce-stack-layout']//*[contains(text(),'"
							+ arg1 + "')]",
					15).click();
			break;
		case "Delete table":
		...
		case "Cell":
			CommonFunctionality
					.getElementByXpath(login.driver,
							"//*[contains(@class,'mce-menu-item-expand')]//*[contains(text(),'" + arg1 + "')]", 15)
					.click();
			break;
...
//						.click();
	...
	public void the_popup_should_be_appeared(String arg1) throws Throwable {
		...
		case "Selected series added to insights:":
			/*
			 * Thread.sleep(800); WebElement ele
			 * =login.driver.findElement(By.xpath(login.LOCATORS.getProperty(
			 * "second_insight"))); ele.click(); Thread.sleep(2000);
			 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty(
			 * "Add_to_insights"))).click();
			 */
			Thread.sleep(500);
			element = login.driver.findElement(By.xpath(login.LOCATORS.getProperty("growl_message_popup")));
			String confirm_msg = element.getText();
	...
	public void select_indicator_as(String arg1, String arg2) throws Throwable {
		...
		if (crossIcon.size() > 0) {
			CommonFunctionality.getElementByXpath(login.driver, "//*[text()='All']", 5).click();
			login.Log4j.info("Selecting indicator " + arg1 + " as " + arg2);
			Thread.sleep(2000);
			login.driver
					.findElement(
							By.xpath("//*[@class='filter-list categories-list']//*[contains(text(),'" + arg1 + "')]"))
					.click();
			login.driver.findElement(By.xpath("//*[@class='filter-list']//*[contains(text(),'" + arg2 + "')]")).click();
		} else {
...
//			List<WebElement> li_All = ul_element.findElements(By.tagName(login.LOCATORS.getProperty("List")));
			...
			if (li_All.size() > 0) {
				for (int i = 0; i < li_All.size(); i++) {
					...
					int j = i + 1;
					// checkbox = login.driver
					// .findElement(By.xpath("//li[" + j +
					// "]//div[@class='series-list-item--checkbox-wrapper']"));
					// CommonFunctionality.action.moveToElement(checkbox).click().build().perform();
					// Thread.sleep(1000);
					element = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--name']"));
					action.moveToElement(element).build().perform();
					Thread.sleep(500);
...
//			List<WebElement> li_All = ul_element.findElements(By.tagName(login.LOCATORS.getProperty("List")));
			...
			statusIcon = login.driver.findElements(By.xpath(
					"//ul[@class='search-series-list']/*//*[@class='series-item--status-icons']//*[@class='status-icon status-icon__has-forecast']"));
			}
	...
	public void create_any_visual() throws Throwable {
		...
		CommonFunctionality.getElementByProperty(login.driver, "Series", 20).click();
		CommonFunctionality.wait(1000);
		WebElement ele = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[1]//*[@class='series-item--name']"));
...
//			login.Log4j.info("List size is :" + li_All.size());
				...
				for (int i = 0; i < sName.size(); i++) {
					...
					if (j == sName.size()) {
						...
						addSeries_dropdown = login.driver
								.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='add-to-data-selection--toggle']"));
			...
			/*
			 * Thread.sleep(2000); addSeries_dropdown = login.driver
			 * .findElement(By.xpath("//li[" + j +
			 * "]//div[@class='add-to-data-selection--toggle']"));
	...
	public void click_on_icon_on_series() throws Throwable {
		...
		try {
			...
			AssertJUnit.assertNotNull(ul_element);
//			List<WebElement> li_All = ul_element.findElements(By.tagName(login.LOCATORS.getProperty("List")));
			List<WebElement> li_All = login.driver.findElements(By.xpath("//ul//div[contains(@class,'container__with_actions')]"));
			login.Log4j.info("List size is :" + li_All.size());
			List<WebElement> sName = login.driver.findElements(By.xpath("//ul//div[@class='series-item--name']"));
			if (li_All.size() > 0) {
				for (int i = 0; i < li_All.size(); i++) {
					j = i + 1;
					CommonFunctionality.wait(1000);
					...
					login.Log4j.info(SeriesNames);
					checkbox = login.driver
							.findElement(By.xpath("//div[contains(@class,'container__with_actions')][" + j + "]//div[@class='series-list-item--checkbox-wrapper']"));
					checkbox.click();
					if (j == li_All.size()) {
						action.pause(300).moveToElement(sName.get(i)).build().perform();
						CommonFunctionality.wait(800);
						addIcon = login.driver
								.findElement(By.xpath("//div[contains(@class,'container__with_actions')][" + j + "]//div[@class='add-to-data-selection--icon']"));
						Thread.sleep(800);
						addIcon.click();
					}
				}
			...
			/*
			 * login.Log4j.info(j); Thread.sleep(3000); addIcon =
			 * login.driver.findElement(By.xpath("//li[" + j +
			 * "]//div[@class='add-to-data-selection--icon']")); Thread.sleep(1000);
			 * addIcon.click();
			 */
		} catch (NoSuchElementException e) {
			Assert.fail("WebElement is null " + e.getMessage());
	...
	public void the_series_should_be_added_to_selected_insight() throws Throwable {
		...
		//confirmPopup = CommonFunctionality.getElementByProperty(login.driver, "", 6);
	...
	/*
	 * @When("^Hover the mouse on any filter and click on Pin$") public void
	 * hover_the_mouse_on_any_filter_and_click_on_Pin() throws Throwable {
	 * login.Log4j.info("Clicking on Pin"); element =
	 * login.driver.findElement(By.xpath(login.LOCATORS.getProperty(
	 * "filter_by_indicator"))); Thread.sleep(2000);
		...
		if (li_All.size() > 0) {
			for (int i = 0; i < li_All.size(); i++) {
				...
				if (arg1.equalsIgnoreCase("NEW")) {
					element = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j
					...
					element = login.driver.findElement(By
							.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--status-icons']//*[@title='Key series']"));
					strLabel = element.getText();
				} else if (arg1.equalsIgnoreCase("f")) {
					element = login.driver.findElement(By.xpath(
							"//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--status-icons']//*[@title='Forecast series']"));
					strLabel = element.getText();
...
//			List<WebElement> li_All = ul_element.findElements(By.tagName(login.LOCATORS.getProperty("List")));
			...
			if (li_All.size() > 0) {
				for (int i = 0; i < li_All.size(); i++) {
					...
					int j = i + 1;
					Thread.sleep(3000);
					ele = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--name']"));
					action.moveToElement(ele).build().perform();
					wait.until(ExpectedConditions
							.visibilityOfElementLocated(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//*[@title='Open footnote']")))
							.click();
					Thread.sleep(1200);
	...
	public void select_series() throws Throwable {
		...
		CommonFunctionality.wait(500);
		ul_element = login.driver.findElement(By.cssSelector(login.LOCATORS.getProperty("UL")));
		List<WebElement> li_All = ul_element.findElements(By.xpath("/*//*[@class='series-item--name']"));
		login.Log4j.info("List size is :" + li_All.size());
		for (int i = 0; i < li_All.size(); i++) {
			Thread.sleep(500);
			int j = i + 1;
	...
	public void select_series_and_Click_on_More_actions() throws Throwable {
		...
		for (int i = 0; i < li_All.size(); i++) {
			...
			checkbox = login.driver
					.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-list-item--checkbox-wrapper']"));
			checkbox.click();
			copiedSeries = login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//div[@class='series-item--name']"));
			SeriesNames = copiedSeries.getText();
			login.Log4j.info(SeriesNames);
			Copy.add(SeriesNames);
			...
			if (i == 1 || i == 0 && li_All.size() == 1) {
				...
				// "]//div[@class='series-item-information']"));
				new Actions(login.driver).pause(500).moveToElement(ele).build().perform();
				Thread.sleep(700);
				login.driver.findElement(By.xpath("//ul[@class='search-series-list']/*[" + j + "]//span[@title='More actions']")).click();
			}
		}
	}
	...
	public void scroll_down_and_set_showing_results_as_per_page(String arg1) throws Throwable {
		...
		// .findElement(By.xpath("//div[@class='search-input-field--item
		// search-input-button']"));
	...
	public void results_should_display_in_a_page(String arg1) throws Throwable {
		...
		ul_element = login.driver.findElement(By.cssSelector(login.LOCATORS.getProperty("UL")));
		List<WebElement> li_All = ul_element.findElements(By.xpath("//ul[@class='search-series-list']/*"));
		login.Log4j.info("List size is :" + li_All.size());
		...
		/*
		 * if (li_All.size() > 0) { for (int i = 0; i < li_All.size(); i++) {
		 * Thread.sleep(2000); int j = i + 1; WebElement checkbox = login.driver
		 * .findElement(By.xpath("//li[" + j +
		 * "]//div[@class='series-list-item--checkbox-wrapper']")); checkbox.click();
		 * jse.executeScript("arguments[0].scrollIntoView(true);", checkbox); }
		 * 
		 * Thread.sleep(2000); WebElement ele = login.driver.findElement(By.xpath(
		 * "//span[@class='search-input--selected-count']")); String count =
		 * ele.getText(); int SeriesCount = Integer.parseInt(count); int resultsPer_page
		 * = Integer.parseInt(arg1); login.Log4j.info("Selected series count is :" +
		 * SeriesCount); if (resultsPer_page == SeriesCount) { login.Log4j.info(arg1 +
		 * " series are displayed as per the selection");
		 * 
		 * } else { Assert.fail(arg1 +
		 * " series are not displayed as per the selection"); }
		 */
		/*
		 * Thread.sleep(2000); element = login.driver.findElement(By.xpath(
		 * "//div[@class='search-series-pagination-count']")); element.click();
		 * Thread.sleep(1500);
		 * login.driver.findElement(By.xpath("//*[@value='20']")).click();
		 */
	}
