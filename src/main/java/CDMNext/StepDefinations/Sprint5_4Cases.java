...
public class Sprint5_4Cases extends CommonFunctionality {
	...
	public void user_creates_a_commentary_visual() throws Throwable {
		try {
			...
			wait.until(ExpectedConditions
					.elementToBeClickable(By.xpath(("//span[@class='insight-page-view-tab--title']")))).click();
	...
	public void download_series_base_and_transformed_to_excel() throws Throwable {
		String DOWNLOAD_DEFAULT_LOCAL_DIRECTORY = "C:\\Users\\svenkatraju\\Downloads";
		...
		ArrayList<String> arrayTimepointsSerieExcelCDM = getTimePointToExcel1(1, DOWNLOAD_DEFAULT_Remote_DIRECTORY,
				fileCDM);
	...
	public void change_the_table_visual_to_invert_mode_from_edit_visual() throws Throwable {
		...
		WebElement Invert = login.driver
				.findElement(By.xpath("//span[normalize-space(text())='Invert']/preceding-sibling::span"));
		Invert.click();
	...
	public void series_selector_is_displayed_select_series(int arg1) throws Throwable {
		WebDriverWait wait = new WebDriverWait(login.driver, 40);
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(("//input[@class='index-module_text__GTkop']"))))
				.click();
		CommonFunctionality.wait(2000);
	...
	public void click_on_Date_Header() throws Throwable {
		login.driver.findElement(By.xpath(
				"(//div[@class='public-js-views-insight_visuals-chart-parts-range_controls-picker-header-picker_header-module__calendar_icon'])[2]"))
				.click();
		CommonFunctionality.wait(2000);
	...
	public void the_number_of_series_entere_in_the_series_field_should_be_displayed_on_the_table_visual()
			throws Throwable {
		CommonFunctionality.wait(2000);
	...
	public void the_Insert_Edit_link_popup_should_be_opened() throws Throwable {
		WebElement Edit_linkPopup = login.driver
				.findElement(By.xpath("//div[normalize-space(text())='Insert/Edit Link']"));
	...
	public void the_special_character_popup_should_be_opened() throws Throwable {
		WebElement Special_CharacterPopup = login.driver
				.findElement(By.xpath("//div[normalize-space(text())='Special Character']"));
	...
	public void user_creates_a_Table_visual() throws Throwable {
		...
		WebElement ele1 = login.driver.findElement(By.xpath(
				"//div[@class='series-list-item--action-icons']/span[@title='More actions']//*[name()='svg']//*[local-name()='use'][1]"));
	...
	public void check_the_default_attributes_Name_Region_Unit_Series_ID_Frequency_should_be_present() throws Throwable {
		...
		if (attributes.contains("Name") && attributes.contains("Region") && attributes.contains("Unit")
				&& attributes.contains("Series ID")) {
	...
	public void user_creates_a_Histogram_visual() throws Throwable {
		...
		new Actions(login.driver).moveToElement(Add_chart).pause(1000).build().perform();
		login.driver.findElement(By.xpath(
				"//div[@class='public-js-views-visuals-VisualsPanelSubItem-module__subItemTitle'][normalize-space()='Histogram']"))
				.click();
	...
	public void clicks_on_Date_Picker() throws Throwable {
		CommonFunctionality.wait(2000);
		WebElement Date_picker = login.driver.findElement(By.xpath("//div[contains(@class,'calendar_icon')]"));
		Date_picker.click();
	...
	public void calendar_should_be_opened() throws Throwable {
		...
		WebElement Calendar_popup = login.driver
				.findElement(By.xpath("//div[contains(@class,'dropdown--body__open')]"));
	...
	public void selected_period_should_be_applied_to_histogram_visual() throws Throwable {
		...
		List<WebElement> Dates = login.driver
				.findElements(By.xpath("(//*[@class='highcharts-axis-labels highcharts-xaxis-labels'])[5]"));
	...
	public void hover_the_mouse_on_the_selected_indicator_full_path_should_display() throws Throwable {
		...
		WebElement Flowof_Funds = login.driver.findElement(
				By.xpath("//div[normalize-space(text())='National Accounts and Flow of Funds > Real GDP']"));
	...
	public void download_series_to_excel() throws Throwable {
		...
		login.driver
				.findElement(By.xpath(
						"//button[@class='drop-down-button--btn download-button--button button button__download-btn']"))
				.click();
		CommonFunctionality.wait(2000);
	...
	public void user_selects_any_series_and_create_a_chart_visual() throws Throwable {
		...
		WebElement First_Series = login.driver
				.findElement(By.xpath("(//div[@class='series-list-item--information'])[1]"));
	...
	public void the_growl_popup_should_display_as_series_imported() throws Throwable {
		WebElement Upload_File = login.driver.findElement(By.xpath("//div[contains(@class,'module__uploadContent')]"));
		Upload_File.click();
		CommonFunctionality.wait(2000);
		// System.out.println(System.getProperty("user.dir") + "\\AutoIT\\CEIC defined
		// template.exe");
	...
	public void user_clicks_on_open_import_series_popup() throws Throwable {
		WebElement Import_Series = login.driver
				.findElement(By.xpath("//button[normalize-space(text())='Import Series']"));
		Import_Series.click();
	...
	public void check_Note_Description() throws Throwable {
		WebElement Note = login.driver
				.findElement(By.xpath("//div[contains(@class,'module__uploaderDescriptionContentNote')]/h3"));
		if (Note.isDisplayed()) {
	...
	public void user_import_a_UDD_series() throws Throwable {
		/*
		 * WebElement
		 * Imported_Tab=login.driver.findElement(By.xpath("//span[text()='Imported']"));
		 * Imported_Tab.click(); WebElement
		 * ImportedSeries1=login.driver.findElement(By.xpath(
		 * "(//div[@class='series-item--name'])[1]"));
		 * action.moveToElement(ImportedSeries1).pause(2000).build().perform();
		 * WebElement Remove_Series=login.driver.findElement(By.
		 * xpath("//span[@title='Remove series']")); if(Remove_Series.isDisplayed()) {
		 * Remove_Series.click(); CommonFunctionality.wait(1000);
		 * login.driver.findElement(By.xpath("//button[text()='Delete forever']")).click
		 * (); System.out.println("Remove series button is clicked"); } else {
		 * System.out.println("Remove series button is not clicked"); } WebElement
		 * ImportedSeries2=login.driver.findElement(By.xpath(
		 * "(//div[@class='series-item--name'])[1]"));
		 * action.moveToElement(ImportedSeries2).pause(2000).build().perform();
		 * WebElement Remove_Series1=login.driver.findElement(By.
		 * xpath("//span[@title='Remove series']")); if(Remove_Series1.isDisplayed()) {
		 * Remove_Series1.click(); CommonFunctionality.wait(1000);
		 * login.driver.findElement(By.xpath("//button[text()='Delete forever']")).click
		 * (); System.out.println("Remove series button is clicked"); } else {
	...
	public void import_from_CDM_Next_and_Import_File_again() throws Throwable {
		...
		WebElement Import_Series = login.driver
				.findElement(By.xpath("//button[normalize-space(text())='Import Series']"));
		Import_Series.click();
		WebElement Upload_File1 = login.driver.findElement(By.xpath("//div[contains(@class,'module__uploadContent')]"));
		Upload_File1.click();
		CommonFunctionality.wait(2000);
		// System.out.println(System.getProperty("user.dir") + "\\AutoIT\\CEIC defined
		// template.exe");
		CommonFunctionality.uploadTheFileusingAutoIT(login.driver,
				...
				System.getProperty("user.dir") + "\\AutoIT\\CEIC.xlsx");
		Thread.sleep(8000);
		WebElement Data_CantUpload = login.driver
				.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']"));
	...
	public void download_attributes_to_excel() throws Throwable {
		...
		Checkbox.click();
		CommonFunctionality.wait(2000);
		WebElement Checkbox1 = login.driver
				.findElement(By.xpath("(//span[@class='series-list-item--checkbox svg-checkbox'])[2]"));
		Checkbox1.click();
		CommonFunctionality.wait(3000);
		...
		WebElement Download_Button = login.driver.findElement(By.xpath(
				"//button[@class='sphere-modal-control button insight-download__modal-button button button__download-btn']//span[contains(text(),'Download')]"));
	...
	public void search_UDD_Series_with_attributes_like_UserId_and_Category() throws Throwable {
		...
		action.moveToElement(ImportedSeries3).pause(2).click().build().perform();
	...
	public void the_spell_checker_should_be_detect_incorrect_words_in_the_Commentary_visual() throws Throwable {
		CommonFunctionality.wait(2000);
		List<WebElement> IncorrectWord = login.driver
				.findElements(By.xpath("//*[@class='mce-content-body ']//p[contains(text(),'ceic')]"));
	...
	public void user_Add_some_series_and_Table_to_My_Series() throws Throwable {
		...
		// login.driver.findElements(By.xpath("//span[@class='series-list-item--checkbox
		// svg-checkbox']"));
		...
		/*
		 * for (int i=1; i<=2; i++) { List<WebElement> list =
		 * login.driver.findElements(By.
		 * xpath("(//span[@class='series-list-item--checkbox svg-checkbox'])["+i+"]"));
		 * 
		 * WebElement list1=list.get(i); System.out.println(list1.getSize());
		 * list1.click();
		 * 
		 */
		// WebElement First_Series =
		// login.driver.findElement(By.xpath("(//div[@class='series-list-item--information'])[1]"));
		// action.moveToElement(First_Series).pause(2000).build().perform();
		...
		login.driver.findElement(By.xpath(
				"(//div[@class='add-to-data-selection--icon']/following::div[@class='add-to-data-selection--toggle'])[1]"))
				.click();
		;
		// Add_group.click();
		CommonFunctionality.wait(2000);
	...
	public void expand_Table() throws Throwable {
		...
		login.driver.findElement(By.xpath(
				"//div[@class='icon--table-vertical_large public-js-views-visuals-VisualsPanelSubItem-module__subItemIcon']"))
				.click();
	...
	public void user_clicks_on_Open_Region_filter() throws Throwable {
		...
		CommonFunctionality.wait(2000);
		login.driver.findElement(By.xpath("//span[@title='Bangalore']")).click();
	...
	public void open_any_Insight_having_series() throws Throwable {
		...
		WebElement View = login.driver
				.findElement(By.xpath("(//*[@class='insight-grid-item--buttons-item button'])[1]"));
	...
	public void copy_SR_code_Search_Insight_with_SR_code() throws Throwable {
		WebElement Search_Series = login.driver.findElement(By.xpath(
				"//div[@class='list-view-wrapper']//input[@placeholder='Filter by name, region, unit, frequency']"));
		Search_Series.click();
		...
		WebElement Search_Series1 = login.driver.findElement(By.xpath(
				"//div[@class='list-view-wrapper']//input[@placeholder='Filter by name, region, unit, frequency']"));
	...
	public void user_creates_multiple_visuals_in_single_views() throws Throwable {
		...
		login.driver.findElement(By.xpath(
				...
				.click();
		CommonFunctionality.wait(3000);
		WebElement Visual_Title = login.driver.findElement(
				By.xpath("//div[@class='visual-title--group']//span[@class='visual-title--text text-dots']"));
		Visual_Title.click();
		...
		/*
		 * CommonFunctionality.wait(2000); WebElement
		 * Add_chart=login.driver.findElement(By.
		 * xpath("//div[contains(text(),'Add chart')]")); Add_chart.click();
		 * login.driver.findElement(By.
		 * xpath("//div[@class='icon--table-vertical_large public-js-views-visuals-VisualsPanelSubItem-module__subItemIcon']"
		 * )).click();
		 */
		...
		login.driver.findElement(By.xpath(
				...
				.click();
		CommonFunctionality.wait(3000);
		WebElement Visual_Title1 = login.driver.findElement(
				By.xpath("(//div[@class='visual-title--group']//span[@class='visual-title--text text-dots'])[1]"));
		Visual_Title1.click();
		login.driver.findElement(By.xpath("(//span[@class='input-control--indicator'])[1]")).click();
		login.driver.findElement(By.xpath("//div[@class='popover--close']")).click();
	...
	public void should_be_able_to_move_the_visual() throws Throwable {
		...
		WebElement Hover = login.driver.findElement(
				By.xpath("(//div[@class='visual-title ui-draggable ui-draggable-handle visual-drag__cursor'])[2]"));
		action.moveToElement(Hover).pause(2000).build().perform();
		WebElement source = login.driver
				.findElement(By.xpath("(//div[@class='visual-title--move visual-title--icon'])[2]"));
		...
		new Actions(login.driver).moveToElement(source).pause(2000).dragAndDrop(source, target).clickAndHold().build()
				.perform();
		CommonFunctionality.wait(5000);
		WebElement Visual2 = login.driver.findElement(
				By.xpath("(//div[@class='insight-visual-container insight-visual-container__column-2'])[2]"));
	...
	public void user_Add_this_series_into_right_pane(int arg1) throws Throwable {
		...
		CommonFunctionality.wait(2000);
		login.driver.findElement(By.xpath(
				"//*[contains(@class,'series-list-item series-list-item--container')]//*[@class='series-list-item--checkbox svg-checkbox']"))
				.click();
		login.driver.findElement(By.xpath(
				"//*[contains(@class,'series-list-item series-list-item--container')]//div[@class='add-to-data-selection--icon']"))
				.click();
		CommonFunctionality.wait(3000);
		login.driver.findElement(By.xpath("//span[@class='input-control--indicator']")).click();
		CommonFunctionality.wait(3000);
	...
	public static Workbook readExcel(String fileName) {
		...
		try {
			...
			FileInputStream fileInputStream = new FileInputStream(
					new File(DOWNLOAD_DEFAULT_LOCAL_DIRECTORY + "/" + fileName));
	...
	public void openFunctionEditor() {
		...
		CommonFunctionality.wait(1000);
		/*
		 * findElementClick(By.cssSelector(".insert-function-button")); timeout(1000);
		 */
	}
	...
	public void openEditSeriesPanel() {
		if (login.driver.findElement(By.cssSelector(".fx-panel-toggle__is-open")).isDisplayed() == true) {
			...
			CommonFunctionality.wait(1000);
			login.driver
					.findElement(By.xpath("//*[@class='visual-top-panel']/*/button[contains(text(),'Edit Series')]"));
			CommonFunctionality.wait(1000);
		}
	}
	...
	public void selectArgumetsInFunctionsEditor(String argument, String numberOfArgument) {
		String setArgument = "$(\"[js-regular-parameters]>div:nth-child(" + numberOfArgument
				+ ") .select2-container.function-parameter--select a\").trigger('mousedown')";
	...
	/*
	 * @Given("^Apply Aggregate Sum, yearly, december$") public void
	 * apply_Aggregate_Sum_yearly_december() throws Throwable {
	 * 
	 * }
	 */

	/*
	 * @Then("^Download base and transformed series into excel$") public void
	 * download_base_and_transformed_series_into_excel() throws Throwable {
	 * 
	 * }
	 */
	...
	public void open_edit_visual_EditSeries_Panel() throws Throwable {
		...
		action.moveToElement(Add_Chart).pause(2000).build().perform();
		login.driver.findElement(By.xpath(
				"//div[@class='public-js-views-visuals-VisualsPanelSubItem-module__subItemTitle'][normalize-space()='Line']"))
				.click();
		/*
		 * WebElement
		 * Add_Chart=login.driver.findElement(By.xpath("//span[@title='Add chart']"));
		 * action.moveToElement(Add_Chart).pause(2000).build().perform();
		 * login.driver.findElement(By.
		 * xpath("//div[@class='icon--table-vertical_large public-js-views-visuals-VisualsPanelSubItem-module__subItemIcon']"
		 * )).click(); WebElement Edit_Table=login.driver.findElement(By.
		 * xpath("//button[normalize-space(text())='Edit Table']")); Edit_Table.click();
		 */
	...
	public void verify_the_content() throws Throwable {
		...
		List<WebElement> Data = login.driver
				.findElements(By.xpath("//div[@class='preview-series-time-points--container']"));
	...
	public void drag_and_Drop_Series() throws Throwable {
		CommonFunctionality.wait(2000);
		// WebElement
		// Hover=login.driver.findElement(By.xpath("(//div[@class='table--cell
		// table--body-cell visual-series-list--series-row'])[15]"));
		// action.moveToElement(Hover).pause(2000).build().perform();
		// WebElement source =
		// login.driver.findElement(By.xpath("//div[@class='table']//table/div[3]/div[1]/div"));
		...
		// WebElement target =
		// login.driver.findElement(By.xpath("(//div[@class='series-name--title'])[1]"));
		// WebElement target =
		// login.driver.findElement(By.xpath("(//div[@class='visual-series-name'])[3]"));

		Thread.sleep(5000);
		action.dragAndDrop(source, target).build().perform();
		// new
		// Actions(login.driver).moveToElement(source).pause(2000).dragAndDrop(source,
		// target).build().perform();
		CommonFunctionality.wait(5000);
		System.out.println("skhkj");
		if (login.driver.findElement(By.xpath("(//div[@class='series-name'])[1]")).getText()
				.equalsIgnoreCase("Consumer Price Index")) {
	...
	public void click_on_Hyperlink_CEIC_Data_Template() throws Throwable {
		WebElement CEIC_DataTemplate = login.driver
				.findElement(By.xpath("//a[normalize-space()='CEIC defined template']"));
		CEIC_DataTemplate.click();
		// CommonFunctionality.Download_to_Excel("CEIC defined template",1,1,"Series
		// Name");
	...
	public void right_click_and_click_on_View_as_Chart() throws Throwable {
		...
		login.driver.switchTo().activeElement();
		String str = login.driver.findElement(By.xpath("//div[@class='modal-content sphere-modal__content']")).getText()
				.toString();
	...
	public void check_the_series_id_and_click_on_Open_Function_editior() throws Throwable {
		...
		String str = login.driver.findElement(By.xpath("//td[contains(text(),'Series id')]/following::td[1]"))
				.getText();
	...
	public void check_the_series_id_checkbox_and_click_on_the_fx_icon_in_toolbar() throws Throwable {
		// login.driver.findElement(By.xpath("//span[@class='table-container--checkbox
		// svg-checkbox input-control__grey']")).click();
		a.moveToElement(login.driver.findElement(By.xpath("//span[@class='series-name-field--text']"))).build()
				.perform();
	...
	public void select_any_unit_multiplier(String arg1) throws Throwable {
		WebElement quickfun = login.driver.findElement(
				By.xpath("//div[contains(text(),' Unit multiplier')]/following::div[@data-id='UNIT_" + arg1 + "']"));
	...
	public void hover_on_the_PoP_function() throws Throwable {
		a.moveToElement(login.driver.findElement(
				By.xpath("//div[contains(text(),' Calculate change')]/following::div[contains(text(),'%PoP')]")))
				.build().perform();
	...
	public void it_should_display_as_follows() throws Throwable {
		String str = " ";
		List<WebElement> hover = login.driver
				.findElements(By.xpath("//div[@class='tooltip tooltip__visible']/div/div"));
		for (WebElement mouse : hover) {
			str = str + mouse.getText();
		}
		System.out.println(str);
		Assert.assertEquals(str,
				" % Period-over-Period (%PoP)Syntax: %CHANGE(Over Period; 1; No)Description: Gets the percentage change over time");
	...
	public void click_on_Edit_Views() throws Throwable {
		...
		Assert.assertEquals(login.driver
				.findElement(By.xpath("//div[contains(text(),'View 2')]/following::div[@title='Chart']")).isEnabled(),
				true);
	...
	public void drag_the_view_and_drop_in_view(int arg1, int arg2) throws Throwable {
		...
		a.dragAndDrop(
				login.driver.findElement(By.xpath("//div[contains(text(),'View 2')]/following::div[@title='Chart']")),
				login.driver
						.findElement(By.xpath("//div[contains(text(),'View 1')]/following::div[@title='Chart'][1]")))
				.build().perform();
		Thread.sleep(2000);
		Assert.assertEquals(
				login.driver.findElement(By.xpath("//div[contains(text(),'View 1')]/following::div[@title='Chart'][2]"))
						.isDisplayed(),
				true);
	}
	...
	public void the_configuration_menu_should_be_displayed() throws Throwable {
		Assert.assertEquals(
				login.driver.findElement(By.xpath("//div[@class='popover--header ui-draggable-handle']")).isDisplayed(),
				true);
	}
	...
	public void check_if_the_following_function_description_are_same_as_follows(String arg1, String arg2)
			throws Throwable {
		...
		for (int i = 0, j = 0; i <= arg3.length - 1; i++) {
			...
			Assert.assertEquals(
					login.driver.findElement(By.xpath("(//div[@class='function-data--description'])[2]")).getText(),
					arg4[j]);
			j++;
		}
	}
	...
	public void check_if_the_icons_C_and_S_are_displayed_infront_of_the_series() throws Throwable {
		...
		for (int i = 1; i <= series.size(); i++) {
			Assert.assertEquals(login.driver
					.findElement(By.xpath("(//span[@class='status-icon status-icon__key'])[" + i + "]")).isDisplayed(),
					true);
			Assert.assertEquals(login.driver
					.findElement(By.xpath("(//span[@class='status-icon status-icon__has-replacements'])[" + i + "]"))
					.isDisplayed(), true);
	...
	/*
	 * @And("^Click on Edit Chart$") public void click_on_Edit_Chart() throws
	 * Throwable { Thread.sleep(1000);
	 * login.driver.findElement(By.xpath("//button[contains(text(),'Edit Chart')]"))
	 * .click(); }
	 */
	...
	public void check_if_Under_left_axis_Step_option_is_present() throws Throwable {
		...
		Assert.assertEquals(login.driver
				.findElement(
						By.xpath("//div[@class='tabs__tab-item active']/following::div[contains(text(),'Step')][1]"))
				.isDisplayed(), true);
	}
	...
	public void check_if_the_Number_format_is_at_the_first_place() throws Throwable {
		...
		Assert.assertEquals(login.driver
				.findElement(By.xpath(
						"//div[@class='tabs__tab-item active']/following::div[contains(text(),'Number format:')]"))
				.isDisplayed(), true);
	}
	...
	public void check_if_the_Min_MAX_value_tab_has_only_input_No_up_and_down_arrows() throws Throwable {
		...
		Assert.assertEquals(login.driver.findElement(By.xpath(
				"//div[@class='tabs__tab-item active']/following::div[contains(text(),'Min/Max value')]/following::input[@name='interval_min']"))
				.isDisplayed(), true);
		Assert.assertEquals(login.driver.findElement(By.xpath(
				"//div[@class='tabs__tab-item active']/following::div[contains(text(),'Min/Max value')]/following::input[@name='interval_max']"))
				.isDisplayed(), true);
	}
	...
	public void in_Tooltip_open_Advanced_setting_popup() throws Throwable {
		login.driver.findElement(By.xpath(
				"//div[@title='Tooltips. Configure the tooltips in the chart.']//div[@title='Open advanced settings popup']"))
				.click();
	...
	public void expand_Items() throws Throwable {
		login.driver
				.findElement(By.xpath("(//div[contains(text(),'Items')]/following::div[@class='icon-collapse'])[1]"))
				.click();
	...
	public void check_if_the_Name_and_Region_are_displayed_by_default() throws Throwable {
		List<WebElement> tooltip = login.driver
				.findElements(By.xpath("//div[@class='select-behaviour--multi-select-item']/span"));
	...
	public void in_tooltip_click_on_dropdown_beside_Date() throws Throwable {
		login.driver.findElement(By.xpath(
				"//div[@title='Tooltips. Configure the tooltips in the chart.']//div[@class='context-menu-control--icon']"))
				.click();
	...
	public void select_Frequency_Checkbox() throws Throwable {
		login.driver
				.findElement(By.xpath(
						"//span[contains(text(),'Frequency')]/parent::label/span[@class='input-control--indicator']"))
				.click();
	}
	...
	public void select_any_udd_series() throws Throwable {
		...
		login.driver.findElement(By.xpath("//div[contains(text(),'or click to select a file from your computer')]"))
				.click();
		Robot robot = new Robot();
		robot.setAutoDelay(2000);

		StringSelection selection = new StringSelection(
				"C:\\Users\\tbemineni\\Desktop\\New folder\\Cucumber_project\\AutoIT\\udd_template.xlsx");
	...
	public void open_SSP() throws Throwable {
		...
		login.driver.switchTo().activeElement();
		int faq = login.driver
				.findElements(By.xpath("//div[@class='main-series-information--link main-series-information--ask'][1]"))
				.size();
		int ask_question = login.driver
				.findElements(By.xpath("//div[@class='main-series-information--link main-series-information--ask'][2]"))
				.size();
		int watch = login.driver.findElements(By.xpath("(//span[@class='preview-series-data-actions--label'])[2]"))
				.size();
		if (faq == 0) {
			System.out.println("equal");
		}
	...
	public void dont_select_any_series_from_imported_tab() throws Throwable {
		...
		Assert.assertEquals(login.driver
				.findElement(By.xpath("//button[@class='index-module_button__xs646 index-module_small__6GGgk']"))
				.isEnabled(), false);
	}
	...
	public void click_on_Edit_series_in_Excel_button() throws Throwable {
		...
		login.driver.findElement(By.xpath("//button[@class='index-module_button__xs646 index-module_small__6GGgk']"))
				.click();
	}
	...
	public void dnd_Visual_from_View_to_Empty_View(int arg1, int arg2) throws Throwable {
		...
		Thread.sleep(2000);
		a.dragAndDrop(
				login.driver.findElement(By.xpath("//div[contains(text(),'View 1')]/following::div[@title='Chart']")),
				login.driver.findElement(By.xpath("//div[contains(text(),'View 2')]"))).build().perform();
		Thread.sleep(4000);
		Assert.assertEquals(
				login.driver.findElement(By.xpath("//div[contains(text(),'View 1')]/following::div[@title='Chart'][1]"))
						.isDisplayed(),
				true);
	...
	public void hover_the_mouse_on_the_series_name() throws Throwable {
		Thread.sleep(2000);
		a.moveToElement(login.driver.findElement(By.xpath("(//div[@class='series-name--title'])[1]"))).build()
				.perform();
	...
	public void check_the_background_selection_color_of_a_series() throws Throwable {
		...
		String str = login.driver.findElement(By.xpath("//div[@class='index-module_swatch_button_item_color__gAHg1']"))
				.getAttribute("style");
		System.out.println(str);
	}
	...
	public void click_on_the_cross_icon_besides_the_series_name() throws Throwable {
		Thread.sleep(2000);
		a.moveToElement(login.driver.findElement(By.xpath("(//span[@title='Remove series'])[1]"))).click().build()
				.perform();
		login.driver.switchTo().activeElement();
		String str = login.driver.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']")).getText();
		System.out.println(str);
		Assert.assertEquals(str,
				"Are you sure you want to delete the series \"Suresh\"?\r\n"
	...
	public void check_the_user_data_tab_or_imported_option_on_search_panel() throws Throwable {
		Assert.assertEquals(login.driver.findElement(By.xpath("//span[contains(text(),'Imported')]")).isDisplayed(),
				false);
	...
	public void try_to_import_same_imported_file_again() throws Throwable {
		...
		String str = login.driver.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']")).getText();
		Assert.assertEquals(str,
				"Invalid value in the cell C8-SssT005. A series with the same user series ID has been used already by you or your account member. Please specify a different ID.\r\n"
						+ "\r\n"
	...
	public void open_ssp_windows() throws Throwable {
		...
		a.moveToElement(login.driver.findElement(By.xpath("(//div[@class='series-item--name'])[1]"))).click().perform();
		login.driver.switchTo().activeElement();
		String str = login.driver.findElement(By.xpath("//span[@class='main-series-information--link']/span"))
				.getText();
		System.out.println(str);
	}
	...
	public void apply_currency_conversion_function_on_above_series() throws Throwable {
		login.driver
				.findElement(By.xpath(
						"//input[@name='select_all_dataselection']/following::span[@class='input-control--indicator']"))
				.click();
		Thread.sleep(2000);
		login.driver.findElement(By.className("function-editor-window--icon")).click();
		login.driver.findElement(By.xpath("//div[contains(text(),'By function')]")).click();
		...
		a.moveToElement(login.driver.findElement(By.xpath("//div[@class='function-item'][1]"))).doubleClick().build()
				.perform();
		Thread.sleep(2000);
		login.driver.findElement(By.xpath("//button[contains(text(),'Apply')]")).click();
		login.driver.switchTo().activeElement();
		String str = login.driver.findElement(By.xpath("//div[@class='modal-body sphere-modal__body']")).getText();
		Assert.assertEquals(str,
				"The function cannot be applied to \"Policy Rate: Month End: Main Refinancing Operations\" series.\r\n"
	...
	public void verify_the_footnotes_of_series(String arg1) throws Throwable {
		select_any_series_id(arg1);
		a.moveToElement(login.driver.findElement(By.xpath("(//div[@class='series-item--name'])[1]"))).contextClick()
				.perform();
