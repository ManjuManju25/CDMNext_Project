		...
		for (int i = 6; i <= 12; i++) {
			...
			login.driver
					.findElement(By.xpath(
							"(//span[@class='name-text'])[" + i + "]/parent::span/parent::a/preceding-sibling::span"))
					.click();
		}
...
//		delete_watlist();
		...
		if (str1.equalsIgnoreCase("Comparables")) {
			...
			login.driver.findElement(By.xpath("//div[@data-node-model-id='National Accounts']/div[@class='toggle']"))
					.click();
			login.driver.findElement(By.xpath(
					"//div[@data-node-model-id='Global Economic Monitor National Accounts']/div[@class='toggle']"))
					.click();
			login.driver.findElement(By.xpath(
					"//div[@data-node-model-id='Real GDP: Q-o-Q Growth: Quarterly: Seasonally Adjusted|||Global Economic Monitor National Accounts']/div[@class='toggle']"))
					.click();
			...
			for (int i = 1; i <= 4; i++) {
				login.driver
						...
						.click();
				String str4 = login.driver.findElement(By.xpath("(//div[@class='series-item--name'])[" + i + "]"))
						.getText().toString();
				compare.add(str);
	...
	public void highlight_the_series_in_watchlist_and_click_bell_icon(String str) throws InterruptedException {
		...
		Thread.sleep(2000);
		if (login.driver.findElements(By.xpath("//span[@class='series-list-item--checkbox svg-checkbox']"))
				.size() >= 1) {
...
//				login.driver.findElement(By.xpath("//*[@class='dropdown-submenu active-menu-item']//button[contains(text(),'Apply')]")).click();
	...
	public void go_to_watchlist_and_select_the_series_and_click_edit_alert_drop_down(String str, String str1)
			throws Throwable {
		...
		login.driver
				.findElement(By.xpath(
						"//input[@name='popup_notifications']/following::span[@class='input-control--indicator'][1]"))
				.click();
		login.driver
				.findElement(
						By.xpath("//input[@name='" + str + "']/following::span[@class='input-control--indicator'][1]"))
	...
	public void go_to_watchlist_and_select_the_series_and_click_edit_alert_drop_down1(String str, String str1)
			throws Throwable {
		...
		if (str1.length() > 0) {
			login.driver
					.findElement(By.xpath(
							"//input[@name='" + str1 + "']/following::span[@class='input-control--indicator'][1]"))
					.click();
	...
	public void add_series_with_different_region_to_watchlist(String arg1, String str, List<String> str2, String str3)
			throws Throwable {
		delete_watlist();
