...
Scenario: Tc_Comparables_42: Verify checkbox selection for tables
    And Clicking "Comparables" icon
    And Expand "National Accounts" > "Global Economic Monitor" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" > "Real GDP: YoY: Quarterly: sa: Australia" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia"  
    And Check the checkbox "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" 
...
Scenario: Tc_Comparables_45: Verify unchecking selection of tables
    And Clicking "Comparables" icon
    And Expand "National Accounts" > "Global Economic Monitor" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" > "Real GDP: YoY: Quarterly: sa: Australia" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia"  
    And Uncheck the checkbox "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" 
...
Scenario: Tc_Comparables_46: Verify unchecking selection of series
    ...
    And Clicking "Comparables" icon
    And Expand "National Accounts" > "Global Economic Monitor" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" > "Real GDP: YoY: Quarterly: sa: Australia" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia"   
    And Deselect 3 series inside table
...
Scenario: Tc_Comparables_122: Verify top button when comparables tab is scrolled down
   And Clicking "Comparables" icon
   And Expand "National Accounts" > "Global Economic Monitor" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" > "Real GDP: YoY: Quarterly: sa: Australia" > "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Asia" 
   And Also Expand the "Table: Real GDP: Y-o-Y Growth: Quarterly: Seasonally Adjusted: Europe and Central Asia" 
