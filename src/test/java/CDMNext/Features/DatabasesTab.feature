...
@DB
Scenario: TC_DB_01: Verifying Database selection 
...
@DB
Scenario: TC_DB_02: Verifying Expand --> DB > Topic > Section > Table
...
@DB
Scenario: TC_DB_03: Verifying Collapse option
...
@DB
Scenario: TC_DB_04: Verifying unselect option
And Select any number of series
And Click on Unselect
Then Selected series should be unselected

@DB
Scenario: TC_DB_05: Verifying mouse hover options for DB level
...
@DB
Scenario: TC_DB_06: Verifying Copy link(s) for DB level
...
@DB
Scenario: TC_DB_07: Verifying 'Footnotes' for DB level
Given Right click on any Database
And Click on "Footnotes"
Then Footnotes should be opened for selected DB

@DB
Scenario: TC_DB_08: Verifying remove icon for database
Given Click on All Databases dropdown
...
@DB
Scenario: TC_DB_09: Verify multiple databases selection
Given Click on All Databases dropdown
