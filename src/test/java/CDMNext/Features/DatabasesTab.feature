...
@DB 
Scenario: TC_DB_13: Verifying 'See our search help' 
	Given User enters "X" 
...
@DB 
Scenario: TC_DB_155:Series selection - Verify 'Add and replace' from dropdown 
	And Create a visual and select visual 
...
@DB 
Scenario: TC_DB_158:Series selection - Verify chart option 
	And Select some series from series level 
	And Click on selected series count 
...
@DB 
Scenario: TC_DB_159:Series selection - Verify CTC 
	And Select some series from series level 
	And Click on selected series count 
...
@DB 
Scenario: TC_DB_162:Series selection - Verify maximize option 
	And Select some series from series level 
	And Click on selected series count 
...
@DB 
Scenario: TC_DB_163:Series selection - Verify exit full screen icon 
	And Select some series from series level 
	And Click on selected series count 
	And Click on "Maximize" icon on header 
...
@DB 
Scenario: TC_DB_166:Series selection - Verify close button(x) 
	And Select some series from series level 
	And Click on selected series count 
