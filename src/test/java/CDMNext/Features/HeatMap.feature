...
@Heatmap 
Scenario: TC_HM_02: Verify creating HeatMap visual by drag and drop 
	And Click on Create new view tab 
	And Drag and drop HeatMap visual to view panel 
	Then Verify the HeatMap visual should be created 
	
@Heatmap 
Scenario: TC_HM_03: Verify creating HeatMap visual from View panel by drag and drop 
	And Click on Create new view tab 
...
@Heatmap 
Scenario: TC_HM_26: Empty visual - Verify "+ Add from My Series" option in edit series panel 
	And Navigate to series Tab 
	And My series tab should be empty 
	And Click on Create new view tab 
	And Click on HeatMap visual icon 
...
@Heatmap 
Scenario: TC_HM_37: Verify click on title 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
	...
	Then verify the Series Harmonization window is displayed 
	And click on Apply button 
	And Click on title and Verify the Title popup should be displayed 
...
@Heatmap 
Scenario: TC_HM_49: Rename - Verify find field and Rename -  Verify number of searched result 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
...
@Heatmap 
Scenario: TC_HM_51: Rename - Verify Replace field and Rename - Verify 'Replace' button 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
...
@Heatmap 
Scenario: TC_HM_92: Rename - Verify maximiz option 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
...
Scenario: TC_HM_99: Edit series - Verify 'Aggregate' function apply 
	...
	And click on Apply button 
	And Click on Edit series 
	And Click on 'Aggregate' and Select "Weekly (Distribute)" 
...
Scenario: TC_HM_102: Edit series - Verify 'FX more' icon 
	...
	And click on Apply button 
	And Click on Edit series 
	And Click on 'FX' Open function editor(F) icon 
	Then Verify The "Apply functions to visual series" popup should be opened 
	
	
@Heatmap 
Scenario: TC_HM_103: Edit series - Verify appling function by clicking on function icon. 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
	...
	And Click on Edit series 
	And Click on 'FX' Open function editor(F) icon 
	And Verify The "Apply functions to visual series" popup should be opened 
	Then Apply function to the series. 
	
	#functionality remove
	#@Heatmap
Scenario: TC_HM_104: Edit series - Verify hiding function bar 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
	...
	And click on Apply button 
	And Click on Edit series 
	And Click on 'function bar' hide icon 
	Then Verify The 'function bar' should be hidden 
	#functionality remove
	#@Heatmap
Scenario: TC_HM_105: Edit series - Verify showing the fuction toolbar 
	And Navigate to series Tab 
	And Search for the series "1692001;7874601;2126801;292514601;369703887" with different frequencies 
	And checked selected series 
	And right click on checked series 
	...
	And Click on Edit series 
	And Click on 'function bar' hide icon 
	And Click on 'function bar' show icon 
...
Scenario: TC_HM_113: Edit series - Verify Rename option under edit series 
	...
	And Click on Edit series 
	And Mouse move on series and Click on 'Edit series' icon 
	And Cick on "Rename" on Edit series Dropdwon list 
...
Scenario: TC_HM_114: Edit series - Verify 'Frequency' option under edit series 
	...
	And Click on Edit series 
	And Mouse move on series and Click on 'Edit series' icon 
	And Cick on "Frequency" on Edit series and select anyone on Dropdwon list 
	Then Verify The Selected function should be applied to the series 
	
@Heatmap 
Scenario: TC_HM_115: Edit series - Verify 'Currency' option under edit series 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
	...
	And Click on Edit series 
	And Mouse move on series and Click on 'Edit series' icon 
	And Cick on "Currency" on Edit series and select anyone on Dropdown list 
	Then Verify the Selected currency should be applied to all series 
...
Scenario: TC_HM_116: Edit series - Verify 'Change' option under edit series 
	...
	And Click on Edit series 
	And Mouse move on series and Click on 'Edit series' icon 
	And Cick on "Change" on Edit series and select anyone on dropdown list 
...
Scenario: TC_HM_129: Edit series - Verify clicking on type a function field. 
	...
	And click on Apply button 
	And Click on Edit series 
	And click on type a function feild in series level. 
...
@Heatmap 
Scenario: TC_HM_131: Edit series -  Verify cancel icon for selected function. 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
@Heatmap 
Scenario: TC_HM_141: Edit series - Verify adding series from my series. 
...
@Heatmap 
Scenario: TC_HM_145: Edit seires - Verify Edit series option on visual if edit series panle is opened 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
@Heatmap 
Scenario: TC_HM_148: Edit HeatMap - Verify popup of creating template 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
Scenario: TC_HM_149: Edit HeatMap - Verify auto naming for template 
	...
	And Make some changes in 'Edit visual' popup 
	And Click on create template icon(+) 
	Then Verify The Auto name should be available as "My template 1" in creating template 
	
@Heatmap 
Scenario: TC_HM_150: Edit HeatMap - Verify template creating 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
Scenario: TC_HM_154: Edit HeatMap - Verify 'Set as default for future HeatMap visual' is checked 
	...
	And Click on 'Edit HeatMap' 
	And Mouse move on existing visual template and click on dropdown 
	...
	And click on Add chart and click on HeatMap 
	# And Click on  "View as ..." and  click on "Heat map"
	# And "2" check boxs checked
	# And right click on checked series
	#And click on Add chart and click on HeatMap
	Then verify the Series Harmonization window is displayed 
...
Scenario: TC_HM_160: Edit HeatMap -  Title - Verify default selection for title 
	...
	And click on Apply button 
	And Click on 'Edit HeatMap' 
	And Click on Title dropdown and by default Title checked 
	And click on 'Save' button 
...
Scenario: TC_HM_161: Edit HeatMap -  Title - Verify Title=NO 
	...
	And click on Apply button 
	And Click on 'Edit HeatMap' 
	And Click on Title dropdown and Title=Uncheck 
	And click on 'Save' button 
...
@Heatmap 
Scenario: TC_HM_169: Edit HeatMap - Title - Verify advance settings 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
@Heatmap 
Scenario: TC_HM_170: Edit HeatMap - Verify advance settings cogwheel icon 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
Scenario: TC_HM_173: Edit HeatMap - Title - Verify font size for visual title 
	...
	And Click on 'Edit HeatMap' 
	And Click on open Advanced settings popup(cogwheel icon) 
	And Verify the Title ='Check' and Select size for visual title "30" 
	And click on 'Save' button 
...
Scenario: TC_HM_257: Edit HeatMap - legend - advanced settings under dropdown - background 
	...
	And Click on legend dropdown 
	And Click on "Advanced settings" hyper link 
	And Click on "Background" plus icon 
...
Scenario: TC_HM_258: Edit HeatMap - legend - advanced settings under dropdown - background color 
	...
	And Click on "Advanced settings" hyper link 
	And Click on "Background" plus icon 
	And checked checkbox and Select color for legends background 
	And click on 'Save' button 
...
Scenario: TC_HM_259: Edit HeatMap - legend - advanced settings under dropdown - background opacity 
	...
	And Click on "Background" plus icon 
	And checked checkbox and Select color for legends background 
	And Apply opacity "20" for legends background 
	And click on 'Save' button 
...
Scenario: TC_HM_261: Edit HeatMap - legend - advanced settings under dropdown - border color 
	...
	And Click on "Advanced settings" hyper link 
	And Click on "Border" plus icon 
	And check on border check box and Choose color for legend border 
	And click on 'Save' button 
...
Scenario: TC_Hm_262: Edit HeatMap - legend - advanced settings under dropdown - border width 
	...
	And Click on "Border" plus icon 
	And check on border check box and Choose color for legend border 
	And Choose 'width' for legend border "5" 
	And click on 'Save' button 
...
Scenario: TC_HM_263: Edit HeatMap - legend - advanced settings under dropdown - border radius 
	...
	And Click on "Border" plus icon 
	And check on border check box and Choose color for legend border 
	And Choose radius for legend border "15" 
	And click on 'Save' button 
...
@Heatmap 
Scenario: TC_HM_291:Edit HeatMap - Copyright - Verify 'Vertical align' for middle. 
	And Navigate to series Tab 
	And Search for the series "7874301;249445301" with different frequencies 
	And "2" check boxs checked 
	And right click on checked series 
...
Scenario: TC_HM_359: Edit HeatMap - Verify Solid Color button - Advanced settings cogwheel - Background 
	...
	And Click on Solid color 
	And Solid color - Click on "Open advanced settings popup" cogwheel 
	And Click on ( + ) icon from "Background" section 
...
Scenario: TC_HM_360: Edit HeatMap - Verify Solid Color button - Advanced settings cogwheel - Border 
	...
	And Click on Solid color 
	And Solid color - Click on "Open advanced settings popup" cogwheel 
	And Click on ( + ) icon from "Border" section 
...
Scenario: TC_HM_442: Edit HeatMap - Feedback - Verify Submit button 
	...
	And Click on Feedback option 
	And Enter text on description field 
	# And Click on submit button//venkat
...
@Heatmap 
Scenario: TC_HM_487: Right click - Verify insert visual sub dropdown. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
...
@Heatmap 
Scenario: TC_HM_488: Right click - Verify chart under insert visual 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And choose insert visual=>Chart. 
	
@Heatmap 
Scenario: TC_HM_489: Right click - Verify Pie under insert visual 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And choose insert visual=>Pie. 
	
@Heatmap 
Scenario: TC_HM_491: Right click - Verify map under insert visual 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And choose insert visual=>Map. 
	
@Heatmap 
Scenario: TC_HM_492: Right click - Verify Heatmap under insert visual 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And choose insert visual=>HeatMap. 
	
@Heatmap 
Scenario: TC_HM_493: Right click - Verify Histogram under insert visual 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
...
@Heatmap 
Scenario: TC_HM_500: Right click - Verify View as sub dropdown. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And hover on Add chart 
...
@Heatmap 
Scenario: TC_HM_501: Right click - View as - Verify Chart. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And HeatMap visual should be changed to chart visual. 
	
@Heatmap 
Scenario: TC_HM_502: Right click - View as - Verify Map. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And HeatMap visual should be changed to Map visual. 
	
@Heatmap 
Scenario: TC_HM_503: Right click - View as - Verify Histogram. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
	And HeatMap visual should be changed to Histogram visual. 
	
@Heatmap 
Scenario: TC_HM_504: Right click - View as - Verify Pie. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
...
@Heatmap 
Scenario: TC_HM_506: Right click - View as - Verify Heatmap. 
	Given user creates a HeatMap Visual 
	And Right clicks on Visual. 
...
Scenario: TC_HM_517: Verify visual drag. 
	Given user creates an Empty HeatMap visual 
	And user creates a HeatMap Visual 
