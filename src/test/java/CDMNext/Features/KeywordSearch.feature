...
@SynonymSearch
Scenario: TC_SynonymSearch_40 : Search for an Acronym as "iti"
...
@SynonymSearch
Scenario: TC_SynonymSearch_120 : Search for an Acronym as "Cr"
...
@SynonymSearch
Scenario: TC_SynonymSearch_203 : Search for an Acronym as "ppi"
...
@KeywordSearch
Scenario: TC_Filters_Search_261
...
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_271 : Search for an Acronym as "上海"
#Given User enters keyword "上海"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_272 : Search for an Acronym as "个人消费支出"
#Given User enters keyword "个人消费支出"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_273 : Search for an Acronym as "冰箱"
#Given User enters keyword "冰箱"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_274 : Search for an Acronym as "印尼"
#Given User enters keyword "印尼"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_275 : Search for an Acronym as "国债利率"
#Given User enters keyword "国债利率"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_276 : Search for an Acronym as "张家界"
#Given User enters keyword "张家界"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_277 : Search for an Acronym as "活猪存栏量"
#Given User enters keyword "活猪存栏量"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_278 : Search for an Acronym as "深交所"
#Given User enters keyword "深交所"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_279 : Search for an Acronym as "生产率"
#Given User enters keyword "生产率"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_280 : Search for an Acronym as "草鱼"
#Given User enters keyword "草鱼"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_281 : Search for an Acronym as "货币供应量"
#Given User enters keyword "货币供应量"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_282 : Search for an Acronym as "金融资产总量"
#Given User enters keyword "金融资产总量"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_283 : Search for an Acronym as "程限"
#Given User enters keyword "程2"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_284 : Search for an Acronym as "文化"
#Given User enters keyword "文化"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_285 : Search for an Acronym as "一月"
#Given User enters keyword "一月"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_286 : Search for an Acronym as "职工"
#Given User enters keyword "职工"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_287 : Search for an Acronym as "年尾年末"
#Given User enters keyword "年尾年末"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_288 : Search for an Acronym as "交易"
#Given User enters keyword "交易"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_289 : Search for an Acronym as "建造"
#Given User enters keyword "建造"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_290 : Search for an Acronym as "假期"
#Given User enters keyword "假期"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_291 : Search for an Acronym as "季节"
#Given User enters keyword "季节"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_292 : Search for an Acronym as "加强"
#Given User enters keyword "加强"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_293 : Search for an Acronym as "计算"
#Given User enters keyword "计算"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_294 : Search for an Acronym as "出产"
#Given User enters keyword "出产"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_295 : Search for an Acronym as "出入收支"
#Given User enters keyword "出入收支"
#Then User verify keyword search results
#
#@ChineseKeywordSearch
#Scenario: TC_KeywordSearch_296 : Search for an Acronym as "摩托车"
