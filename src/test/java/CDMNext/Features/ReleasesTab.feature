Feature: Verify ReleasesTab functionality
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_12: Verify ' v ' icon for a series to display details
  # And Clicking "Releases" icon
  #And Expand first Dataset
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_13: Verify ' ^ ' icon for a series to collapse details
  # And Clicking "Releases" icon
  #And Expand first Dataset
  # And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  @ReleasesTab
  Scenario: TC_Releases_14 : Hovor on to ' + ' icon
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_15: Verify ' + ' icon
    And Clicking "Releases" icon
    And Expand first Dataset
    And Select 1 series inside table
    And Clicking "add-to-data-selection--label" option from Series list
    Then The series should add into right pane

  @ReleasesTab
  Scenario: TC_Releases_16: Verify ' + ' dropdown
    And Clicking "Releases" icon
    And Expand first Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_17: Hovor on to Add option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_18: Verify add option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_19: Hovor on to Add and replace option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_20: Hovor on to Add and group option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_21: Verify Add and group option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Select 1 series inside table
    # And Clicking + option from series
    And clicking on + option from series.
    And Clicking "Add and group" from dropdown list
    Then The Selected series should get added into right pane with "Group"

  @ReleasesTab
  Scenario: TC_Releases_22: Hovor on to Add to new insight option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_23: Verify Add to new insight option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Select 1 series inside table
    #   And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_24: Hovor on to Add to recent insight option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_25 : Verify Add to recent insight option
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
  ...
  @ReleasesTab
  Scenario: TC_Releases_26: Verify right click option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_27: Hovor on to unselect All option for the series
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_28: Verify unselect All option for the series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Select 1 series inside table
  #And Right click the first series
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_29: Hovor on to View as Chart option for the series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_30: Verify View as Chart option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
    And Click on "Add chart" button in Comparables
    Then The "Edit Chart" option is displayed

  #@ReleasesTab
  #Scenario: TC_Releases_31: Hovor on to View as Map option for the series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_32: Verify View as Map option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_33: Hovor on to View as Table option for the series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_34: Verify View as Table option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  # @ReleasesTab
  #Scenario: TC_Releases_35: Hovor on to View as Pie option for the series
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_36: Verify View as Pie option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_37: Hovor on to View as Heat map option for the series
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_38: Verify View as Heat map option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_39: Hovor on to View as Histogram option for the series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_40: Verify View as Histogram option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_41: Hovor on to Download option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_42: Verify Download option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_43: Hovor on to Copy option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_44: Verify Copy option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_45 : Hovor on to Copy Data option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_46: Verify Copy data option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_47: Hovor on to Copy link(s) option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_48: Verify Copy link(s) option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_49: Hovor on to Series Info for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_50: Verify Series Info option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to series name without click
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_51: Hovor on to Footnotes option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_52: Verify Footnotes option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_53: Verify Footnotes option for the series(Multiple Footnotes)
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Expand first Dataset
    And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_54: Hovor on to Show Dataset option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario: TC_Releases_55: Verify Show Dataset option for the series(Multiple datasets)
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Expand first Dataset
    And Select 1 series inside table
  ...
  @ReleasesTab
  Scenario: TC_Releases_56: Verify Show Dataset option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Select 1 series inside table
    # And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_57: Hovor on to ' + ' icon for dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
    Then "Add series" , "Add and replace series" Options should present

  @ReleasesTab
  Scenario: TC_Releases_58: Verify ' + ' dropdown for dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
    And clicking on + option from series.
    # And Clicking "add-to-data-selection--toggle" option from Table
  ...
  @ReleasesTab
  Scenario: TC_Releases_59: Hovor on to Add option in Dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
    And clicking on + option from series.
    #  And Clicking "add-to-data-selection--toggle" option from Table
  ...
  @ReleasesTab
  Scenario: TC_Releases_60: Verify add option in Dataset
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to "add-to-data-selection--title"
    And clicking on + option from series.
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_61: Hovor on to Add and replace option in Dataset
  #And Clicking "Releases" icon
  # And Hovor on to "add-to-data-selection--title"
  #And clicking on + option from series.
  ...
  #Then The "Add and replace series in visual (R)" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_62: Hovor on to Add and group option in Dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
    And clicking on + option from series.
    # And Clicking "add-to-data-selection--toggle" option from Table
  ...
  @ReleasesTab
  Scenario: TC_Releases_63: Verify Add and group option in Dataset
    And Clicking "Releases" icon
    And Expand first Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_64: Hovor on to Add to new insight option in Dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
    # And Clicking "add-to-data-selection--toggle" option from Table
    And clicking on + option from series.
  ...
  @ReleasesTab
  Scenario: TC_Releases_65: Verify Add to new insight option in Dataset
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
    And Get Text of Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_66: Hovor on to Add to existing insight option in Dataset
    And Clicking "Releases" icon
    And Hovor on to "add-to-data-selection--title"
  ...
  @ReleasesTab
  Scenario: TC_Releases_67: Verify Add to existing insight option in Dataset
    And Clicking "Releases" icon
    And Expand first Dataset
    And Clicking "add-to-data-selection--toggle" option from Series list
    And Get Text of Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_68: Verify clicking on more actions option for the series
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_69: Hovor on to unselect All option for the series in more actions
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "Unselect all" tooltip should be displayed
  #@ReleasesTab
  #Scenario: TC_Releases_70: Verify unselect All option for the series in more actions
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Select 1 series inside table
  #And Hovor on to i icon without click
  ...
  #Then Selected series should get deselected
  #@ReleasesTab
  #Scenario: TC_Releases_71: Hovor on to View as Chart option for the series in more actions
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "View as Chart" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_72: Verify View as Chart option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  # @ReleasesTab
  #Scenario: TC_Releases_73: Hovor on to View as Map option for the series in more actions
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "View as Map" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_74: Verify View as Map option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_75: Hovor on to View as Table option for the series in more actions
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "View as Table" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_76: Verify View as Table option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  # @ReleasesTab
  #Scenario: TC_Releases_77: Hovor on to View as Pie option for the series in more actions
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "Pie" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_78: Verify View as Pie option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_79: Hovor on to View as Heat map option for the series in more actions
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "Heat map" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_80: Verify View as Heat map option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_81: Hovor on to View as Histogram option for the series in more actions
  # And Clicking "Releases" icon
  #And Expand first Dataset
  # And Hovor on to i icon without click
  #And Click on "More actions" option in series level
  ...
  #Then The "Histogram" tooltip should be displayed
  @ReleasesTab
  Scenario: TC_Releases_82: Verify View as Histogram option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_83: Hovor on to Download option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_84: Verify Download option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_85: Hovor on to Copy option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_86: Verify Copy option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_87: Hovor on to Copy Data option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_88: Verify Copy data option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_89: Hovor on to Copy link(s) option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_90: Verify Copy link(s) option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to series name without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_91: Hovor on to Series Info for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_92: Verify Series Info option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to series name without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_93: Hovor on to Footnotes option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_94: Verify Footnotes option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_95: Verify Footnotes option for the series in More actions(Multiple Footnotes)
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Expand first Dataset
    #And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_96: Hovor on to Show Dataset option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    #And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_97: Verify Show Dataset option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    # And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario: TC_Releases_98: Verify Show Dataset option for the series in more actions(Multiple datasets)
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Expand first Dataset
    #And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_99: Verify for Unselect link related to  all sections
    And Clicking "Releases" icon
    And Expand first Dataset
    And Select 1 series inside table
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_100: Verify Unselect link
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Select 1 series inside table
  #Then The "Unselect" link should be clicked
  @ReleasesTab
  Scenario Outline: TC_Releases_101: Verify the Release time intervals
    And Clicking "Releases" icon
  ...
  #@ReleasesTab
  #Scenario: TC_Releases_102: Verify Load more option
  #And Clicking "Releases" icon
  #Then The "Load More" button should present
  @ReleasesTab
  Scenario: TC_Releases_103: Verify right click options on Dataset
    And Clicking "Releases" icon
    And Right Click the first dataset
   Then Chart , Map , Table and download options should be clicked.

  @ReleasesTab
  Scenario: TC_Releases_104: Hovoring right click options on Dataset
   #Scenario: TC_Releases_104: Hovoring right click options on Dataset
    And Clicking "Releases" icon
    And Right Click the first dataset
  ...
  #| "Download"      |
  #@ReleasesTab
  #Scenario Outline: TC_Releases_105: Hovor on to View as ... option for the dataset
  # And Clicking "Releases" icon
  #And Right Click the first dataset
  ...
  #| "Histogram" |
  #@ReleasesTab
  #Scenario: TC_Releases_106: Verify unselect All option for the Datasets
  # And Clicking "Releases" icon
  #And Right Click the first dataset
  #And Click on "Unselect all" button in Comparables
  ...
  #And Check the download button and search box
  @ReleasesTab
  Scenario: TC_Releases_107: Verify View as Chart option for the Datasets
    And Clicking "Releases" icon
    And Expand first Dataset
  ...
  @ReleasesTab
  Scenario: TC_Releases_108: Verify View as Map option for the Datasets
  ...
  @ReleasesTab
  Scenario: TC_Releases_109: Verify View as Table option for the Datasets
    And Clicking "Releases" icon
    # And Search for the series "176412302" in ReleasesTab
    And Search for the series "70649302" in ReleasesTab
    And Select "-1Y" timeframe button
  ...
  @ReleasesTab
  Scenario: TC_Releases_110: Verify View as Pie option for the Datasets
    And Clicking "Releases" icon
    # And Search for the series "176412302" in ReleasesTab
    And Search for the series "70649302" in ReleasesTab
    And Select "-1Y" timeframe button
  ...
  @ReleasesTab
  Scenario: TC_Releases_111: Verify View as Heat map option for the Datasets
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Expand first Dataset
    And Count the series inside "First Dataset"
  ...
  @ReleasesTab
  Scenario: TC_Releases_112: Verify View as Histogram option for the Datasets
    And Clicking "Releases" icon
    # And Search for the series "176412302" in ReleasesTab
    And Search for the series "70649302" in ReleasesTab
    And Select "-1Y" timeframe button
  ...
  @ReleasesTab
  Scenario: TC_Releases_113: Verify Download option for the Datasets
  ...
  # @ReleasesTab
  #Scenario: Tc_Releases_114: Verify Read more for series in ReleasesTab
  #  And Clicking "Releases" icon
  # And Expand first Dataset
  # And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #Then The "Footnotes" option is shown
  #@ReleasesTab
  #Scenario: Tc_Releases_115: Verify datasets for Multiple related series
  # And Clicking "Releases" icon
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_116: Verify navigating to database for related series
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_117: Verify navigating to topic for related series
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_118: Verify navigating to section for related series
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_119: Verify opening any of related insights
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_120: Verify favoriting related insight
  #And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_121: Verify sharing of related insight
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_122: Verify sharing of non sharing related insight
  # And Clicking "Releases" icon
  #And Search for the series "5724301" in ReleasesTab
  #And Expand first Dataset
  #And Hovor on to i icon without click
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_123: Verify presence of related insights tooltip
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_124: Verify creator tooltip of related insight present
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  #@ReleasesTab
  #Scenario: Tc_Releases_125: Verify time period of related insight present
  # And Clicking "Releases" icon
  #And Expand first Dataset
  #And Hovor on to i icon without click
  #And Click "Show related data" option in series
  ...
  @ReleasesTab
  Scenario Outline: TC_Releases_126: Hovor on to Add to Watchlist option for the series by right click
    And Clicking "Releases" icon
    And Expand first Dataset
    And Right click the first series
  ...
  @ReleasesTab
  Scenario Outline: TC_Releases_127: Hovor on to View as Add to Watchlist option for the series in more actions
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
    And Click on "More actions" option in series level
  ...
  @ReleasesTab
  Scenario Outline: TC_Releases_128: Verify showing tool tip for mouse hover options in series level
    And Clicking "Releases" icon
    And Expand first Dataset
    And Hovor on to i icon without click
  ...
  @ReleasesTab
  Scenario: TC_Releases_129: Verify Add to Watchlist icon in series level
    And Clicking "Releases" icon
  ...
  @ReleasesTab
  Scenario: TC_Releases_130: Verify Add to Watchlist option in series level right click
    And Clicking "Releases" icon
    And Select released database
    And Right click the first series
    And Click on "Add to Watchlist" option
    And Select "popup_notifications" option from watchlist
    And Select "email_notifications" option from watchlist
  ...
  # Then The selected actions should reflect inside watchlist tab
  @ReleasesTab
  Scenario: TC_Releases_131: Verify Add to Watchlist option in series level more actions
    And Clicking "Releases" icon
    And Select released database
    And Click on "More actions" option in series level
    And Click on "Add to Watchlist" option in series level
  ...
  #Then The selected actions should reflect inside watchlist tab
  @ReleasesTab
  Scenario: TC_Comparables_132: Verify Add to Watchlist option in series level more actions
    And Clicking "Releases" icon
    And Select released database
    And Click on "More actions" option in series level
    And Click on "Add to Watchlist" option in series level
  ...
  # Then The selected actions should reflect inside watchlist tab
  @ReleasesTab
  Scenario: Tc_Releases_133: Verify series added to new insight in Dataset
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Select "-1Y" timeframe button
    And Expand first Dataset
  ...
  @ReleasesTab
  Scenario: Tc_Comparables_134: Verify adding series into existing insight with existing insight shown in growl msg popup
    And Clicking "Releases" icon
    And Search for the series "70649302" in ReleasesTab
    And Select "-1Y" timeframe button
    And Expand first Dataset
