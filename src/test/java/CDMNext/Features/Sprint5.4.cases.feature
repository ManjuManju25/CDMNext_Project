Feature: Verify title for commentary visual by default.
 ...
 @Sprint5_4
  ...
  Scenario: TC_20903:Verify if only 1 view is selected  in Edit view
    ...
    And Refresh and clear search
    Given Select any two series id "5724301;5958801" and create Chart in view 2
    And Click on view1
 ...
 @Sprint5_4
  ...
  #And Hover the mouse of the imported series by User	
