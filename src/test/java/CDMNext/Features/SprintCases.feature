...
Scenario: TC_12744_01: Clear All filters button to clear all filters set
	...
	And User selects "Dates" as "Last observation after" 
...
Scenario: TC_13722_04: Search: expand results down to the series level when a user performs a search
	And User enters keyword "panaji"
	And Select "Matches only" filter
	Then For search results less than 1000, the system will display all the tables and on the first table – down to series level
	
@Sprint
Scenario: TC_13722_05: Support 3rd subnational level on the India map
...
@Sprint
Scenario: TC_14218_09:Add a possibility to copy a view from new insight 
	And User enters "282464801"
	And Create visual
	And Right click on the View and select Copy View
...
@Sprint
Scenario: TC_14218_10:Add a possibility to copy all views from same insight 
...
@Sprint
Scenario: TC_14218_11:Add a possibility to copy all views from new insight 
	And User enters "384681617;232081403"
	And Create visual
	And Right click on the View and select "Copy all views"
	And Create new insight
...
@Sprint
Scenario: TC_6603_12:FEEDBACK: Improve customizing of color palettes in map
...
@Sprint
Scenario: TC_6603_13:Verify the changes inEdit Visual modal
	And User enters series_id "384681617"
	And Create a map visual
	And Click on Edit Map
	And Select Solid color
...
@Sprint
Scenario: TC_6603_14:Verify if more gradient steps are selected 
	And User enters series_id "384681617"
	And Create a map visual
	And Click on Edit Map
	And Select Gradient
...
@Sprint
Scenario: TC_12897_15: FEEDBACK:37192 Include China map with Taiwan
	And User enters series_id "359421337"
	And Create map with taiwan series
	Then The taiwan should be included in China map
	
@Sprint	
Scenario: TC_15651_16: Verify Correct order of style templates 
   And User enters series_id "384681617"
   And Create a map visual
   And Click on Edit Map
...
@Sprint	
Scenario: TC_15651_17: Verify Selected style visiblity in the template list
   And User enters series_id "359421337"
   And Create a map visual
   And Click on Edit Map
   And Uncheck the "Legend" option
...
@Sprint
Scenario: TC_14172_18: Edit visual: implement a possibility to save a custom style
   And User enters series_id "384681617"
   And Create a map visual
   And Click on Edit Map
   And Uncheck the "Legend" option
