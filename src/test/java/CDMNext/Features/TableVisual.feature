...
Feature: Table Visual Functionality
  ...
  @TableVisual
  Scenario: TC_TV_235:Edit Table - Copyright - Verify copyright color
    And Create a table visual
  ...
  @TableVisual
  Scenario: TC_TV_237:Edit Table - Copyright - Verify bold style.
    And Create a table visual
  ...
  Scenario: TC_TV_265:Edit Table-Value -Blank observations - Verify Fill with N/A
    And User Select Series ID  as "69851501"
